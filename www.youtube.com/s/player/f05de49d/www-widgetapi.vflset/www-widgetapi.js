(function() {
    ...
    */
    ...
    function Ba(a) {
        ...
        (b = a.l = a.l || b) ? b.Xa ? a.i = a.v || a.m : void 0 != b.s && a.m < b.s ? (a.i = b.s, a.l = null) : a.i = a.m: a.i = 0
    }
    ...
    function Ea(a, b, c, d) {
        try {
            ...
            if (!e.done) return a.i.u = !1, e;
            var f = e.value
        } catch (g) {
            return a.i.o = null, wa(a.i, g), Fa(a)
        }
        a.i.o = null;
        d.call(a.i, f);
        return Fa(a)
    ...
    function Ga(a) {
        this.next = function(b) {
            ua(a.i);
            a.i.o ? b = Ea(a, a.i.o.next, b, a.i.B) : (a.i.B(b), b = Fa(a));
            return b
        };
        this.throw = function(b) {
            ua(a.i);
            a.i.o ? b = Ea(a, a.i.o["throw"], b, a.i.B) : (wa(a.i, b), b = Fa(a));
            return b
        };
    ...
    r("Promise", function(a) {
        ...
        b.prototype.pa = function(g) {
            ...
            "function" == typeof h ? this.kb(h, g) : this.v(g)
        };
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).sa(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var t = [],
                    p = 0;
                do t.push(void 0), p++, d(k.value).sa(q(t.length - 1), m), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function ac(a) {
        if (a !== $b) throw Error("requires a valid immutable API token");
    };
    ...
    var Pc, Qc = Object.freeze(Gc([]));

    function Rc(a) {
        if (Nc(a)) throw Error("Cannot mutate an immutable Message");
    }
        ...
        switch (typeof a) {
            ...
            case "object":
                if (a && !Array.isArray(a)) {
                    ...
                    if (a instanceof Bc) {
                        var b = a.Ma;
                        null != b && "string" !== typeof b && (yc && b instanceof Uint8Array ? b = xc(b) : (Na(b), b = null));
                        return null == b ? "" : a.Ma = b
                    }
                }
        }
        return a
    ...
    function ed(a, b, c) {
        return -1 === b ? null : b >= a.l ? a.j ? a.j[b] : void 0 : (void 0 === c ? 0 : c) && a.j && (c = a.j[b], null != c) ? c : a.D[b + a.Z]
    }
    ...
    function fd(a, b, c, d) {
        ...
        if (Nc(a)) c && (Lc(e), Object.freeze(e));
        else if (e === Qc || Kc(e)) e = Gc(e.slice()), F(a, b, e, d);
        return e
    }
    ...
    function id(a, b, c, d, e) {
        ...
        if (-1 === c) d = null;
            ...
            if (g) d = g;
                ...
                var h = ed(a, c, f);
                b = Xc(h, b, d);
                void 0 == b ? d = g : (d && b.D !== h && F(a, c, b.D, f, !0), a.i[c] = b, Nc(a) && Lc(b.D), d = b)
            }
        }
        if (null == d) return d;
        Nc(d) && !Nc(a) && (d = d.La($b), F(a, c, d.D, e), a.i[c] = d);
        return d
    }
    ...
    function jd(a, b, c, d, e) {
        ...
        b = h || e;
        e = Kc(g);
        b && !e && (Object.isFrozen(g) && (a.i[c] = g = g.slice()), Lc(g), Object.freeze(g));
        !b && e && (a.i[c] = g = g.slice());
        return g
    }
    ...
    function ld(a, b, c, d) {
        ...
        if (null != d) {
            var e = Gc([]);
            for (var f = !1, g = 0; g < d.length; g++) e[g] = Wc(d[g], b).D, f = f || Kc(e[g]);
            a.i || (a.i = {});
            a.i[c] = d;
            Mc(e, !f)
        } else a.i && (a.i[c] = void 0), e = Qc;
        return F(a, c, e)
    }
    ...
    function od(a, b, c) {
        ...
        this.D = a;
        a: {
            d = this.D.length;a = d - 1;
            if (d && (d = this.D[a], Oc(d))) {
                this.l = a - this.Z;
                this.j = d;
                break a
            }
            void 0 !== b && -1 < b ? (this.l = Math.max(b, a + 1 - this.Z), this.j = void 0) : this.l = Number.MAX_VALUE
        }
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.Z, (d = this.D[a]) ? Array.isArray(d) && Gc(d) : this.D[a] = Qc;
                else {
                    d = dd(this);
                    var e = d[a];
                    e ? Array.isArray(e) && Gc(e) : d[a] = Qc
                }
    }
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length) {
                            ...
                            if (h) {
                                for (h = 0; h < k.length; h++)(l = k[h]) && Nc(l) && !f && (k[h] = k[h].La($b), g[h] = k[h].D);
                                Mc(g, !0)
                            }
                            f = k;
    ...
    function vd(a, b, c, d, e, f) {
        (a = a.i && a.i[c]) ? Array.isArray(a) ? (e = f.Ca ? Gc(a.slice()) : a, ld(b, 0 < e.length ? e[0].constructor : void 0, c, e)) : H(b, a.constructor, c, a): (yc && d instanceof Uint8Array ? e = d.length ? new Bc(new Uint8Array(d)) : Ac || (Ac = new Bc(null)) : (Array.isArray(d) && (e ? Lc(d) : Fc(d) && f.Ca && (d = d.slice())), e = d), F(b, c, e))
    };
    ...
    if (Sc) {
        var wd = {};
        Object.defineProperties(I, (wd[Symbol.hasInstance] = Tc(Object[Symbol.hasInstance]), wd))
    };
    var xd = window;
    xb("csi.gstatic.com");
    ...
    */
    ...
    function Bd(a, b) {
        ...
        for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof yd && d.isValid(a)) return new Hb(a, Ib)
        }
    }
    ...
    function Dd(a, b) {
        ...
        b instanceof Hb && b.constructor === Hb ? b = b.i : (Na(b), b = "type_error:SafeUrl");
        a.src = b;
    ...
    var Rd = "client_dev_mss_url client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");
    ia(Rd);
            ...
            for (p = 0; 80 > p; p++) {
                if (40 > p)
                    if (20 > p) {
                        var M = G ^ y & (z ^ G);
                        var P = 1518500249
                    } else M = y ^ z ^ G, P = 1859775393;
                else 60 > p ? (M = y & z | G & (y | z), P = 2400959708) : (M = y ^ z ^ G, P = 3395469782);
    ...
    function Td(a, b, c) {
        ...
        return d && a && b ? [b, Ud(Qd(d), a, c || null)].join(" ") : null
    }
    ...
    n.clear = function() {
        for (var a = (this.i.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = zb(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        for (a = b.length - 1; 0 <= a; a--) this.remove(b[a])
    };
    var Yd = new Xd("undefined" == typeof document ? null : document);

    function Zd(a) {
        return !!Wd.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a)
    }

    function $d(a, b, c, d) {
        (a = A[a]) || (a = (new Xd(document)).get(b));
    ...
    function ae(a) {
        ...
        Zd(e) && (f = f || A.__1PSAPISID);
        if (f) e = !0;
        else {
            var g = new Xd(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            Zd(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new Xd(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? Td(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && Zd(b) && ((b = $d("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = $d("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    oe.prototype.add = function(a, b, c, d, e) {
        ...
        var g = pe(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ra = !1)) : (b = new me(b, this.src, f, !!d, e), b.ra = c, a.push(b));
        return b
    };
    oe.prototype.remove = function(a, b, c, d) {
        ...
        b = pe(e, b, c, d);
        return -1 < b ? (ne(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.i--), !0) : !1
    };

    function qe(a, b) {
        var c = b.type;
        c in a.listeners && eb(a.listeners[c], b) && (ne(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }

    function pe(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.la && f.listener == b && f.capture == !!c && f.wa == d) return e
        }
        return -1
    };
    ...
    function ue(a, b, c, d, e) {
        ...
        else c = we(c), a && a[ke] ? a.S(b, c, Pa(d) ? !!d.capture : !!d, e) : xe(a, b, c, !1, d, e)
    }
    ...
    function xe(a, b, c, d, e, f) {
        ...
        if (!c.proxy) {
            ...
            else if (a.attachEvent) a.attachEvent(Ae(b.toString()), d);
    ...
    function ve(a, b, c, d, e) {
        ...
        else c = we(c), a && a[ke] ? a.l.add(String(b), c, !0, Pa(d) ? !!d.capture : !!d, e) : xe(a, b, c, !0, d, e)
    }

    function Ce(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Ce(a, b[f], c, d, e);
        else(d = Pa(d) ? !!d.capture : !!d, c = we(c), a && a[ke]) ? a.l.remove(String(b), c, d, e) : a && (a = ye(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = pe(b, c, d, e)), (c = -1 < a ? b[a] : null) && De(c))
    }
    ...
    function De(a) {
        if ("number" !== typeof a && a && !a.la) {
            ...
            if (b && b[ke]) qe(b.l, a);
                ...
                te--;
                (c = ye(b)) ? (qe(c, a), 0 == c.i && (c.src = null, b[re] = null)) : ne(a)
            }
        }
    }
    ...
    function Fe(a, b) {
        ...
        a = a.Aa;
        c = b.type || b;
        "string" === typeof b ? b = new ce(b, a) : b instanceof ce ? b.target = b.target || a : (e = b, b = new ce(c, a), pb(b, e));
        e = !0;
        if (d)
        ...
        b.l || (g = b.i = a, e = Ge(g, c, !0, b) && e, b.l || (e = Ge(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.l && f < d.length; f++) g = b.i = d[f], e = Ge(g, c, !1, b) && e
    }
    ...
    function Je(a) {
        a.B = a.K.M(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return a.i ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.s(3) : w(c, Ie(a), 3) : w(c, Ie(a), 3);
                Je(a);
                c.i = 0
            })
        }, 3E4)
    ...
    function Ie(a, b) {
        return a.u ? a.u : a.u = new Promise(function(c) {
            ...
            return x(function(h) {
                switch (h.i) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, xa(h, 2, 3), d && (a.j = a.K.M(function() {
                            d.abort()
                    ...
                    case 3:
                        Aa(h);
                        a.u = void 0;
                        a.j && (a.K.aa(a.j), a.j = 0);
                        g !== a.i && (a.i = g, a.i ? Fe(a, "networkstatus-online") : Fe(a, "networkstatus-offline"));
                        c(g);
                        Ba(h);
                        break;
                    case 2:
    ...
    v(We, I);
    var Pe = [10, 6];
    var Ze = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function af() {
        ...
        a = a.navigator.userAgentData.getHighEntropyValues(Ze).then(function(e) {
    ...
    function bf(a) {
        var b;
        return Xe(Ve(Ue(Te(Se(Re(Qe(Ye(new Oe, a.platform || ""), a.platformVersion || ""), a.architecture || ""), a.model || ""), a.uaFullVersion || ""), a.bitness || ""), (null == (b = a.fullVersionList) ? void 0 : b.map(function(c) {
            var d = new We;
            d = F(d, 1, c.brand);
    ...
    function cf() {
        var a, b;
        return null != (b = null == (a = af()) ? void 0 : a.then(function(c) {
            return bf(c)
        })) ? b : null
    };
    ...
    uf.prototype.update = function(a, b) {
        if (null != a) {
            ...
            for (var c = b - this.blockSize, d = 0, e = this.m, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) vf(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    function zf(a) {
        if (a instanceof Af || a instanceof Bf || a instanceof Cf) return a;
        if ("function" == typeof a.next) return new Af(function() {
            return a
        });
        if ("function" == typeof a[Symbol.iterator]) return new Af(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.L) return new Af(function() {
            return a.L()
        });
    ...
    Af.prototype[Symbol.iterator] = function() {
        return new Cf(this.j())
    };
    Af.prototype.i = function() {
        return new Cf(this.j())
    };
    ...
    function Df(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Df)
                for (c = Ef(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    n.delete = function(a) {
        return Gf(this.j, a) ? (delete this.j[a], --this.size, this.l++, this.i.length > 2 * this.size && Ff(this), !0) : !1
    };
    ...
    function Ff(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], Gf(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    n.get = function(a, b) {
        return Gf(this.j, a) ? this.j[a] : b
    };
    n.set = function(a, b) {
        Gf(this.j, a) || (this.size += 1, this.i.push(a), this.l++);
        this.j[a] = b
    };
    n.forEach = function(a, b) {
        for (var c = Ef(this), d = 0; d < c.length; d++) {
            var e = c[d],
                f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    n.keys = function() {
        return zf(this.L(!0)).i()
    };
    n.values = function() {
        return zf(this.L(!1)).i()
    };
    n.entries = function() {
        var a = this;
    ...
    Kf.prototype.then = function(a, b, c) {
        return Pf(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
    Kf.prototype.$goog_Thenable = !0;
    Kf.prototype.cancel = function(a) {
        if (0 == this.i) {
            var b = new mg(a); of (function() {
                ng(this, b)
            }, this)
        }
    };
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? ng(c, b) : (f ? (d = f, d.next == c.o && (c.o = d), d.next = d.next.next) : og(c), pg(c, e, 3, b)))
                }
                a.l = null
            } else Lf(a, 3, b)
    }
    ...
    function Pf(a, b, c, d) {
        ...
        e.i = new Kf(function(f, g) {
            ...
            e.onRejected = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof mg ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function Lf(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.u = c, a.i = b, a.l = null, rg(a), 3 != b || c instanceof mg || tg(a, c))
        }
    }
    ...
    Kf.prototype.B = function() {
        for (var a; a = og(this);) pg(this, a, this.i, this.u);
        this.v = !1
    };
    ...
    function pg(a, b, c, d) {
        ...
        if (b.i) b.i.l = null, ug(b, c, d);
        else try {
            b.l ? b.j.call(b.context) : ug(b, c, d)
        } catch (e) {
            vg.call(null, e)
        }
        ef(Nf, b)
    ...
    n.oa = function(a) {
        ...
        if (b) {
            var c = this.j[b];
            0 != this.m ? (this.l.push(a), this.i[a + 1] = function() {}) : (c && eb(c, a), delete this.i[a], delete this.i[a + 1], delete this.i[a + 2])
        }
        return !!b
    };
    n.fa = function(a, b) {
        ...
        if (c) {
            ...
            if (this.B)
                for (e = 0; e < c.length; e++) {
                    var g = c[e];
                    yg(this.i[g + 1], this.i[g + 2], d)
                } else {
                    this.m++;
                    try {
                        for (e = 0, f = c.length; e < f && !this.o; e++) g = c[e], this.i[g + 1].apply(this.i[g + 2], d)
                    } finally {
    ...
    zg.prototype.set = function(a, b) {
        void 0 === b ? this.i.remove(a) : this.i.set(a, If(b))
    };
    ...
    function Cg(a) {
        return void 0 === a || a instanceof Bg ? a : new Bg(a)
    }
    Ag.prototype.set = function(a, b) {
        Ag.O.set.call(this, a, Cg(b))
    };
    Ag.prototype.j = function(a) {
        a = Ag.O.get.call(this, a);
    ...
    Dg.prototype.set = function(a, b, c) {
        if (b = Cg(b)) {
            if (c) {
                if (c < Date.now()) {
                    Dg.prototype.remove.call(this, a);
                    return
                }
                b.expiration = c
            }
        ...
        Dg.O.set.call(this, a, b)
    };
    Dg.prototype.j = function(a) {
        var b = Dg.O.j.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) Dg.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function Ig(a, b) {
        ...
        this.i = null;
        var c;
        if (c = ec) c = !(9 <= Number(qc));
        if (c) {
            Jg || (Jg = new Df);
            this.i = Jg.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), Jg.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    n.set = function(a, b) {
        this.i.setAttribute(Lg(a), b);
        Mg(this)
    };
    n.get = function(a) {
        a = this.i.getAttribute(Lg(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    n.remove = function(a) {
        this.i.removeAttribute(Lg(a));
        Mg(this)
    };
    n.L = function(a) {
        var b = 0,
        ...
        d.next = function() {
            if (b >= c.length) return xf;
            var e = c[b++];
            if (a) return yf(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1));
            e = e.nodeValue;
            if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered";
            return yf(e)
        };
    ...
    Ng.prototype.L = function(a) {
        ...
        d.next = function() {
            ...
            return yf(a ? e.slice(c.i.length) : c.j.get(e))
        };
        return d
    };
    ...
    v(Og, I);
    Og.prototype.getKey = function() {
        return ed(this, 1)
    };
    Og.prototype.X = function() {
        return ed(this, 2 === hd(this, Pg) ? 2 : -1)
    };
    Og.prototype.setValue = function(a) {
        return gd(this, 2, Pg, a)
    };
    var Pg = [2, 3, 4, 5, 6];
    ...
    v(Ug, I);
    Ug.prototype.getPlayerType = function() {
        return ed(this, 36)
    };
    Ug.prototype.setHomeGroupInfo = function(a) {
        return H(this, Sg, 81, a)
    };
    var Vg = [9, 66, 24, 32, 86, 100, 101];
    ...
    v(Yg, I);
    Yg.prototype.setToken = function(a) {
        return F(this, 2, a)
    };
    ...
    v(Zg, I);
    Zg.prototype.setSafetyMode = function(a) {
        return F(this, 5, a)
    };
    var $g = [12];
    ...
    v(eh, I);
    eh.prototype.getKey = function() {
        return nd(this, 1)
    };
    eh.prototype.X = function() {
        return nd(this, 2)
    };
    eh.prototype.setValue = function(a) {
        return F(this, 2, a)
    };
    var dh = [4, 5];
    ...
    v(th, I);
    th.prototype.setVideoId = function(a) {
        return gd(this, 1, uh, a)
    };
    th.prototype.getPlaylistId = function() {
        return ed(this, 2 === hd(this, uh) ? 2 : -1)
    };
    var uh = [1, 2];
    ...
    var wh = [3];
    var xh = A.window,
        yh, zh, Ah = (null == xh ? void 0 : null == (yh = xh.yt) ? void 0 : yh.config_) || (null == xh ? void 0 : null == (zh = xh.ytcfg) ? void 0 : zh.data_) || {};
    C("yt.config_", Ah);

    function Bh() {
        var a = arguments;
        1 < a.length ? Ah[a[0]] = a[1] : 1 === a.length && Object.assign(Ah, a[0])
    }

    function N(a, b) {
        return a in Ah ? Ah[a] : b
    }
    ...
    function Hh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = N("ERRORS", []), e.push([a, "ERROR", b, c, d]), Bh("ERRORS", e));
        Fh(a)
    }

    function Ih(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = N("ERRORS", []), e.push([a, "WARNING", b, c, d]), Bh("ERRORS", e))
    };
    var Jh = 0;
    ...
    function Lh(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in Kh || (this[b] = a[b]);
    ...
    Lh.prototype.stopImmediatePropagation = function() {
    ...
    var Mh = A.ytEventsEventsCounter || {
        count: 0
    };
    C("ytEventsEventsCounter", Mh);
        ...
        a && ("string" == typeof a && (a = [a]), D(a, function(b) {
            if (b in lb) {
                var c = lb[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Ph() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete lb[b]
            }
        }))
    }
    ...
    function Qh(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                g = Gh(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Ph() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                lb[e] = [a, b, c, g, d]
            }
        }
    };
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                ...
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: Xh == m ? "unchanged" : m
                }];
                Uh.hasOwnProperty(l) || Ih(k)
            }
        }
        return c
    }
    ...
    function Wh(a) {
        return a && a.match(Th) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function ei(a) {
        ...
        p = [P, kb, p, y, vc, va, z, G, K, M];
        y = b.i.top;
        try {
            var na = (y || window).document,
                Y = "CSS1Compat" ==
                na.compatMode ? na.documentElement : na.body;
            var ca = (new Ed(Y.clientWidth, Y.clientHeight)).round()
        } catch (X) {
            ca = new Ed(-12245933, -12245933)
        }
        na = ca;
        ca = {};
        var da = void 0 === da ? A : da;
        Y = new Me;
        da.SVGElement && da.document.createElementNS && Y.set(0);
        y = Ld();
        y["allow-top-navigation-by-user-activation"] && Y.set(1);
        y["allow-popups-to-escape-sandbox"] && Y.set(2);
        da.crypto && da.crypto.subtle && Y.set(3);
        da.TextDecoder && da.TextEncoder && Y.set(4);
        da = Ne(Y);
        ca.bc = da;
        ca.bih = na.height;
        ca.biw = na.width;
    ...
    Date.now();
    var gi = "XMLHttpRequest" in A ? function() {
    ...
    var ii = {
        ...
        ji = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Rd)),
        ki = !1;
    ...
    function li(a, b) {
        ...
        if (c || !Qb(a)) b["X-YouTube-Ad-Signals"] = Yh(ei());
        return b
    }
    ...
    function mi(a) {
        var b = window.location.search,
            c = Qb(a);
        O("debug_handle_relative_url_for_query_forward_killswitch") || c || !ai(a) || (c = document.location.hostname);
        ...
        var d = pi(a, b),
            ...
            f = qi(a, function(k) {
                if (!e) {
                    ...
                    if (l || q || t) m = ri(a, c, k, b.convertToSafeHtml);
    ...
    function oi(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = $h(a, b || {}, !0);
        return a
    }
    ...
    function pi(a, b) {
        ...
        if (!(a = e) && (a = f)) {
            ...
            a = !f
        }!ki && a && "POST" != b.method && (ki = !0, Hh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Ih(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? si(a) : null) e = {}, D(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = ti(g)
                })
        }
        d && ui(e);
    ...
    function qi(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && Gh(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = hi();
        ...
        O("debug_forward_web_query_parameters") && (a = mi(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    var vi = {
        Pb: "WEB_DISPLAY_MODE_UNKNOWN",
        Lb: "WEB_DISPLAY_MODE_BROWSER",
        Nb: "WEB_DISPLAY_MODE_MINIMAL_UI",
        Ob: "WEB_DISPLAY_MODE_STANDALONE",
        Mb: "WEB_DISPLAY_MODE_FULLSCREEN"
    };
    ...
    function Ci() {
        return "INNERTUBE_API_KEY" in Ah && "INNERTUBE_API_VERSION" in Ah
    }
    ...
    function Di() {
        return {
            ...
            Ua: N("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            qb: N("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            innertubeContextClientVersion: N("INNERTUBE_CONTEXT_CLIENT_VERSION"),
            Wa: N("INNERTUBE_CONTEXT_HL"),
            Va: N("INNERTUBE_CONTEXT_GL"),
            rb: N("INNERTUBE_HOST_OVERRIDE") || "",
            tb: !!N("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            sb: !!N("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Ei(a) {
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = u(Object.entries(Zh(N("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function Ji(a) {
        ...
        Hi(a, c);
        Ii(c);
        N("DELEGATED_SESSION_ID") && !O("pageid_as_header_web") && (a = new Zg, F(a, 3, N("DELEGATED_SESSION_ID")));
        a = u(Object.entries(Zh(N("DEVICE", ""))));
    ...
    function Fi(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                c = id(b, Rg, 96) || new Rg;
                var d = wi();
                d = Object.keys(vi).indexOf(d);
                d = -1 === d ? null : d;
                null !== d && F(c, 3, d);
                H(b, Rg, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = wi())
    }
    ...
    function Ii(a, b) {
        a: {
            var c = Bi();
            if (c) {
                var d = xi[c.type || "unknown"] || "CONN_UNKNOWN";
                c = xi[c.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        d && (a ? F(a, 61, yi[d]) : b && (b.client.connectionType = d));O("web_log_effective_connection_type") && (d = Bi(), d = null != d && d.effectiveType ? Ai.hasOwnProperty(d.effectiveType) ? Ai[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d && (a ? F(a, 94, zi[d]) :
    ...
    function Ki(a, b, c) {
        ...
        (b = c.Rb || N("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().Qb : b = ae([]));
    ...
    function Mi(a) {
        var b = new Hg;
        (b = b.isAvailable() ? a ? new Ng(b, a) : b : null) || (a = new Ig(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.i = (a = b) ? new Dg(a) : null;
        this.j = document.domain || window.location.hostname
    }
    Mi.prototype.set = function(a, b, c, d) {
        c = c || 31104E3;
        this.remove(a);
        if (this.i) try {
    ...
    Mi.prototype.get = function(a, b) {
        ...
        if (d && (c = Yd.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    Mi.prototype.remove = function(a) {
        ...
        var b = this.j;
        Yd.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var Ni = window,
        Q = Ni.ytcsi && Ni.ytcsi.now ? Ni.ytcsi.now : Ni.performance && Ni.performance.timing && Ni.performance.now && Ni.performance.timing.navigationStart ? function() {
            return Ni.performance.timing.navigationStart + Ni.performance.now()
        } : function() {
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(Q()) - d.requestTime)) {
                    var e = d.authState,
                        f = Li(Ki(!1));
                    mb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(Q())), Ti(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Pi().set("requests", b, 86400, !0)
    ...
    function Wi(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Rh(a, c || 0)
    }
    Yi.prototype.aa = function(a) {
    ...
    function bj() {
        var a;
        return null == (a = aj()) ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    };
    var cj = [],
        dj = !1;
    ...
    function ij() {
        ...
        throw new gj("Datasync ID not set", "unknown");
    };
    ...
    var lj = {},
        mj = (lj.AUTH_INVALID = "No user identifier specified.", lj.EXPLICIT_ABORT = "Transaction was explicitly aborted.", lj.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", lj.MISSING_INDEX = "Index not created.", lj.MISSING_OBJECT_STORES = "Object stores not created.", lj.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.", lj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "Database is reopened because expected object stores were not created.", lj.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
            lj.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", lj.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", lj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", lj.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", lj),
        nj = {},
        oj = (nj.AUTH_INVALID = "ERROR", nj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", nj.EXPLICIT_ABORT = "IGNORED", nj.IDB_NOT_SUPPORTED = "ERROR", nj.MISSING_INDEX =
            "WARNING", nj.MISSING_OBJECT_STORES = "ERROR", nj.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING", nj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "WARNING", nj.QUOTA_EXCEEDED = "WARNING", nj.QUOTA_MAYBE_EXCEEDED = "WARNING", nj.UNKNOWN_ABORT = "WARNING", nj.INCOMPATIBLE_DB_VERSION = "WARNING", nj),
        pj = {},
        qj = (pj.AUTH_INVALID = !1, pj.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, pj.EXPLICIT_ABORT = !1, pj.IDB_NOT_SUPPORTED = !1, pj.MISSING_INDEX = !1, pj.MISSING_OBJECT_STORES = !1, pj.DB_DELETED_BY_MISSING_OBJECT_STORES = !1, pj.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1, pj.QUOTA_EXCEEDED = !1, pj.QUOTA_MAYBE_EXCEEDED = !0, pj.UNKNOWN_ABORT = !0, pj.INCOMPATIBLE_DB_VERSION = !1, pj);
    ...
    function rj(a, b) {
        T.call(this, "MISSING_OBJECT_STORES", {
            ...
            foundObjectStores: a
        }, mj.MISSING_OBJECT_STORES);
        Object.setPrototypeOf(this, rj.prototype)
    }
    v(rj, T);
    ...
    function sj(a, b) {
        ...
        this.index = a;
        this.objectStore = b;
        Object.setPrototypeOf(this, sj.prototype)
    }
    v(sj, Error);
    var tj = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function uj(a, b, c, d) {
        ...
        if (tc && "UnknownError" === e.name) return new T("QUOTA_MAYBE_EXCEEDED", a);
        if (e instanceof sj) return new T("MISSING_INDEX", Object.assign({}, a, {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && tj.some(function(f) {
    ...
    U.all = function(a) {
        return new U(new yj(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    ca: f.ca
                }, ++f.ca) zj(U.resolve(a[f.ca]).then(function(g) {
                return function(h) {
                    d[g.ca] = h;
                    e--;
                    0 === e && b(d)
    ...
    U.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : xj,
            e = null != b ? b : wj;
        return new U(new yj(function(f, g) {
            "PENDING" === c.state.status ? (c.i.push(function() {
                Aj(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Bj(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Aj(c, c, d, f, g) : "REJECTED" === c.state.status && Bj(c, c, e, f, g)
        }))
    };
    ...
    function Aj(a, b, c, d, e) {
        try {
            ...
            f instanceof U ? Cj(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function Fj(a, b) {
        return new U(new yj(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
        ...
        return x(function(G) {
            switch (G.i) {
                ...
                case 2:
                    ...
                    return w(G, K, 6);
                case 6:
                    return m = G.j, q = Math.round(Q()), Nj(a, k, q, g, void 0, b.join(), e), G.return(m);
                case 4:
                    t = za(G);
                    p = Math.round(Q());
                    y = uj(t, a.i.name, b.join(), a.i.version);
                    if ((z = y instanceof T && !y.i) || g >= f) Nj(a, k, p, g, y, b.join(), e), h = y;
                    G.s(2);
                    break;
                case 3:
    ...
    function Nj(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof T && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && fj("QUOTA_EXCEEDED", {
            dbName: kj(a.i.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof T && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), fj("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.j = !0), Ck(a, !1, d, f, b, g.tag), ej(e)) : Ck(a, !0, d, f, b, g.tag)
    }

    function Ck(a, b, c, d, e, f) {
        fj("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    n.delete = function(a) {
        return a instanceof IDBKeyRange ? Dk(this, a) : V(this.i.delete(a))
    };
    n.get = function(a) {
    ...
    n.index = function(a) {
        try {
            return new Fk(this.i.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new sj(a, this.i.name);
            throw b;
        }
    };
    n.getName = function() {
    ...
    Lj.prototype.abort = function() {
        this.i.abort();
        this.j = !0;
        throw new T("EXPLICIT_ABORT");
    };
    Lj.prototype.objectStore = function(a) {
        a = this.i.objectStore(a);
        var b = this.l.get(a);
        b || (b = new Jj(a), this.l.set(a, b));
        return b
    };
    ...
    function Gk(a) {
        return V(a).then(function(b) {
            return b ? new Ik(a, b) : null
        })
    }
    n = Ik.prototype;
    n.advance = function(a) {
        this.cursor.advance(a);
        return Gk(this.request)
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(p) {
                try {
                    ...
                    p.dataLoss && "none" !== p.dataLoss && fj("IDB_DATA_CORRUPTED", {
                        reason: p.dataLossMessage || "unknown reason",
                        dbName: kj(a)
                    });
                    var y = f(),
                        z = new Lj(g.transaction);
                    m && m(y, function(G) {
    ...
    Nk.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return Kk(a, b, c)
    };
    Nk.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return Lk(this.name, a)
    };
    ...
    function Pk(a, b) {
        if (!b) throw vj("openWithToken", kj(a.name));
        return Qk(a)
    }
                ...
                switch (z.i) {
                    ...
                    case 4:
                        ...
                        for (var G = a.options, K = [], M = u(Object.keys(G.ka)), P = M.next(); !P.done; P = M.next()) {
                            P = P.value;
                            var kb = G.ka[P],
                                vc = void 0 === kb.wb ? Number.MAX_VALUE : kb.wb;
                            !(h.i.version >= kb.Ba) || h.i.version >= vc || h.i.objectStoreNames.contains(P) || K.push(P)
                        }
                        k = K;
                        if (0 === k.length) {
                            z.s(5);
                        ...
                        if (!(a.m < ci("ytidb_remake_db_retries", 1))) {
                            z.s(6);
                            break
                        }
                        a.m++;
                    ...
                    case 9:
                        return ej(new T("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: l,
                            foundObjectStores: m
                        })), z.return(b());
                    ...
                    case 11:
                        ...
                        return z.return(t);
                    case 10:
                        throw c(), q instanceof Error && !O("ytidb_async_stack_killswitch") && (q.stack = q.stack + "\n" + g.substring(g.indexOf("\n") + 1)), uj(q, a.name, "", null != (y = a.options.version) ? y : -1);
                }
            })
        }
    ...
    function Sk(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.i) return w(d, Pk(Rk, b), 2);
            c = d.j;
            return d.return(Hj(c, ["databases"], {
                I: !0,
                mode: "readwrite"
            }, function(e) {
                var f = e.objectStore("databases");
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1) return V(f.i.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    ...
    function Tk(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.i) return a ? w(d, Pk(Rk, b), 2) : d.return();
            c = d.j;
    ...
    function Uk(a, b) {
        var c, d;
        return x(function(e) {
            return 1 == e.i ? (c = [], w(e, Pk(Rk, b), 2)) : 3 != e.i ? (d = e.j, w(e, Hj(d, ["databases"], {
                I: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
                return Ek(f.objectStore("databases"), {}, function(g) {
                    a(g.X()) && c.push(g.X());
                    return g.continue()
                })
            }), 3)) : e.return(c)
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = $i) f = /WebKit\/([0-9]+)/.exec(Kb()), f = !!(f && 600 <= parseInt(f[1], 10));
                    ...
                    return w(e, Sk(d, Xk), 4);
                case 4:
                    return w(e, Tk("yt-idb-test-do-not-use", Xk), 5);
                case 5:
                    return e.return(!0);
                case 2:
    ...
    function Zk() {
        if (void 0 !== Wk) return Wk;
        dj = !0;
        return Wk = Yk().then(function(a) {
            dj = !1;
            var b;
            if (null != (b = aj()) && b.i) {
                var c;
                b = {
                    hasSucceededOnce: (null == (c = bj()) ? void 0 : c.hasSucceededOnce) || a
                };
                var d;
                null == (d = aj()) || d.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0)
            }
            return a
        })
    }
    ...
    function al() {
        var a = $k();
        return a ? Promise.resolve(a) : Zk().then(function(b) {
            (b = b ? Xk : void 0) && C("ytglobal.idbToken_", b);
            return b
        })
    };
    new Jf;
    ...
    function bl(a) {
        if (!hj()) throw a = new T("AUTH_INVALID", {
            dbName: a
        }), ej(a), a;
        var b = ij();
        return {
    ...
    function cl(a, b, c, d) {
        ...
        return x(function(m) {
            switch (m.i) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", w(m, al(), 2);
                case 2:
                    g = m.j;
                    if (!g) throw h = vj("openDbImpl", a, b), O("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), ej(h), h;
                    jj(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                    ...
                    return w(m, Sk(k, g), 5);
                case 5:
                    return w(m, Kk(k.actualName, b, d), 6);
                case 6:
                    return m.return(m.j);
                case 3:
                    return l = za(m), xa(m, 7), w(m, Tk(k.actualName, g), 9);
                case 9:
                    ya(m,
                        8);
                    break;
    ...
    function fl(a, b) {
        ...
        var c, d;
        return x(function(e) {
            if (1 == e.i) return w(e, al(), 2);
            if (3 != e.i) {
                c = e.j;
                if (!c) return e.return();
                jj(a);
                d = bl(a);
                return w(e, Lk(d.actualName, b), 3)
            }
            return w(e, Tk(d.actualName, c), 0)
        })
    }
    ...
    function gl(a, b, c) {
        a = a.map(function(d) {
            return x(function(e) {
                return 1 == e.i ? w(e, Lk(d.actualName, b), 2) : w(e, Tk(d.actualName, c), 0)
            })
        });
    ...
    function jl(a) {
        ...
        var c;
        this.fb = null != (c = a.fb) ? c : 1;
        var d;
        this.cb = null != (d = a.cb) ? d : 2592E6;
        var e;
        this.bb = null != (e = a.bb) ? e : 12E4;
        var f;
        this.eb = null != (f = a.eb) ? f : 5E3;
        var g;
        ...
        this.Ia = a.Ia;
        this.Ha = a.Ha;
        kl(this) && (!this.C || this.C("networkless_logging")) && ll(this)
    }

    function ll(a) {
        kl(a) && !a.ha && (a.i = !0, a.va && Math.random() <= a.ta && a.F.mb(a.A), ml(a), a.H.G() && a.na(), a.H.S(a.Ia, a.na.bind(a)), a.H.S(a.Ha, a.Oa.bind(a)))
    }
    n = jl.prototype;
    ...
    n.sendThenWrite = function(a, b, c) {
        ...
        if (kl(this) && this.i) {
            ...
            this.C && this.C("nwl_skip_retry") && (e.skipRetry = c);
            if (this.H.G() || this.C && this.C("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function() {};
                    b.onError = function(g, h) {
                        return x(function(k) {
                            if (1 == k.i) return w(k, d.F.set(e, d.A).catch(function(l) {
                                ol(d, l)
                            }), 2);
                            f(g, h);
                            k.i = 0
            ...
            } else this.F.set(e, this.A).catch(function(g) {
                d.U(a, b, e.skipRetry);
                ol(d, g)
            })
        } else this.U(a, b, this.C && this.C("nwl_skip_retry") && c)
    };
    n.sendAndWrite = function(a, b) {
        ...
        if (kl(this) && this.i) {
            ...
            d.options.onSuccess = function(g, h) {
                ...
                c.H.T && c.C && c.C("vss_network_hint") && c.H.T(!0);
                f(g, h)
            };
    ...
    n.na = function() {
        var a = this;
        if (!kl(this)) throw vj("throttleSend");
        this.j || (this.j = this.K.M(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return w(c, a.F.Ta("NEW", a.A), 2);
                if (3 != c.i) return b = c.j, b ? w(c, nl(a, b), 3) : (a.Oa(), c.return());
                a.j && (a.j = 0, a.na());
                c.i = 0
            })
        }, this.gb))
    ...
    function nl(a, b) {
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    if (!kl(a)) throw c = vj("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.s(2);
                        break
                    }
                    return w(e, a.F.ub(b.id, a.A), 3);
                case 3:
                ...
                case 8:
                    a.U(b.url, b.options, !!b.skipRetry), e.i = 0
            }
        })
    }

    function ql(a, b) {
        if (!kl(a)) throw vj("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return x(function(l) {
                switch (l.i) {
                    case 1:
                        g = rl(f);
                        if (!(a.C && a.C("nwl_consider_error_code") && g || a.C && !a.C("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.ya)) {
                            l.s(2);
                            break
                        }
                        if (!a.H.V) {
                    ...
                    case 3:
                        ...
                        c(e, f);
                        if (!a.C || !a.C("nwl_consider_error_code") || void 0 === (null == (h = b) ? void 0 : h.id)) {
                            l.s(6);
                            break
                        }
                        return w(l, a.F.Ja(b.id, a.A, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        if (a.C && a.C("nwl_consider_error_code") &&
                            !g && a.potentialEsfErrorCounter > a.ya) return l.return();
                        a.potentialEsfErrorCounter++;
                        if (void 0 === (null == (k = b) ? void 0 : k.id)) {
                            l.s(8);
                            break
                        }
                        return b.sendCount < a.fb ? w(l, a.F.Ja(b.id, a.A), 12) : w(l, a.F.da(b.id, a.A), 8);
                    case 12:
                        a.K.M(function() {
                            a.H.G() && a.na()
                        }, a.eb);
        ...
        b.options.onSuccess = function(e, f) {
            var g;
            return x(function(h) {
                if (1 == h.i) return void 0 === (null == (g = b) ? void 0 : g.id) ? h.s(2) : w(h, a.F.da(b.id, a.A), 2);
                a.H.T && a.C && a.C("vss_network_hint") && a.H.T(!0);
                d(e, f);
                h.i = 0
            })
        };
    ...
    function ml(a) {
        if (!kl(a)) throw vj("retryQueuedRequests");
        a.F.Ta("QUEUED", a.A).then(function(b) {
            b && !pl(a, b, a.bb) ? a.K.M(function() {
                return x(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.s(2) : w(c, a.F.Ja(b.id, a.A), 2);
                    ml(a);
                    c.i = 0
                })
            }) : a.H.G() && a.na()
    ...
    function ol(a, b) {
        a.hb && !a.H.G() ? a.hb(b) : a.handleError(b)
    }
    ...
    var sl = B("ytPubsub2Pubsub2Instance") || new L;
    ...
    tl.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ka ? el : dl)(a, b, Object.assign({}, c))
    };
    tl.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ka ? il : fl)(this.name, a)
    };
    ...
    function xl() {
        if (wl) return wl();
        var a = {};
        wl = vl("LogsDatabaseV2", {
            ka: (a.LogsRequestsStore = {
                Ba: 2
            }, a),
            Ka: !1,
            upgrade: function(b, c, d) {
                c(2) && Ij(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
    ...
    function Bl(a, b) {
        ...
        return x(function(l) {
            ...
            if (3 != l.i) return d = l.j, e = N("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, Q()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, Hj(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    I: !0
                }, function(m) {
                    return Hk(m.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: h,
                        direction: "prev"
                    }, function(q) {
                        q.X() && (k = q.X(), "NEW" === a && (k.status = "QUEUED", q.update(k)))
                    })
                }),
                3);
            c.zb = Q();
    ...
    function Cl(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.i) return w(d, yl(b), 2);
            c = d.j;
            return d.return(Hj(c, ["LogsRequestsStore"], {
                mode: "readwrite",
                I: !0
            }, function(e) {
                var f = e.objectStore("LogsRequestsStore");
                return f.get(a).then(function(g) {
                    if (g) return g.status = "QUEUED", V(f.i.put(g, void 0)).then(function() {
                        return g
                    })
                })
            }))
    ...
    function Dl(a, b, c) {
        ...
        var d;
        return x(function(e) {
            if (1 == e.i) return w(e, yl(b), 2);
            d = e.j;
            return e.return(Hj(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                I: !0
            }, function(f) {
                var g = f.objectStore("LogsRequestsStore");
                return g.get(a).then(function(h) {
                    return h ? (h.status = "NEW", c && (h.sendCount += 1), V(g.i.put(h, void 0)).then(function() {
                        return h
                    })) : U.resolve(void 0)
                })
            }))
    ...
    function Fl(a) {
        var b, c;
        return x(function(d) {
            if (1 == d.i) return w(d, yl(a), 2);
            b = d.j;
            c = Q() - 2592E6;
            return w(d, Hj(b, ["LogsRequestsStore"], {
                mode: "readwrite",
                I: !0
            }, function(e) {
                return Ek(e.objectStore("LogsRequestsStore"), {}, function(f) {
    ...
    var Hl = {},
        Il = vl("ServiceWorkerLogsDatabase", {
            ka: (Hl.SWHealthLog = {
                Ba: 1
            }, Hl),
            Ka: !0,
            upgrade: function(a, b) {
                b(1) && Ij(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function Kl(a) {
        var b, c;
        x(function(d) {
            if (1 == d.i) return w(d, Jl(a), 2);
            b = d.j;
            c = Q() - 2592E6;
            return w(d, Hj(b, ["SWHealthLog"], {
                mode: "readwrite",
                I: !0
            }, function(e) {
                return Ek(e.objectStore("SWHealthLog"), {}, function(f) {
                    if (f.X().timestamp <= c) return f.delete().then(function() {
                        return f.continue()
                    })
                })
    ...
    function Ol(a) {
        ...
        var c = void 0 === c ? !1 : c;
        if (a)
            if (b) qi(a, void 0, "POST", b);
            else if (N("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) qi(a, void 0, "GET", "", void 0, void 0, c);
        else {
            b: {
                try {
                    var d = new Za({
    ...
    function Sl() {
        Rl || (Rl = new Mi("yt.offline"));
        return Rl
    }

    function Tl(a) {
        if (O("offline_error_handling")) {
            var b = Sl().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            Sl().set("errors", b, 2592E3, !0)
        }
    }

    function Ul() {
        if (O("offline_error_handling")) {
            var a = Sl().get("errors", !0);
            if (a) {
                for (var b in a)
                    if (a[b]) {
                        var c = new gj(b, "sent via offline_errors");
                        c.name = a[b].name;
                        c.stack = a[b].stack;
                        c.level = a[b].level;
                        Hh(c)
                    }
                Sl().set("errors", {}, 2592E3, !0)
            }
        }
    };
    var Vl = ci("network_polling_interval", 3E4);
    ...
    function Z() {
        ...
        this.B = this.m = !1;
        this.j = this.Da();
        O("use_shared_nsm") ? (this.i = Ke(), O("use_shared_nsm_and_keep_yt_online_updated") && (this.i.S("networkstatus-online", function() {
            a.j = !0;
            a.B && Ul()
    ...
    n.T = function(a) {
        if (O("use_shared_nsm") && this.i) {
            var b;
            null != (b = this.i) && (b.i = a)
        } else a !== this.j && (this.j = a)
    };
    n.vb = function(a) {
        !O("use_shared_nsm") && (this.m = !0, void 0 === a ? 0 : a) && (this.pa || Zl(this))
    };
    n.Da = function() {
    ...
    function Zl(a) {
        a.pa = Vi(function() {
            return x(function(b) {
                if (1 == b.i) return a.j ? a.Da() || !a.m ? b.s(3) : w(b, a.V(), 3) : w(b, a.V(), 3);
                Zl(a);
                b.i = 0
            })
        }, Vl)
    ...
    n.V = function(a) {
        ...
        if (O("use_shared_nsm") && this.i) {
            var c = Ie(this.i, a);
            c.then(function(d) {
                O("use_cfr_monitor") && Ql().requestComplete("generate_204", d)
            });
            return c
        }
        return this.u ? this.u : this.u = new Promise(function(d) {
            ...
            return x(function(k) {
                switch (k.i) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, xa(k, 2, 3), e && (b.P = Le.M(function() {
                            e.abort()
                    ...
                    case 3:
                        Aa(k);
                        O("use_cfr_monitor") && Ql().requestComplete("generate_204", h);
                        b.u = void 0;
                        b.P && Le.aa(b.P);
                        h !== b.j && (b.j = h, b.j && b.m ? Fe(b, "ytnetworkstatus-online") : b.m && Fe(b, "ytnetworkstatus-offline"));
                        d(h);
                        Ba(k);
                        break;
                    case 2:
    ...
    Z.prototype.enableErrorFlushing = Z.prototype.ob;
    Z.prototype.getWindowStatus = Z.prototype.Da;
    Z.prototype.monitorNetworkStatusChange = Z.prototype.vb;
    ...
    function $l(a) {
        ...
        c && c(a.Ra);
        a.Ya && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i)) && c();
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.i)) a.za ? (this.za = a.za, c(this.u,
            function() {
                am(b, "publicytnetworkstatus-online")
            }), c(this.m, function() {
            am(b, "publicytnetworkstatus-offline")
        })) : (c(this.u, function() {
            Fe(b, "publicytnetworkstatus-online")
        }), c(this.m, function() {
            Fe(b, "publicytnetworkstatus-offline")
        }))
    }
    v($l, J);
    ...
    $l.prototype.V = function(a) {
        ...
        return x(function(d) {
            ...
            return O("skip_network_check_if_cfr") && Ql().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
    ...
    function am(a, b) {
        a.za ? a.j ? (Le.aa(a.P), a.P = Le.M(function() {
            a.B !== b && (Fe(a, b), a.B = b, a.j = Q())
        }, a.za - (Q() - a.j))) : (Fe(a, b), a.B = b, a.j = Q()) : Fe(a, b)
    };
    var bm;
    ...
    function cm() {
        jl.call(this, {
            ...
            hb: Tl,
            K: Zi(),
            Ia: "publicytnetworkstatus-online",
            Ha: "publicytnetworkstatus-offline",
            va: !0,
            ta: .1,
            ya: ci("potential_esf_error_limit", 10),
            C: O,
            ha: !(hj() && "www.youtube-nocookie.com" !== Qb(document.location.toString()))
        });
        this.l = new Jf;
        O("networkless_immediately_drop_all_requests") && Gl();
        il("LogsDatabaseV2")
    }
    v(cm, jl);
    ...
    function fm() {
        ...
        a || (a = new cm, C("yt.networklessRequestController.instance", a), O("networkless_logging") && al().then(function(b) {
            a.A = b;
            ll(a);
            a.l.resolve();
            a.va && Math.random() <= a.ta && a.A && Kl(a.A);
            O("networkless_immediately_drop_sw_health_store") && gm(a)
        }));
        return a
    }
    cm.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        hj() || (this.i = !1);
        jl.prototype.writeThenSend.call(this, a, b)
    };
    cm.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        hj() || (this.i = !1);
        jl.prototype.sendThenWrite.call(this, a, b, c)
    };
    cm.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        hj() || (this.i = !1);
        jl.prototype.sendAndWrite.call(this, a, b)
    };
    ...
    function gm(a) {
        var b;
        x(function(c) {
            if (!a.A) throw b = vj("clearSWHealthLogsDb"), b;
            return c.return(Ll(a.A).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    function hm(a, b) {
        ...
        b.onError = function(e, f) {
            Ql().requestComplete(a, !1);
            c(e, f)
        };
        var d = b.onSuccess ? b.onSuccess : function() {};
        b.onSuccess = function(e, f) {
            Ql().requestComplete(a, !0);
            d(e, f)
        }
    };
    var im = 0,
        jm = 0,
        km, lm = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
            potentialEsfErrorCounter: jm
        };
    C("ytNetworklessLoggingInitializationOptions", lm);

    function mm(a, b) {
        function c(d) {
            var e = nm().G();
            if (!om() || !d || e && O("vss_networkless_bypass_write")) pm(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        O("skip_is_supported_killswitch") ? al().then(function(d) {
            c(d)
        }) : c($k())
    }
        ...
        function c(d) {
            if (om() && d) {
                ...
                e.options.onSuccess = function(k, l) {
                    O("use_cfr_monitor") && Ql().requestComplete(e.url, !0);
                    void 0 !== e.id ? El(e.id, d) : f = !0;
                    O("vss_network_hint") && nm().T(!0);
                    g(k, l)
                };
                if (O("use_cfr_monitor")) {
                    var h = b.onError ? b.onError : function() {};
                    e.options.onError = function(k, l) {
                        Ql().requestComplete(e.url, !1);
                        h(k, l)
                    }
                }
                pm(e.url, e.options);
                zl(e, d).then(function(k) {
                    e.id = k;
                    f && El(e.id, d)
                }).catch(function(k) {
                    nm().G() ? Hh(k) : Tl(k)
    ...
    function sm() {
        var a = $k();
        if (!a) throw vj("throttleSend");
        im || (im = Le.M(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return w(c, Bl("NEW", a), 2);
                if (3 != c.i) return b = c.j, b ? w(c, qm(b), 3) : (Le.aa(im), im = 0, c.return());
                im && (im = 0, sm());
                c.i = 0
            })
        }, 100))
    ...
    function qm(a) {
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    b = $k();
                    if (!b) throw c = vj("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.s(2);
                        break
                    }
                    return w(e, Cl(a.id, b), 3);
                case 3:
                    (d = e.j) ? a = d: Ih(Error("The request cannot be found in the database."));
                case 2:
                    var f = a.timestamp;
                    if (!(2592E6 <= Q() - f)) {
                        e.s(4);
                    ...
                    Ih(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.s(5);
                        break
                    }
                    return w(e, El(a.id, b), 5);
                case 5:
                    return e.return();
                case 4:
                    a.skipRetry || (a = tm(a));
                    ...
                    return w(e, El(a.id, b), 8);
                case 8:
                    pm(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    ...
    function tm(a) {
        var b = $k();
        if (!b) throw vj("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return x(function(l) {
                switch (l.i) {
                    case 1:
                        O("use_cfr_monitor") && Ql().requestComplete(a.url, !1);
                        g = rl(f);
                        if (!(O("nwl_consider_error_code") && g || !O("nwl_consider_error_code") && um() <= ci("potential_esf_error_limit", 10))) {
                            l.s(2);
                            break
                        }
                        if (O("skip_checking_network_on_cfr_failure") && (!O("skip_checking_network_on_cfr_failure") || Ql().isEndpointCFR(a.url))) {
                            l.s(3);
                            break
                        }
                        return w(l, nm().V(), 3);
                    case 3:
                        ...
                        return w(l, Dl(a.id, b, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        if (O("nwl_consider_error_code") && !g && um() > ci("potential_esf_error_limit", 10)) return l.return();
                        B("ytNetworklessLoggingInitializationOptions") && lm.potentialEsfErrorCounter++;
                        jm++;
                        if (void 0 === (null == (k = a) ? void 0 : k.id)) {
                            l.s(8);
                            break
                        }
                        return 1 > a.sendCount ? w(l, Dl(a.id, b), 12) : w(l, El(a.id, b), 8);
                    case 12:
                        Le.M(function() {
                            nm().G() && sm()
                        }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            var g;
            return x(function(h) {
                if (1 == h.i) return O("use_cfr_monitor") && Ql().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.s(2) : w(h, El(a.id, b), 2);
                O("vss_network_hint") && nm().T(!0);
                d(e, f);
                h.i = 0
            })
    ...
    function om() {
        return B("ytNetworklessLoggingInitializationOptions") ? lm.isNwlInitialized : !1
    }

    function um() {
        return B("ytNetworklessLoggingInitializationOptions") ? lm.potentialEsfErrorCounter : jm
    };

    function vm(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : Ci() && (this.config_ = Di());
        Vi(function() {
            Si(b)
        }, 5E3)
    }
    vm.prototype.isReady = function() {
        !this.config_ && Ci() && (this.config_ = Di());
        return !!this.config_
    };
    ...
    function Ti(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y;
            var z;
            if (d.retry && "www.youtube-nocookie.com" != h && (y || O("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (z = Qi(b, c, l, k)), z)) {
                var G = g.onSuccess,
                    K = g.onFetchSuccess;
            ...
            try {
                y && d.retry && !d.Za.bypassNetworkless ? (g.method = "POST", d.Za.writeThenSend ? O("use_new_nwl_wts") ? fm().writeThenSend(p, g) : mm(p, g) : O("use_new_nwl_saw") ? fm().sendAndWrite(p, g) : rm(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), ni(p, g))
            } catch (M) {
                if ("InvalidAccessError" == M.name) z && (Ri(z), z = 0), Ih(Error("An extension is blocking network request."));
                else throw M;
            }
            z && Vi(function() {
                Si(a)
            }, 5E3)
        }!N("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Ih(new gj("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
            var f = new gj("innertube xhrclient not ready", b, c, d);
            Hh(f);
            throw f;
        }
        var g = {
        ...
        var p = $h("" + h + m, q || {}, !0);
        O("use_new_nwl") && fm().i || !O("use_new_nwl") &&
            om() ? Zk().then(function(y) {
                e(y)
            }) : e(!1)
    };
    var wm = {
    ...
    var zm = A.ytPubsubPubsubInstance || new L,
        Am = A.ytPubsubPubsubSubscribedKeys || {},
    ...
    L.prototype.publish = L.prototype.fa;
    L.prototype.clear = L.prototype.clear;
    C("ytPubsubPubsubInstance", zm);
    C("ytPubsubPubsubTopicToKeys", Bm);
    C("ytPubsubPubsubIsSynchronous", Cm);
    C("ytPubsubPubsubSubscribedKeys", Am);
    var Dm = A.window;
    Dm.ytExports || (Dm.ytExports = {
        logging: {
            transport: {
                leaderQueueLength: 0,
                leaderChosen: !1
    ...
    var Em = ci("initial_gel_batch_timeout", 2E3),
        Fm = Math.pow(2, 16) - 1,
        Gm = !1,
        Hm = void 0;
    ...
    var Jm = new Im,
        Km = new Im,
        Lm = !0,
        Mm = A.ytLoggingTransportGELQueue_ || new Map;
    C("ytLoggingTransportGELQueue_", Mm);
    var Nm = new Map,
        Om = A.ytLoggingTransportGELProtoQueue_ || new Map;
    C("ytLoggingTransportGELProtoQueue_", Om);
    var Pm = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    C("ytLoggingTransportTokensToCttTargetIds_", Pm);
    var Qm = A.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    C("ytLoggingTransportTokensToJspbCttTargetIds_", Qm);

    function Rm() {
        O("jspb_with_transport_leader") && !Dm.ytExports.logging.transport.leaderChosen && (Gm = Dm.ytExports.logging.transport.leaderChosen = !0, document.addEventListener("FLUSH_REQUEST", function() {
            Sm(void 0, void 0, !0)
        }))
    }
    ...
    function Xm(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            Um(void 0, a);
            var c = Vm(a, !0);
            if (O("jspb_with_transport_leader") && Gm) {
                var d = Nm.get(c) || [];
                Nm.set(c, d);
                Dm.ytExports.logging.transport.leaderQueueLength++;
                d.push(a.payload);
                Wm(b, d, c, !0)
            } else d = Om.get(c) || [], Om.set(c, d), a = a.payload.toJSON(), d.push(a), Wm(b, d, c, !0)
        }
    }
    ...
    function Wm(a, b, c, d) {
        d = void 0 === d ? !1 : d;
        a && (Hm = new a);
        a = ci("tvhtml5_logging_max_batch") || ci("web_logging_max_batch") || 100;
        var e = Q(),
            f = d ? Km.l : Jm.l,
            g = Om.get(c) || [];
        O("jspb_with_transport_leader") && (Gm && b.length + g.length >= a || !Gm && Dm.ytExports.logging.transport.leaderQueueLength + b.length >= a) || b.length >= a ? Sm({
            writeThenSend: !0
        }, O("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && (Ym(d), d ? Km.l = e : Jm.l = e)
    }
    ...
    function Zm(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            d.set(c, [a.payload]);
            b && (Hm = new b);
            return new Kf(function(e, f) {
                Hm && Hm.isReady() ? $m(d, e, f, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function an(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            var c = Vm(a, !0),
                d = new Map,
                e = new Map;
            O("jspb_with_transport_leader") && Gm ? e.set(c, [a.payload]) : d.set(c, [a.payload.toJSON()]);
            b && (Hm = new b);
            return new Kf(function(f) {
                Hm && Hm.isReady() ? bn(d, e, f, {
                    bypassNetworkless: !0
                }, !0) : f()
            })
        }
    ...
    function Vm(a, b) {
        ...
        if (a.ga) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.R;
                var d = new th;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && gd(d, 2, uh, c.playlistId);
                Qm[b] = d
            } else b = a.R, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Pm[a.R.token] = c;
            c = a.R.token
        }
        return c
    }
    ...
    function Sm(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new Kf(function(d, e) {
            c ? (window.clearTimeout(Km.j), window.clearTimeout(Km.i), Km.i = 0) : (window.clearTimeout(Jm.j), window.clearTimeout(Jm.i), Jm.i = 0);
            if (O("jspb_with_transport_leader") && !Gm) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
            else if (Hm && Hm.isReady())
                if (void 0 !== b)
                    if (c) {
                        e = new Map;
                        var f = new Map,
                            g = Om.get(b) || [];
                        e.set(b, g);
                        O("jspb_with_transport_leader") && (g = Nm.get(b) || [], f.set(b, g));
                        bn(e, f, d, a);
                        O("jspb_with_transport_leader") &&
                            Nm.delete(b);
                        Om.delete(b)
                    } else f = new Map, g = Mm.get(b) || [], f.set(b, g), $m(f, d, e, a), Mm.delete(b);
            else c ? (bn(Om, Nm, d, a), Om.clear(), O("jspb_with_transport_leader") && Nm.clear()) : ($m(Mm, d, e, a), Mm.clear());
            else Ym(c), d()
        })
    }
    ...
    function Ym(a) {
        a = void 0 === a ? !1 : a;
        if (O("web_gel_timeout_cap") && (!a && !Jm.i || a && !Km.i)) {
            var b = Rh(function() {
                Sm({
                    writeThenSend: !0
                }, void 0, a)
        ...
        window.clearTimeout(a ? Km.j : Jm.j);
        b = N("LOGGING_BATCH_TIMEOUT", ci("web_gel_debounce_ms", 1E4));
        O("shorten_initial_gel_batch_timeout") && Lm && (b = Em);
        b = Rh(function() {
            Sm({
                writeThenSend: !0
            }, void 0, a)
    ...
    function $m(a, b, c, d, e) {
        ...
        for (var k = a.next(); !k.done; k = a.next()) {
            ...
            try {
                Ti(f, "log_event", k, fn(d, l, m, q, e)), Lm = !1
            } catch (t) {
                Hh(t), c()
            }
        }
    ...
    function bn(a, b, c, d, e) {
        ...
        for (var l = k.next(); !l.done; l = k.next()) {
            var m = u(l.value).next().value,
                ...
                t = b.get(m) || [];
            l = new vh;
            var p = Ji(f.config_ || Di());
            H(l, ah, 1, p);
            q = q ? gn(q) : [];
            q = u(q);
            for (p = q.next(); !p.done; p = q.next()) md(l, 3, qh, p.value);
            t = u(t);
            for (q = t.next(); !q.done; q = t.next()) md(l, 3, qh, q.value);
            (t = Qm[m]) && hn(l, m, t);
            delete Qm[m];
            ...
            m = fn(d, m,
                function() {
                    Dm.ytExports.logging.transport.leaderQueueLength = 0;
                    h--;
                    h || c()
                },
                function() {
    ...
    function dn(a, b, c) {
        ...
        !c && (b = N("EVENT_ID")) && (c = kn(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function kn() {
        ...
        a || (a = Math.floor(Math.random() * Fm / 2));
        a++;
        a > Fm && (a = 1);
        Bh("BATCH_CLIENT_COUNTER", a);
        return a
    }
    ...
    function gn(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            Hh(new gj("Transport failed to deserialize " + String(a[c])))
        }
        return b
    }
    ...
    var ln = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", ln);
    ...
    function on(a, b) {
        var c = void 0 === c ? {} : c;
        var d = vm;
        N("ytLoggingEventsDefaultDisabled", !1) && vm == vm && (d = null);
        a: {
            c = void 0 === c ? {} : c;
            if (O("lr_drop_other_and_business_payloads")) {
                if (xm[a] || wm[a]) break a
            } else if (O("lr_drop_other_payloads") && xm[a]) break a;
            var e = {},
                f = Math.round(c.timestamp || Q());e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0;e[a] = b;a = ym();e.context = {
                lastActivityMs: String(c.timestamp || !isFinite(a) ? -1 : a)
            };O("log_sequence_info_on_gel_web") && c.ma && (a = e.context, b = c.ma, b = {
                    index: nn(b),
                    groupKey: b
                }, a.sequence =
                b, c.pb && delete ln[c.ma]);
            (c.xb ? Zm : Tm)({
                endpoint: "log_event",
                payload: e,
                R: c.R,
    ...
    function un() {
        if (!tn) {
            ...
            a.Y.length = 0;
            a.W.length = 0;
            rn.Y && a.Y.push.apply(a.Y, rn.Y);
            rn.W && a.W.push.apply(a.W, rn.W)
        }
        return tn
    };
    var vn = new L;
    ...
    function yn(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += zn(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = wn(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? zn(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += zn(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = An(a), d += c[b].length;
        else c[b] = An(a), d += c[b].length;
        return d
    }
    ...
    var Bn = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", Bn);

    function Cn(a) {
        var b = void 0;
        b = void 0 === b ? {} : b;
        var c = !1;
        N("ytLoggingEventsDefaultDisabled", !1) && vm === vm && (c = !0);
        c = c ? null : vm;
        b = void 0 === b ? {} : b;
    ...
    var Dn = new Set,
        ...
        Gn = 0,
        Hn = [],
        In = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];

    function Jn() {
        for (var a = u(In), b = a.next(); !b.done; b = a.next()) {
            var c = Kb();
    ...
    function Kn() {
        var a;
        return x(function(b) {
            return (a = cf()) ? b.return(a.then(function(c) {
                c = qd(c);
    ...
    function Mn(a) {
        return Ln[a] || (Ln[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function Qn() {
        for (var a = u(On), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function Rn(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[Mn(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function Sn(a) {
        xg.fa.apply(xg, arguments)
    };
    ...
    function Vn(a, b, c) {
        Wn || (Wn = {}, Qh(window, "message", function(d) {
            a: {
                if (d.origin === Un(a, "host")) {
                    try {
                    ...
                    if (d = Wn[e.id]) d.u = !0, d.u && (D(d.v, d.sendMessage, d), d.v.length = 0), d.Na(e)
                }
                e = void 0
            }
            return e
    ...
    n.destroy = function() {
        this.i && this.i.id && (Nn[this.i.id] = null);
        var a = this.o;
    ...
    function co(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Un(a.j, "title"));
        (b = Un(a.j, "width")) && c.setAttribute("width", b.toString());
        (b = Un(a.j, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.Qa();
        ...
        Xn.yt_embedsTokenValue && (g.embedsTokenValue = encodeURIComponent(Xn.yt_embedsTokenValue), delete Xn.yt_embedsTokenValue);
        var h = "" + Un(a.j, "host") + ("/embed/" + Un(a.j, "videoId")) + "?" + Tb(g);
        Xn.yt_embedsEnableUaChProbe ? Kn().then(function(k) {
                var l = new URL(h),
    ...
    n.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Rb(a.src) : "https://www.youtube.com"), this.j = new Tn(b), c || (b = co(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.i = a, this.i.id || (this.i.id = "widget" + Qa(this.i)), Nn[this.i.id] = this, window.postMessage) {
                this.o = new L;
                eo(this);
                b = Un(this.j, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in Pn) Pn.hasOwnProperty(e) &&
                    ao(this, e)
            }
    };

    function $n(a, b) {
        a.J[b] || (a.J[b] = !0, bo(a, "addEventListener", [b]))
    }
                        ...
                        if (f) {
                            ...
                            if (!(5 <= En)) {
                                ...
                                if (t.hasOwnProperty("args") && t.args && t.args.length)
                                    for (var na = 0; na < t.args.length && !(va = yn(t.args[na], "params." + na, p, va), 500 <= va); na++);
                                ...
                                if (Hn.length)
                                    for (var X =
                                            0; X < Hn.length && !(va = yn(Hn[X], "params.context." + X, p, va), 500 <= va); X++);
                                ...
                                var S = {
                                    ...
                                    Oj = Number(t.columnNumber);
                                isNaN(Oj) || (S.lineNumber = S.lineNumber + ":" + Oj);
                                if ("IGNORED" === t.level) m = 0;
                                else a: {
                                    for (var Pj = un(), Qj = u(Pj.Y), Qf = Qj.next(); !Qf.done; Qf = Qj.next()) {
                                        var Rj = Qf.value;
                                        if (S.message && S.message.match(Rj.Ub)) {
                                            m = Rj.weight;
                                            break a
                                        }
                                    }
                                    for (var Sj = u(Pj.W),
                                            Rf = Sj.next(); !Rf.done; Rf = Sj.next()) {
                                        var Tj = Rf.value;
                                        if (Tj.lb(S)) {
                                            m = Tj.weight;
                                            break a
                                ...
                                S.sampleWeight = m;
                                for (var Uj = u(pn), Sf = Uj.next(); !Sf.done; Sf = Uj.next()) {
                                    var Tf = Sf.value;
                                    if (Tf.xa[S.name])
                                        for (var Vj = u(Tf.xa[S.name]), Uf = Vj.next(); !Uf.done; Uf = Vj.next()) {
                                            var Wj = Uf.value,
                                                Md = S.message.match(Wj.regexp);
                                            if (Md) {
                                                S.params["params.error.original"] = Md[0];
                                                for (var Vf = Wj.groups, Xj = {}, Wb = 0; Wb < Vf.length; Wb++) Xj[Vf[Wb]] = Md[Wb + 1], S.params["params.error." + Vf[Wb]] = Md[Wb + 1];
                                                S.message = Tf.Ga(Xj);
                                                break
                                            }
                                        }
                                ...
                                S.params || (S.params = {});
                                var Yj = un();
                                S.params["params.errorServiceSignature"] = "msg=" + Yj.Y.length + "&cb=" + Yj.W.length;
                                ...
                                if (0 !== ra.sampleWeight && !Dn.has(ra.message)) {
                                    if ("ERROR" === h) {
                                        vn.fa("handleError", ra);
                                        if (O("record_app_crashed_web") &&
                                            0 === Gn && 1 === ra.sampleWeight)
                                            if (Gn++, O("errors_via_jspb")) {
                                                var Wf = new nh;
                                                F(Wf, 1, 1);
                                                ...
                                                O("report_client_error_with_app_crash_ks") || (ek.systemHealth = {
                                                    crashData: {
                                                        clientError: {
                                                            logMessage: {
                                                                message: ra.message
                                    ...
                                    if (O("kevlar_gel_error_routing")) a: {
                                        ...
                                        if (O("errors_via_jspb")) {
                                            if (Jn()) Yf = void 0;
                                                ...
                                                var Xb = new fh;
                                                F(Xb, 1, R.stack);
                                                R.fileName && F(Xb, 4, R.fileName);
                                                var Ja = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Ja.length && (1 !== Ja.length || isNaN(Number(Ja[0])) ? 2 !== Ja.length || isNaN(Number(Ja[0])) || isNaN(Number(Ja[1])) || (F(Xb, 2, Number(Ja[0])), F(Xb, 3, Number(Ja[1]))) : F(Xb, 2, Number(Ja[0])));
                                                var qb = new ih;
                                                F(qb, 1, R.message);
                                                F(qb, 3, R.name);
                                                F(qb, 6, R.sampleWeight);
                                                "ERROR" === Hc ? F(qb, 2, 2) : "WARNING" === Hc ? F(qb, 2, 1) : F(qb, 2, 0);
                                                var Zf = new gh;
                                                F(Zf, 1, !0);
                                                kd(Zf, fh, 3, hh, Xb);
                                                var rb = new ch;
                                                F(rb, 3, window.location.href);
                                                for (var fk = N("FEXP_EXPERIMENTS", []), $f = 0; $f < fk.length; $f++) {
                                                    var gk = rb,
                                                        lo = fk[$f];
                                                    Rc(gk);
                                                    fd(gk, 5).push(lo)
                                                ...
                                                var ag = Ch();
                                                if (!Dh() && ag)
                                                    for (var hk = u(Object.keys(ag)), sb = hk.next(); !sb.done; sb = hk.next()) {
                                                        var ik = sb.value,
                                                            bg = new eh;
                                                        F(bg, 1, ik);
                                                        bg.setValue(String(ag[ik]));
                                                        md(rb, 4, eh, bg)
                                                    }
                                                var cg = R.params;
                                                if (cg) {
                                                    var jk = u(Object.keys(cg));
                                                    for (sb = jk.next(); !sb.done; sb =
                                                        jk.next()) {
                                                        var kk = sb.value,
                                                            dg = new eh;
                                                        F(dg, 1, "client." + kk);
                                                        dg.setValue(String(cg[kk]));
                                                        md(rb, 4, eh, dg)
                                                    }
                                                }
                                                var lk = N("SERVER_NAME"),
                                                    mk = N("SERVER_VERSION");
                                                if (lk && mk) {
                                                    var eg = new eh;
                                                    F(eg, 1, "server.name");
                                            ...
                                            if (Jn()) Xf = void 0;
                                                ...
                                                R.fileName && (Ic.filename =
                                                    R.fileName);
                                                var Ka = R.lineNumber && R.lineNumber.split ? R.lineNumber.split(":") : [];
                                                0 !== Ka.length && (1 !== Ka.length || isNaN(Number(Ka[0])) ? 2 !== Ka.length || isNaN(Number(Ka[0])) || isNaN(Number(Ka[1])) || (Ic.lineNumber = Number(Ka[0]), Ic.columnNumber = Number(Ka[1])) : Ic.lineNumber = Number(Ka[0]));
                                                var gg = {
                                                ...
                                                "ERROR" === Hc ? gg.level = "ERROR_LEVEL_ERROR" : "WARNING" === Hc && (gg.level = "ERROR_LEVEL_WARNNING");
                                                var mo = {
                                                        isObfuscated: !0,
                                                        browserStackInfo: Ic
                                                    },
                                                ...
                                                N("FEXP_EXPERIMENTS") && (Yb.experimentIds = N("FEXP_EXPERIMENTS"));
                                                var hg = Ch();
                                                if (!Dh() && hg)
                                                    for (var pk = u(Object.keys(hg)), tb = pk.next(); !tb.done; tb = pk.next()) {
                                                        var qk = tb.value;
                                                        Yb.kvPairs.push({
                                                            key: qk,
                                                            value: String(hg[qk])
                                                ...
                                                var ig = R.params;
                                                if (ig) {
                                                    var rk = u(Object.keys(ig));
                                                    for (tb = rk.next(); !tb.done; tb = rk.next()) {
                                                        var sk = tb.value;
                                                        Yb.kvPairs.push({
                                                            key: "client." + sk,
                                                            value: String(ig[sk])
                                                ...
                                                var tk = N("SERVER_NAME"),
                                                    uk = N("SERVER_VERSION");
                                                tk && uk && (Yb.kvPairs.push({
                                                    key: "server.name",
                                                    value: tk
                                                }), Yb.kvPairs.push({
                                                    key: "server.version",
                                        ...
                                        if ("ERROR" === Hc || O("errors_flush_gel_always_killswitch")) O("web_fp_via_jspb") && mn(!0),
                                        mn()
                                    }
                                    if (!O("suppress_error_204_logging")) {
                                        ...
                                        Jc.version && ($a["client.version"] = Jc.version);
                                        if ($a.postParams) {
                                            ub.stack && ($a.postParams.stack = ub.stack);
                                            for (var wk = u(Object.keys(Jc)), jg = wk.next(); !jg.done; jg = wk.next()) {
                                                var xk = jg.value;
                                                $a.postParams["client." + xk] = Jc[xk]
                                            }
                                            var kg = Ch();
                                            if (kg)
                                                for (var yk = u(Object.keys(kg)), lg = yk.next(); !lg.done; lg = yk.next()) {
                                                    var zk = lg.value;
                                                    $a.postParams[zk] = kg[zk]
                                                }
                                            var Ak = N("SERVER_NAME"),
                                                Bk = N("SERVER_VERSION");
                                            Ak && Bk && ($a.postParams["server.name"] = Ak, $a.postParams["server.version"] = Bk)
                                        }
                                        ni(N("ECATCHER_REPORT_HOST",
                                            "") + "/error_204", $a)
                                    }
                                    try {
                                        Dn.add(ra.message)
    ...
    n.Na = function(a) {
        ...
        switch (b) {
            ...
            case "initialDelivery":
                Pa(a) && (window.clearInterval(this.l), this.playerInfo = {}, this.N = {}, jo(this, a.apiInterface), io(this, a));
                break;
            default:
                Zn(this, b, a)
        }
    ...
    function io(a, b) {
        if (Pa(b)) {
            ...
            a.playerInfo.hasOwnProperty("videoData") && (b = a.playerInfo.videoData, b.hasOwnProperty("title") && b.title ? (b = b.title, b !== a.videoTitle && (a.videoTitle = b, a.i.setAttribute("title", b))) : (a.videoTitle = "", a.i.setAttribute("title", "YouTube " + Un(a.j, "title"))))
        }
    }
    ...
    n.getVideoEmbedCode = function() {
        var a = Un(this.j, "host") + ("/embed/" + Un(this.j, "videoId")),
            b = Number(Un(this.j, "width")),
            c = Number(Un(this.j, "height"));
    ...
    C("YT.subscribe", function(a, b, c) {
        xg.subscribe(a, b, c);
        Pn[a] = !0;
        for (var d in Nn) Nn.hasOwnProperty(d) && ao(Nn[d], a)
    });
    ...
    Yn.prototype.setSize = Yn.prototype.setSize;
    Yn.prototype.getIframe = Yn.prototype.getIframe;
    Yn.prototype.addEventListener = Yn.prototype.addEventListener;
    ho.prototype.getVideoEmbedCode = ho.prototype.getVideoEmbedCode;
    ho.prototype.getOptions = ho.prototype.getOptions;
    ho.prototype.getOption = ho.prototype.getOption;
    On.push(function(a) {
        var b = a;
        b || (b = document);
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Qn();
    var oo = A.onYTReady;
    oo && oo();
    var po = A.onYouTubeIframeAPIReady;
    po && po();
    var qo = A.onYouTubePlayerAPIReady;
    qo && qo();
}).call(this);