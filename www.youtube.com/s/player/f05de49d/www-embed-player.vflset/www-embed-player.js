(function() {
    ...
    */
    ...
    function Ba(a) {
        ...
        (b = a.l = a.l || b) ? b.Xb ? a.i = a.s || a.m : void 0 != b.u && a.m < b.u ? (a.i = b.u, a.l = null) : a.i = a.m: a.i = 0
    }
    ...
    function Ea(a, b, c, d) {
        try {
            ...
            return a.i.o = null, ua(a.i, g), Ga(a)
        }
        a.i.o = null;
        d.call(a.i, f);
        return Ga(a)
    ...
    function Ha(a) {
        this.next = function(b) {
            ta(a.i);
            a.i.o ? b = Ea(a, a.i.o.next, b, a.i.N) : (a.i.N(b), b = Ga(a));
            return b
        };
        this.throw = function(b) {
            ta(a.i);
            a.i.o ? b = Ea(a, a.i.o["throw"], b, a.i.N) : (ua(a.i, b), b = Ga(a));
            return b
        };
    ...
    var Pb = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
        Nb = {},
        Qb = new Mb("about:invalid#zClosurez", Nb);
    ...
    function Ub() {
        return C("Safari") && !(Vb() || C("Coast") || C("Opera") || C("Edge") || C("Edg/") || C("OPR") || Tb() || C("Silk") || C("Android"))
    }
    ...
    function Wb() {
        return C("Android") && !(Vb() || Tb() || C("Opera") || C("Silk"))
    }
    ...
    function $b(a) {
        ...
        switch (a) {
            ...
            case "Microsoft Edge":
                ...
                break;
            case "Chromium":
                if (Vb()) return b(["Chrome", "CriOS", "HeadlessChrome"])
        }
        return "Firefox" === a && Tb() || "Safari" === a && Ub() || "Android Browser" === a && Wb() || "Silk" === a && C("Silk") ? (b = c[2]) && b[1] || "" : ""
    }
    ...
    function ec(a, b) {
        ...
        (b = fc('style[nonce],link[rel="stylesheet"][nonce]', a.ownerDocument && a.ownerDocument.defaultView)) && a.setAttribute("nonce", b)
    }

    function gc() {
        return fc("script[nonce]")
    }
    var hc = /^[\w+/_-]+[=]{0,2}$/;

    function fc(a, b) {
        b = (b || y).document;
        return b.querySelector ? (a = b.querySelector(a)) && (a = a.nonce || a.getAttribute("nonce")) && hc.test(a) ? a : "" : ""
    };
    ...
    function Bc(a, b) {
        for (var c = a.search(zc), d = 0, e, f = []; 0 <= (e = yc(a, d, b, c));) f.push(a.substring(d, e)), d = Math.min(a.indexOf("&", e) + 1 || c, c);
        f.push(a.slice(d));
        return f.join("").replace(Ac, "$1")
    };
    var Cc = {};

    function Dc(a) {
        if (a !== Cc) throw Error("requires a valid immutable API token");
    };
    ...
    function Fc() {
        ...
        if (C("Windows")) {
            ...
            b.exec(a)
        } else Ec() || C("iPad") || C("iPod") ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, (a = b.exec(a)) && a[1].replace(/_/g, ".")) : C("Macintosh") ? (b = /Mac OS X ([0-9_.]+)/, (a = b.exec(a)) && a[1].replace(/_/g, ".")) : -1 != Rb().toLowerCase().indexOf("kaios") ? (b = /(?:KaiOS)\/(\S+)/i, b.exec(a)) : C("Android") ? (b = /Android\s+([^\);]+)(\)|;)/, b.exec(a)) : C("CrOS") && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, b.exec(a))
    };
    ...
    var Jc = C("Opera"),
        Kc = Sb(),
        Lc = C("Edge"),
        Mc = C("Gecko") && !(-1 != Rb().toLowerCase().indexOf("webkit") && !C("Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"),
        Nc = -1 != Rb().toLowerCase().indexOf("webkit") && !C("Edge"),
        Oc = C("Android");
    ...
    function Vc() {
        return Hc(function() {
            for (var a = 0, b = Kb(String(Uc)).split("."), c = Kb("9").split("."), d = Math.max(b.length, c.length), e = 0; 0 == a && e < d; e++) {
                var f = b[e] || "",
                    g = c[e] || "";
                do {
                    f = /(\d*)(\D*)(.*)/.exec(f) || ["", "", "", ""];
    ...
    var id = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0;

    function jd(a, b) {
        Object.isFrozen(a) || (id ? a[id] |= b : void 0 !== a.va ? a.va |= b : Object.defineProperties(a, {
            va: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function ld(a) {
        return Array.isArray(a) ? !!(kd(a) & 1) : !1
    }
    ...
    function nd(a) {
        return Array.isArray(a) ? !!(kd(a) & 2) : !1
    }
    ...
    function sd(a, b) {
        ...
        b ? jd(a, 8) : Object.isFrozen(a) || (id ? a[id] &= -9 : void 0 !== a.va && (a.va &= -9))
    };
    ...
    var vd, wd = Object.freeze(md([]));

    function xd(a) {
        if (td(a)) throw Error("Cannot mutate an immutable Message");
    }
    var yd = "undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance;
    ...
    function Cd(a, b) {
        a instanceof b || Ad(Error("Expected instanceof " + Bd(b) + " but got " + (a && Bd(a.constructor))));
        return a
    }
    ...
    function Id(a, b) {
        if (null != a) {
            if (Array.isArray(a)) a = Hd(a, b);
            else if (ud(a)) {
                var c = {},
                    d;
                for (d in a) c[d] = Id(a[d], b);
                a = c
            } else a = b(a);
            return a
        }
    ...
    function Hd(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = Id(c[d], b);
        ld(a) && md(c);
        return c
    }
    ...
    function Jd(a) {
        ...
        a = Ed(a);
        return Array.isArray(a) ? Fd(a, Jd) : a
    }

    function Gd(a) {
        return ed && null != a && a instanceof Uint8Array ? new Uint8Array(a) : a
    };
    ...
    function Md(a, b, c, d) {
        c = void 0 === c ? !0 : c;
        var e = Ld(a, b, d);
        Array.isArray(e) || (e = wd);
        if (td(a)) c && (rd(e), Object.freeze(e));
        else if (e === wd || nd(e)) e = md(e.slice()), E(a, b, e, d);
        return e
    }
    ...
    function Pd(a, b, c, d) {
        xd(a);
        (c = Qd(a, c)) && c !== b && null != d && (a.i && c in a.i && (a.i[c] = void 0), E(a, c));
        return E(a, b, d)
    }
    ...
    function Qd(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != Ld(a, e) && (0 !== c && E(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function Rd(a, b, c, d, e) {
        ...
        if (-1 === c) d = null;
            ...
            if (g) d = g;
                ...
                var h = Ld(a, c, f);
                b = Dd(h, b, d);
                void 0 == b ? d = g : (d && b.J !== h && E(a, c, b.J, f, !0), a.i[c] = b, td(a) && rd(b.J), d = b)
            }
        }
        if (null == d) return d;
        td(d) && !td(a) && (d = d.Bb(Cc), E(a, c, d.J, e), a.i[c] = d);
        return d
    }
    ...
    function Sd(a, b, c, d, e) {
        ...
        b = h || e;
        e = nd(g);
        b && !e && (Object.isFrozen(g) && (a.i[c] = g = g.slice()), rd(g), Object.freeze(g));
        !b && e && (a.i[c] = g = g.slice());
        return g
    }
    ...
    function Td(a, b, c, d) {
        ...
        if (c) {
            for (c = 0; c < b.length; c++)(d = b[c]) && td(d) && !e && (b[c] = b[c].Bb(Cc), a[c] = b[c].J);
            sd(a, !0)
        }
        return b
    }
    ...
    function Vd(a, b, c, d) {
        ...
        if (null != d) {
            var e = md([]);
            for (var f = !1, g = 0; g < d.length; g++) e[g] = Cd(d[g], b).J, f = f || nd(e[g]);
            a.i || (a.i = {});
            a.i[c] = d;
            sd(e, !f)
        } else a.i && (a.i[c] = void 0), e = wd;
        return E(a, c, e)
    }
    ...
    function Xd(a, b, c) {
        ...
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.sa, (d = this.J[a]) ? Array.isArray(d) && md(d) : this.J[a] = wd;
                else {
                    d = Kd(this);
                    var e = d[a];
                    e ? Array.isArray(e) && md(e) : d[a] = wd
                }
    }
    ...
    function Zd(a) {
        vd = !0;
        try {
            return JSON.stringify(a.toJSON(), $d)
        } finally {
            vd = !1
        }
    }
    ...
    Xd.prototype.isMutable = function(a) {
        Dc(a);
        return !td(this)
    };
        ...
        if (c) {
            ...
            for (var d in c) {
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length)
                            for (f = Td(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++) ae(f[g], e[g])
                    } else(f = Rd(a, e.constructor, g, void 0, f)) && ae(f, e)
                }
            }
        }
    }
    ...
    if (yd) {
        var ce = {};
        Object.defineProperties(be, (ce[Symbol.hasInstance] = zd(function() {
    ...
    function de(a) {
        var b = this.i,
            c = this.j;
        return this.isRepeated ? Td(a, b, c, !0) : Rd(a, b, c, void 0, !0)
    };

    function ee(a, b, c, d, e, f) {
        (a = a.i && a.i[c]) ? Array.isArray(a) ? (e = f.kb ? md(a.slice()) : a, Vd(b, 0 < e.length ? e[0].constructor : void 0, c, e)) : G(b, a.constructor, c, a): (ed && d instanceof Uint8Array ? e = d.length ? new hd(new Uint8Array(d)) : gd || (gd = new hd(null)) : (Array.isArray(d) && (e ? rd(d) : ld(d) && f.kb && (d = d.slice())), e = d), E(b, c, e))
    };
    ...
    I.prototype.Bb = function(a) {
        ...
        if (td(this)) {
            ...
            for (var d = this.J, e = 0; e < d.length; e++) {
                var f = d[e];
                if (e === d.length - 1 && ud(f))
                    for (h in f) {
                        var g = +h;
                        Number.isNaN(g) ? Kd(c)[h] = f[h] : ee(this, c, g, f[h], b, a)
                    } else ee(this, c, e - this.sa, f, b, a)
            }
            var h = c
        } else h = this;
        return h
    ...
    if (yd) {
        var fe = {};
        Object.defineProperties(I, (fe[Symbol.hasInstance] = zd(Object[Symbol.hasInstance]), fe))
    };
    ...
    l.wc = function(a) {
        var b = Ja.apply(1, arguments),
            c = this.nb(b);
        c ? c.push(new ge(a)) : this.lc(a, b)
    };
    l.lc = function(a) {
        this.ya.set(this.Sb(Ja.apply(1, arguments)), [new ge(a)])
    };
    l.nb = function() {
        var a = this.Sb(Ja.apply(0, arguments));
    ...
    je.prototype.l = function(a) {
        this.wc(a, Ja.apply(1, arguments))
    };
    ...
    xe.prototype.init = function(a, b) {
        ...
        this.state = a.state;
        this.j = a;
        a.defaultPrevented && xe.Z.preventDefault.call(this)
    };
    ...
    De.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Ee(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Ta = !1)) : (b = new Be(b, this.src, f, !!d, e), b.Ta = c, a.push(b));
        return b
    };
    De.prototype.remove = function(a, b, c, d) {
        a = a.toString();
        if (!(a in this.listeners)) return !1;
        var e = this.listeners[a];
        b = Ee(e, b, c, d);
        return -1 < b ? (Ce(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.i--), !0) : !1
    };

    function Fe(a, b) {
        var c = b.type;
        c in a.listeners && kb(a.listeners[c], b) && (Ce(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }
    ...
    function Je(a, b, c, d, e) {
        if (d && d.once) Ke(a, b, c, d, e);
        else if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Je(a, b[f], c, d, e);
        else c = Le(c), a && a[ze] ? a.W(b, c, Qa(d) ? !!d.capture : !!d, e) : Me(a, b, c, !1, d, e)
    }
    ...
    function Ke(a, b, c, d, e) {
        ...
        else c = Le(c), a && a[ze] ? a.o.add(String(b), c, !0, Qa(d) ? !!d.capture : !!d, e) : Me(a, b, c, !0, d, e)
    }

    function Re(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Re(a, b[f], c, d, e);
        else(d = Qa(d) ? !!d.capture : !!d, c = Le(c), a && a[ze]) ? a.o.remove(String(b), c, d, e) : a && (a = Ne(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Ee(b, c, d, e)), (c = -1 < a ? b[a] : null) && Se(c))
    }
    ...
    function Se(a) {
        if ("number" !== typeof a && a && !a.Ka) {
            ...
            if (b && b[ze]) Fe(b.o, a);
                ...
                Ie--;
                (c = Ne(b)) ? (Fe(c, a), 0 == c.i && (c.src = null, b[Ge] = null)) : Ce(a)
            }
        }
    }

    function Pe(a) {
        return a in He ? He[a] : He[a] = "on" + a
    }
    ...
    Za(Ue, J);
    Ue.prototype[ze] = !0;
    Ue.prototype.addEventListener = function(a, b, c, d) {
        Je(this, a, b, c, d)
    };
    Ue.prototype.removeEventListener = function(a, b, c, d) {
        Re(this, a, b, c, d)
    };
    ...
    function Ve(a, b) {
        ...
        a = a.tc;
        c = b.type || b;
        "string" === typeof b ? b = new oe(b, a) : b instanceof oe ? b.target = b.target || a : (e = b, b = new oe(c, a), wb(b, e));
        e = !0;
        if (d)
        ...
        b.l || (g = b.i = a, e = We(g, c, !0, b) && e, b.l || (e = We(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.l && f < d.length; f++) g = b.i = d[f], e = We(g, c, !1, b) && e
    }
    Ue.prototype.D = function() {
        ...
        if (this.o) {
            ...
            for (c in a.listeners) {
                for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, Ce(d[e]);
    ...
    Ue.prototype.W = function(a, b, c, d) {
    ...
    l.equals = function(a) {
        return a instanceof $e && (this == a ? !0 : this && a ? this.x == a.x && this.y == a.y : !1)
    };
    l.ceil = function() {
    ...
    l = qf.prototype;
    l.gb = function(a, b) {
        return wf(this, null, a, b)
    };
    l.catch = qf.prototype.gb;
    l.cancel = function(a) {
        if (0 == this.i) {
            var b = new xf(a);
            nf(function() {
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? yf(c, b) : (f ? (d = f, d.next == c.o && (c.o = d), d.next = d.next.next) : zf(c), Af(c, e, 3, b)))
                }
                a.l = null
            } else rf(a, 3, b)
    }
    ...
    function rf(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.C = c, a.i = b, a.l = null, Cf(a), 3 != b || c instanceof xf || Ef(a, c))
        }
    }
    ...
    l.Gc = function() {
        for (var a; a = zf(this);) Af(this, a, this.i, this.C);
        this.s = !1
    };
    ...
    function Af(a, b, c, d) {
        ...
        if (b.i) b.i.l = null, Ff(b, c, d);
        else try {
            b.l ? b.j.call(b.context) : Ff(b, c, d)
        } catch (e) {
            Gf.call(null, e)
        }
        Ye(tf, b)
    ...
    l.od = function() {
        if (this.enabled) {
            ...
            0 < a && a < .8 * this.l ? this.da = this.j.setTimeout(this.m, this.l - a) : (this.da && (this.j.clearTimeout(this.da), this.da = null), Ve(this, "tick"), this.enabled && (this.stop(), this.start()))
        }
    };
    l.start = function() {
        this.enabled = !0;
    ...
    function Kf(a) {
        ...
        this.j = new Hf(this.flushInterval);
        this.j.W("tick", this.ib, !1, this);
        this.m = !1
    }
    l = Kf.prototype;
    l.jc = function(a) {
    ...
    l.Hb = function(a) {
        var b = Ja.apply(1, arguments);
        this.i.has(a) || this.i.set(a, new je(a, b))
    };
    ...
    l.Cb = function(a) {
        this.qc.apply(this, [a, 1].concat(ia(Ja.apply(1, arguments))))
    };
    l.qc = function(a, b) {
        var c = Ja.apply(2, arguments),
            d = Nf(this, a);
        d && d instanceof ie && (d.l(b, c), Lf(this))
    };
    l.hb = function(a, b) {
        var c = Ja.apply(2, arguments),
            d = Nf(this, a);
        d && d instanceof je && (d.l(b, c), Lf(this))
    };
    ...
    function Of(a) {
        this.i = a;
        this.i.Hb("/client_streamz/bg/fil", {
            mb: 3,
            lb: "rk"
        })
    }
    ...
    function Pf(a) {
        this.i = a;
        this.i.xc("/client_streamz/bg/fsc", {
            mb: 3,
            lb: "rk"
        })
    }
    ...
    function Qf(a) {
        this.i = a;
        this.i.Hb("/client_streamz/bg/fsl", {
            mb: 3,
            lb: "rk"
        })
    };
    ...
    function hg(a) {
        a = (a.i.cookie || "").split(";");
        for (var b = [], c = [], d, e, f = 0; f < a.length; f++) e = Kb(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        return {
            keys: b,
            values: c
        }
    ...
    function lg(a, b, c, d) {
        (a = y[a]) || (a = (new gg(document)).get(b));
        return a ? cg(a, c, d) : null
    }

    function mg(a, b) {
        b = void 0 === b ? !1 : b;
        var c = ag(String(y.location.href)),
            d = [];
        if (kg(b)) {
            c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:");
            var e = c ? y.__SAPISID : y.__APISID;
            e || (e = new gg(document), e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID"));
            (e = e ? cg(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e);
            c && jg(b) && ((b = lg("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = lg("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a))
        }
        return 0 ==
    ...
    function tg(a, b) {
        b.push('"', a.replace(vg, function(c) {
            var d = ug[c];
            d || (d = "\\u" + (c.charCodeAt(0) | 65536).toString(16).slice(1), ug[c] = d);
            return d
        }), '"')
    };
    ...
    function wg() {}
    wg.prototype.i = null;
    wg.prototype.getOptions = function() {
        var a;
        (a = this.i) || (a = {}, xg(this) && (a[0] = !0, a[1] = !0), a = this.i = a);
        return a
    };
    var yg;
    ...
    l.send = function(a, b, c, d) {
        ...
        this.P = !1;
        this.j = !0;
        this.A = this.K ? Ag(this.K) : Ag(yg);
        this.G = this.K ? this.K.getOptions() : yg.getOptions();
        ...
        !(0 <= eb(Dg, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
        b = p(c);
        ...
        try {
            Jg(this), 0 < this.s && (this.X = Kg(this.A), this.getStatus(), this.X ? (this.A.timeout = this.s, this.A.ontimeout = Xa(this.nc, this)) :
                this.B = Jf(this.nc, this.s, this)), this.getStatus(), this.v = !0, this.A.send(a), this.v = !1
        } catch (g) {
            this.getStatus(), Ig(this, g)
        }
    };
    ...
    l.nc = function() {
        "undefined" != typeof Ma && this.A && (this.m = "Timed out after " + this.s + "ms, aborting", this.getStatus(), Ve(this, "timeout"), this.abort(8))
    };
    ...
    function Lg(a) {
        a.P || (a.P = !0, Ve(a, "complete"), Ve(a, "error"))
    }
    l.abort = function() {
        this.A && this.j && (this.getStatus(), this.j = !1, this.l = !0, this.A.abort(), this.l = !1, Ve(this, "complete"), Ve(this, "abort"), Mg(this))
    };
    l.D = function() {
        this.A && (this.j && (this.j = !1, this.l = !0, this.A.abort(), this.l = !1), Mg(this, !0));
        Bg.Z.D.call(this)
    };
    l.ac = function() {
        this.i() || (this.R || this.v || this.l ? Ng(this) : this.Qc())
    };
    l.Qc = function() {
        Ng(this)
    };
    ...
    function Ng(a) {
        if (a.j && "undefined" != typeof Ma)
            if (a.G[1] && 4 == Og(a) && 2 == a.getStatus()) a.getStatus();
            else if (a.v && 4 == Og(a)) Jf(a.ac, 0, a);
        else if (Ve(a, "readystatechange"), a.isComplete()) {
            a.getStatus();
            a.j = !1;
            try {
                if (Pg(a)) Ve(a, "complete"), Ve(a, "success");
                else {
                    try {
                        var b = 2 < Og(a) ? a.A.statusText : ""
                    } catch (c) {
                        b = ""
                    }
                    a.m = b + " [" + a.getStatus() + "]";
    ...
    function Pg(a) {
        ...
        if (!c) {
            if (b = 0 === b) a = lc(1, String(a.T)), !a && y.self && y.self.location && (a = y.self.location.protocol.slice(0, -1)), b = !Cg.test(a ? a.toLowerCase() : "");
            c = b
        }
        return c
    }
    ...
    l.getStatus = function() {
        try {
            return 2 < Og(this) ? this.A.status : -1
        } catch (a) {
            return -1
        }
    };
    ...
    r(Rg, I);
    var Sg = [1];
    var Tg = ["platform", "platformVersion", "architecture", "model", "uaFullVersion"];
    new Rg;
    ...
    function ch(a, b, c, d, e, f, g, h, k, m, q) {
        Ue.call(this);
        var t = this;
        this.P = "";
        this.l = [];
        ...
        this.Fa = f || !1;
        !this.Fa && (65 <= ac("Chromium") || 45 <= ac("Firefox") || 12 <= ac("Safari") || (Ec() || C("iPad") || C("iPod")) && Fc());
        a = E(new Ug, 1, 1);
        eh(this.v, a);
        this.s = new pg(1E4);
        this.j = new Hf(this.s.getValue());
        me(this, this.j);
        m = fh(this, m);
        Je(this.j, "tick", m, !1, this);
        this.R = new Hf(6E5);
        me(this, this.R);
        Je(this.R, "tick", m, !1, this);
        this.X || this.R.start();
        this.Fa || (Je(document, "visibilitychange", function() {
            "hidden" === document.visibilityState && t.Y()
        }), Je(document, "pagehide", this.Y, !1, this))
    }
    r(ch, Ue);
    ...
    ch.prototype.D = function() {
        this.Y();
        Ue.prototype.D.call(this)
    };

    function gh(a) {
        a.T || (a.T = .01 > a.vc() ? "https://www.google.com/log?format=json&hasfast=true" : "https://play.google.com/log?format=json&hasfast=true");
        return a.T
    }
    ...
    ch.prototype.log = function(a) {
        ...
        null != Ld(a, 15) || E(a, 15, 60 * (new Date).getTimezoneOffset());
        this.m && (b = this.m.clone(), G(a, ng, 16, b));
        for (; 1E3 <= this.l.length;) this.l.shift(), ++this.B;
        this.l.push(a);
        Ve(this, new ih(a));
        this.X || this.j.enabled || this.j.start()
    };
    ch.prototype.flush = function(a, b) {
        var c = this;
        if (0 === this.l.length) a && a();
        else if (this.ea) jh(this);
        else {
            var d = Date.now();
            if (this.Gb > d && this.ra < d) b && b("throttled");
            else {
                var e = kh(this.v, this.l, this.B);
                d = {};
                var f = this.Eb();
                f && (d.Authorization = f);
                var g = gh(this);
                this.K && (d["X-Goog-AuthUser"] = this.K, g = xc(g, "authuser", this.K));
                this.pageId && (d["X-Goog-PageId"] = this.pageId, g = xc(g, "pageId", this.pageId));
                if (f && this.Fb === f) b && b("stale-auth-token");
                else {
                    this.l = [];
                    this.j.enabled && this.j.stop();
                    this.B = 0;
                    ...
                    var m = {
                        ...
                        q = function(u) {
                            ...
                            if (u) {
                                ...
                                A && (u = Number(Nd(A, 1, "-1")), 0 < u && (c.ra = Date.now(), c.Gb = c.ra + u), A = bh.l(A)) && (A = Nd(A, 1, -1), -1 != A && (c.Qa || hh(c, A)))
                            }
                            a && a()
                        },
                        t = function(u, A) {
                        ...
                        x = function() {
                            c.Pa ? c.Pa.send(m, q, t) : c.sc(m, q, t)
                        };
                    k ? k.then(function(u) {
    ...
    function jh(a) {
        lh(a, function(b, c) {
            b = xc(b, "format", "json");
            b = window.navigator.sendBeacon(b, Zd(c));
            a.ea && !b && (a.ea = !1);
            return b
        })
    }
    ...
    function lh(a, b) {
        if (0 !== a.l.length) {
            var c = Bc(gh(a), "format");
            c = sc(c, "auth", a.Eb(), "authuser", a.K || "0");
    ...
    function eh(a, b) {
        G(a.i, Ug, 1, b);
        Ld(b, 1) || E(b, 1, 1);
        a.j || (b = mh(a), Ld(b, 5) || E(b, 5, a.locale));
        a.uach && (b = mh(a), Rd(b, Rg, 9) || G(b, Rg, 9, a.uach))
    }
    ...
    function qh() {
        ...
        b && (d.o = !0);
        c && (d.j = c);
        a = new ch(1828, d.G ? d.G : mg, "0", d.s, d.l, d.o, !1, d.R, void 0, void 0, d.C ? d.C : void 0);
        d.v && eh(a.v, d.v);
        d.j && (b = d.j, c = mh(a.v), E(c, 7, b));
        d.m && (a.G = d.m);
        d.i && (a.P = d.i);
        d.N && ((b = d.N) ? (a.m || (a.m = new ng), b = Zd(b), E(a.m, 4, b)) : a.m && E(a.m, 4, void 0, !1));
        d.K && (b = d.K, a.m || (a.m = new ng), Od(a.m, 2, b));
        d.B && (b = d.B, a.Qa = !0, hh(a, b));
        d.P && nh(a.v, d.P);
        this.i = a
    }
    qh.prototype.flush = function(a) {
        var b = a || [];
        if (b.length) {
            a = new Zf;
            for (var c = [], d = 0; d < b.length; d++) {
                ...
                for (m = 0; m < k.length; m++) {
                    ...
                    for (x = 0; x < t.length; x++) {
                        ...
                        D = [];
                        F = f;
                        for (var N = [], O = 0; O < F.i.length; O++) N.push(F.i[O].mb);
                        F = N;
            ...
            Vd(a, Rf, 1, c);
            b = this.i;
            a instanceof Vg ? b.log(a) : (c = new Vg, a = Zd(a), a = E(c, 8, a), b.log(a));
            this.i.flush()
        }
    };
    ...
    function rh() {
        this.m = sh();
        this.transport = new qh;
        this.i = new Kf(this.transport);
        this.o = new Of(this.i);
        this.j = new Pf(this.i);
        this.l = new Qf(this.i);
    ...
    function uh(a) {
        ...
        if (a.sq) {
            var c;
            this.ta = null != (c = a.ta) ? c : new rh
        }
        c = a.program;
        a = a.globalName;
        var d = new th;
        this.j = d.promise;
        this.md = p((0, y[a].a)(c, function(e, f) {
            Promise.resolve().then(function() {
                var g;
                if (null != (g = b.ta)) {
                    var h = sh() - g.m;
                    g.o.i.hb("/client_streamz/bg/fil", h, g.Ba)
                }
                d.resolve({
                    yc: e,
                    jd: f
    ...
    uh.prototype.snapshot = function(a) {
        var b = this;
        if (this.Wa) throw Error("Already disposed");
        var c = sh(),
            d;
        null != (d = this.ta) && d.j.i.Cb("/client_streamz/bg/fsc", d.Ba);
        return this.j.then(function(e) {
            ...
            return new Promise(function(g) {
                f(function(h) {
                    ...
                    if (null != (k = b.ta)) {
                        var m = sh() - c;
                        k.l.i.hb("/client_streamz/bg/fsl", m, k.Ba)
                    }
                    g(h)
                }, [a.Mb,
                    a.kd
    ...
    */
    ...
    function xh(a) {
        return new wh(function(b) {
            return b.substr(0, a.length + 1).toLowerCase() === a + ":"
        })
    }
    var yh = [xh("data"), xh("http"), xh("https"), xh("mailto"), xh("ftp"), new wh(function(a) {
        return /^[^:]*([/?#]|$)/.test(a)
    })];
    ...
    var Ih = "client_dev_mss_url client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");
    ia(Ih);
    ...
    function Lh(a) {
        a.v = a.ba.S(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return a.j ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.u(3) : v(c, Kh(a), 3) : v(c, Kh(a), 3);
                Lh(a);
                c.i = 0
            })
        }, 3E4)
    ...
    function Kh(a, b) {
        return a.s ? a.s : a.s = new Promise(function(c) {
            ...
            return w(function(h) {
                switch (h.i) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, va(h, 2, 3), d && (a.l = a.ba.S(function() {
                            d.abort()
                    ...
                    case 3:
                        ...
                        g !== a.j && (a.j = g, a.j ? Ve(a, "networkstatus-online") : Ve(a, "networkstatus-offline"));
                        c(g);
                        Ba(h);
                        break;
                    case 2:
    ...
    var Oh = {
            Kh: "EMBEDDED_PLAYER_MODE_UNKNOWN",
            Hh: "EMBEDDED_PLAYER_MODE_DEFAULT",
            Jh: "EMBEDDED_PLAYER_MODE_PFP",
            Ih: "EMBEDDED_PLAYER_MODE_PFL"
        },
        Ph = {
            Np: "WEB_DISPLAY_MODE_UNKNOWN",
            Jp: "WEB_DISPLAY_MODE_BROWSER",
            Lp: "WEB_DISPLAY_MODE_MINIMAL_UI",
            Mp: "WEB_DISPLAY_MODE_STANDALONE",
            Kp: "WEB_DISPLAY_MODE_FULLSCREEN"
        };
    ...
    Vh.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.m, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) Wh(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    function Zh(a, b) {
        a.classList ? b = a.classList.contains(b) : (a = a.classList ? a.classList : Xh(a).match(/\S+/g) || [], b = 0 <= eb(a, b));
        return b
    }

    function $h() {
        var a = document.body;
        a.classList ? a.classList.remove("inverted-hdpi") : Zh(a, "inverted-hdpi") && Yh(a, Array.prototype.filter.call(a.classList ? a.classList : Xh(a).match(/\S+/g) || [], function(b) {
    ...
    function di(a) {
        ...
        if ("function" == typeof a.fa) return new ei(function() {
            return a.fa()
        });
    ...
    l.delete = function(a) {
        return ji(this.j, a) ? (delete this.j[a], --this.size, this.oa++, this.i.length > 2 * this.size && ii(this), !0) : !1
    };
    ...
    function ii(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], ji(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    l.get = function(a, b) {
        return ji(this.j, a) ? this.j[a] : b
    };
    l.set = function(a, b) {
        ji(this.j, a) || (this.size += 1, this.i.push(a), this.oa++);
        this.j[a] = b
    };
    ...
    l.keys = function() {
        return di(this.fa(!0)).i()
    };
    l.values = function() {
        return di(this.fa(!1)).i()
    };
    l.entries = function() {
        var a = this;
    ...
    l.Ea = function(a) {
        ...
        if (b) {
            var c = this.l[b];
            0 != this.m ? (this.o.push(a), this.j[a + 1] = function() {}) : (c && kb(c, a), delete this.j[a], delete this.j[a + 1], delete this.j[a + 2])
        }
        return !!b
    };
    l.qa = function(a, b) {
    ...
    ni.prototype.set = function(a, b) {
        void 0 === b ? this.i.remove(a) : this.i.set(a, qg(b))
    };
    ...
    oi.prototype.set = function(a, b) {
        oi.Z.set.call(this, a, qi(b))
    };
    oi.prototype.j = function(a) {
        a = oi.Z.get.call(this, a);
    ...
    ri.prototype.set = function(a, b, c) {
        ...
        ri.Z.set.call(this, a, b)
    };
    ri.prototype.j = function(a) {
        var b = ri.Z.j.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
    ...
    function wi(a, b) {
        ...
        if (c) {
            xi || (xi = new hi);
            this.i = xi.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), xi.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    l.set = function(a, b) {
        this.i.setAttribute(zi(a), b);
        Ai(this)
    };
    l.get = function(a) {
        a = this.i.getAttribute(zi(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    l.remove = function(a) {
        this.i.removeAttribute(zi(a));
        Ai(this)
    };
    l.fa = function(a) {
        var b = 0,
    ...
    Bi.prototype.remove = function(a) {
        this.j.remove(this.i + a)
    };
    Bi.prototype.fa = function(a) {
        ...
        d.next = function() {
            ...
            return ci(a ? e.slice(c.i.length) : c.j.get(e))
        };
        return d
    };
    ...
    Di.prototype.getValue = function() {
        return Ld(this, 2 === Qd(this, Ei) ? 2 : -1)
    };
    Di.prototype.setValue = function(a) {
        return Pd(this, 2, Ei, a)
    };
    var Ei = [2, 3, 4, 5, 6];
    ...
    r(Ji, I);
    Ji.prototype.getPlayerType = function() {
        return Ld(this, 36)
    };
    Ji.prototype.setHomeGroupInfo = function(a) {
        return G(this, Hi, 81, a)
    };
    var Ki = [9, 66, 24, 32, 86, 100, 101];
    ...
    r(Ni, I);
    Ni.prototype.setToken = function(a) {
        return E(this, 2, a)
    };
    ...
    Ui.prototype.setValue = function(a) {
        return E(this, 2, a)
    };
    var Ti = [4, 5];
    ...
    r(hj, I);
    hj.prototype.getVideoData = function() {
        return Rd(this, gj, 15)
    };
    var ij = [4];
    ...
    wj.prototype.getPlayerType = function() {
        return Nd(this, 7, 0)
    };
    wj.prototype.setVideoId = function(a) {
        return E(this, 19, a)
    };
    ...
    r(Jj, I);
    Jj.prototype.setVideoId = function(a) {
        return Pd(this, 1, Kj, a)
    };
    Jj.prototype.getPlaylistId = function() {
        return Ld(this, 2 === Qd(this, Kj) ? 2 : -1)
    };
    var Kj = [1, 2];
    ...
    var Oj = y.window,
        kk, lk, mk = (null == Oj ? void 0 : null == (kk = Oj.yt) ? void 0 : kk.config_) || (null == Oj ? void 0 : null == (lk = Oj.ytcfg) ? void 0 : lk.data_) || {};
    z("yt.config_", mk);
    ...
    function wk(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = L("ERRORS", []), e.push([a, "ERROR", b, c, d]), nk("ERRORS", e));
        uk(a)
    }

    function xk(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = L("ERRORS", []), e.push([a, "WARNING", b, c, d]), nk("ERRORS", e))
    };
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                ...
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: Fk == q ? "unchanged" : q
                }];
                Ck.hasOwnProperty(m) || xk(k)
            }
        }
        return c
    }
    ...
    function Ik(a) {
        return -1 != a.indexOf("?") ? (a = (a || "").split("#")[0], a = a.split("?", 2), Hk(1 < a.length ? a[1] : a[0])) : {}
    }
    ...
    function Kk(a) {
        ...
        var c = lc(1, a),
            d = mc(a);
        c && d ? (a = a.match(jc), b = b.match(jc), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? mc(b) == d && (Number(lc(4, b)) || null) == (Number(lc(4, a)) || null) : !0;
        return a
    }

    function Ek(a) {
        return a && a.match(Bk) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function Lk(a) {
        ...
        try {
            ...
            e.u_his = h;
            var k;
            e.u_h = null == (k = vh.screen) ? void 0 : k.height;
            var m;
            e.u_w = null == (m = vh.screen) ? void 0 : m.width;
            var q;
            e.u_ah = null == (q = vh.screen) ? void 0 : q.availHeight;
            var t;
            e.u_aw =
                null == (t = vh.screen) ? void 0 : t.availWidth;
            var x;
            e.u_cd = null == (x = vh.screen) ? void 0 : x.colorDepth
        } catch (ya) {}
        h = b.i;
        try {
            var u = h.screenX;
        ...
        try {
            var ca = h.screen.availWidth;
            var V = h.screen.availTop
        } catch (ya) {}
        u = [Q, ba, u, A, ca, V, D, F, N, O];
        try {
            var Ua = (b.i.top || window).document,
                za = "CSS1Compat" ==
                Ua.compatMode ? Ua.documentElement : Ua.body;
            var H = (new af(za.clientWidth, za.clientHeight)).round()
        } catch (ya) {
            H = new af(-12245933, -12245933)
        }
        Ua = H;
        H = {};
        ...
        b = (H.vis =
            b.prerendering ? 3 : {
                ...
                preview: 4,
                unloaded: 5
            }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, H.wgl = !!vh.WebGLRenderingContext, H);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var Nk = "XMLHttpRequest" in y ? function() {
    ...
    var Sk = {
        ...
        Tk = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Ih)),
        Uk = !1;
    ...
    function Vk(a, b) {
        ...
        for (e in Sk) {
            ...
            !f || !c && mc(a) || d && void 0 !== b[e] || !M("enable_web_eom_visitor_data") && "X-Goog-EOM-Visitor-Id" === e || (b[e] = f)
        }
        ...
        if (c || !mc(a)) b["X-YouTube-Ad-Signals"] = Gk(Lk());
        return b
    }
    ...
    function Wk(a) {
        var b = window.location.search,
            c = mc(a);
        M("debug_handle_relative_url_for_query_forward_killswitch") || c || !Kk(a) || (c = document.location.hostname);
        var d = kc(lc(5, a));
    ...
    function Xk(a, b) {
        ...
        var d = Zk(a, b),
            ...
            f = $k(a, function(k) {
                    if (!e) {
                        ...
                        if (m || t || x) q = al(a, c, k, b.convertToSafeHtml);
        ...
        if (b.onTimeout && 0 < d) {
            var g = b.onTimeout;
            var h = Qk(function() {
                e || (e = !0, f.abort(), Rk(h), g.call(b.context || y, f))
            }, d)
        }
        return f
    }
    ...
    function Yk(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = Jk(a, b || {}, !0);
        return a
    }
    ...
    function Zk(a, b) {
        ...
        b.excludeXsrf || mc(a) && !b.withCredentials && mc(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = Hk(e), wb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : rc(e));
        f = e || f && !pb(f);
        !Uk && f && "POST" != b.method && (Uk = !0, wk(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, xk(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? bl(a) : null) e = {}, fb(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = cl(g)
                })
        }
        d && dl(e);
    ...
    function $k(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && vk(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = Ok();
        ...
        M("debug_forward_web_query_parameters") && (a = Wk(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    var jl = B("ytglobal.prefsUserPrefsPrefs_") || {};
    z("ytglobal.prefsUserPrefsPrefs_", jl);
    ...
    kl.prototype.get = function(a, b) {
        ll(a);
        ml(a);
        a = void 0 !== jl[a] ? jl[a].toString() : null;
        return null != a ? a : b ? b : ""
    };
    ...
    function nl(a) {
        return !!((ol("f" + (Math.floor(a / 31) + 1)) || 0) & 1 << a % 31)
    }
    ...
    function ul() {
        var a = tl();
        if (a) {
            var b = pl[a.type || "unknown"] || "CONN_UNKNOWN";
            a = pl[a.effectiveType || "unknown"] || "CONN_UNKNOWN";
    ...
    function vl() {
        var a = tl();
        if (null != a && a.effectiveType) return sl.hasOwnProperty(a.effectiveType) ? sl[a.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN"
    };
    ...
    function yl(a) {
        ...
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = p(Object.entries(Hk(L("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = p(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function Dl(a) {
        ...
        Bl(a, c);
        Cl(c);
        L("DELEGATED_SESSION_ID") && !M("pageid_as_header_web") && (a = new Oi, E(a, 3, L("DELEGATED_SESSION_ID")));
        a = p(Object.entries(Hk(L("DEVICE", ""))));
    ...
    function zl(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                c = Rd(b, Gi, 96) || new Gi;
                var d = fl();
                d = Object.keys(Ph).indexOf(d);
                d = -1 === d ? null : d;
                null !== d && E(c, 3, d);
                G(b, Gi, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = fl())
    }
    ...
    function Cl(a, b) {
        var c = ul();
        c && (a ? E(a, 61, ql[c]) : b && (b.client.connectionType = c));
        M("web_log_effective_connection_type") && (c = vl()) && (a ? E(a, 94, rl[c]) : b && (b.client.effectiveConnectionType = c))
    }
    ...
    function El(a, b, c) {
        ...
        (b = c.cq || L("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().bq : b = mg([]));
    ...
    function Gl(a) {
        var b = new vi;
        (b = b.isAvailable() ? a ? new Bi(b, a) : b : null) || (a = new wi(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.i = (a = b) ? new ri(a) : null;
    ...
    Gl.prototype.get = function(a, b) {
        ...
        if (d && (c = hl(a)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    Gl.prototype.remove = function(a) {
        ...
        var b = this.j;
        ig.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var Hl = window,
        P = Hl.ytcsi && Hl.ytcsi.now ? Hl.ytcsi.now : Hl.performance && Hl.performance.timing && Hl.performance.now && Hl.performance.timing.navigationStart ? function() {
    ...
    function Kl(a, b, c, d) {
        ...
        Jl().set("nextId", d + 1, 86400, !0);
        Jl().set("requests", e, 86400, !0);
        return d
    }

    function Ll(a) {
        var b = Jl().get("requests", !0) || {};
        delete b[a];
        Jl().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(P()) - d.requestTime)) {
                    var e = d.authState,
                        f = Fl(El(!1));
                    sb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(P())), Nl(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Jl().set("requests", b, 86400, !0)
    ...
    function Ql(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Qk(a, c || 0)
    }
    Tl.prototype.aa = function(a) {
        if (void 0 === a || !Number.isNaN(Number(a))) {
            var b = B("yt.scheduler.instance.cancelJob");
            b ? b(a) : Rk(a)
        }
    };
    Tl.prototype.start = function() {
        var a = B("yt.scheduler.instance.start");
        a && a()
    };
    Tl.prototype.pause = function() {
    ...
    function Yl() {
        var a;
        return null == (a = Xl()) ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    };
    var Zl = [],
        $l, am = !1;
    ...
    function bm() {
        var a = {};
        for ($l = new cm(void 0 === a.handleError ? dm : a.handleError, void 0 === a.logEvent ? em : a.logEvent); 0 < Zl.length;) switch (a = Zl.shift(), a.type) {
            case "ERROR":
                $l.handleError(a.payload);
                break;
            case "EVENT":
                $l.logEvent(a.eventType, a.payload)
        }
    }

    function fm(a) {
        am || ($l ? $l.handleError(a) : (Zl.push({
            type: "ERROR",
            payload: a
        }), 10 < Zl.length && Zl.shift()))
    }

    function gm(a, b) {
        am || ($l ? $l.logEvent(a, b) : (Zl.push({
            type: "EVENT",
            eventType: a,
            payload: b
        }), 10 < Zl.length && Zl.shift()))
    ...
    function sm(a, b) {
        rm.call(this, "MISSING_OBJECT_STORES", {
            expectedObjectStores: b,
            foundObjectStores: a
        }, mm.MISSING_OBJECT_STORES);
    ...
    r(tm, Error);
    var um = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function vm(a, b, c, d) {
        ...
        if ("QuotaExceededError" === e.name) return new rm("QUOTA_EXCEEDED", a);
        if (ad && "UnknownError" === e.name) return new rm("QUOTA_MAYBE_EXCEEDED", a);
        if (e instanceof tm) return new rm("MISSING_INDEX", Object.assign({}, a, {
            objectStore: e.objectStore,
            index: e.index
        }));
        if ("InvalidStateError" === e.name && um.some(function(f) {
                return e.message.includes(f)
            })) return new rm("EXECUTE_TRANSACTION_ON_CLOSED_DB",
            a);
        if ("AbortError" === e.name) return new rm("UNKNOWN_ABORT", a, e.message);
    ...
    function wm(a, b, c) {
        var d = Yl();
        return new rm("IDB_NOT_SUPPORTED", {
            context: {
                caller: a,
                publicName: b,
                version: c,
    ...
    Am.all = function(a) {
        return new Am(new zm(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    xa: f.xa
                }, ++f.xa) Am.resolve(a[f.xa]).then(function(g) {
                return function(h) {
                    d[g.xa] = h;
                    e--;
                    0 === e && b(d)
    ...
    Am.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : ym,
            e = null != b ? b : xm;
        return new Am(new zm(function(f, g) {
            "PENDING" === c.state.status ? (c.i.push(function() {
                Bm(c, c, d, f, g)
            }), c.onRejected.push(function() {
                Cm(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? Bm(c, c, d, f, g) : "REJECTED" === c.state.status && Cm(c, c, e, f, g)
        }))
    };
    Am.prototype.catch = function(a) {
    ...
    function Bm(a, b, c, d, e) {
        try {
            ...
            f instanceof Am ? Dm(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function Hm(a, b) {
        return new Am(new zm(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
        ...
        return w(function(F) {
            switch (F.i) {
                ...
                case 2:
                    ...
                    return v(F, N, 6);
                case 6:
                    return q = F.j, t = Math.round(P()), Pm(a, k, t, g, void 0, b.join(), e), F.return(q);
                case 4:
                    x = xa(F);
                    u = Math.round(P());
                    A = vm(x, a.i.name, b.join(), a.i.version);
                    if ((D = A instanceof rm && !A.i) || g >= f) Pm(a, k, u, g, A, b.join(), e), h = A;
                    F.u(2);
                    break;
                case 3:
    ...
    function Pm(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof rm && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && gm("QUOTA_EXCEEDED", {
            dbName: km(a.i.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof rm && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), gm("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.j = !0), Qm(a, !1, d, f, b, g.tag), fm(e)) : Qm(a, !0, d, f, b, g.tag)
    }

    function Qm(a, b, c, d, e, f) {
        gm("TRANSACTION_ENDED", {
            objectStoreNames: d,
    ...
    l = Lm.prototype;
    l.add = function(a, b) {
        return Gm(this.i.add(a, b))
    };
    l.autoIncrement = function() {
        return this.i.autoIncrement
    };
    l.clear = function() {
        return Gm(this.i.clear()).then(function() {})
    };
    l.count = function(a) {
        return Gm(this.i.count(a))
    };
    ...
    l.delete = function(a) {
        return a instanceof IDBKeyRange ? Rm(this, a) : Gm(this.i.delete(a))
    };
    l.get = function(a) {
        return Gm(this.i.get(a))
    };
    l.index = function(a) {
        try {
            return new Tm(this.i.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new tm(a, this.i.name);
            throw b;
        }
    };
    l.getName = function() {
    ...
    l.delete = function() {
        return Gm(this.cursor.delete()).then(function() {})
    };
    l.getKey = function() {
    ...
    l.update = function(a) {
        return Gm(this.cursor.update(a))
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(u) {
                try {
                    ...
                    u.dataLoss && "none" !== u.dataLoss && gm("IDB_DATA_CORRUPTED", {
                        reason: u.dataLossMessage || "unknown reason",
                        dbName: km(a)
                    });
                    var A = f(),
                        D = new Nm(g.transaction);
                    q && q(A, function(F) {
    ...
    function Zm(a, b) {
        ...
        var c, d, e, f;
        return w(function(g) {
            if (1 == g.i) return va(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.blocked) && c.addEventListener("blocked", function() {
                e()
            }), v(g, Fm(c), 4);
            if (2 != g.i) return wa(g, 0);
            f = xa(g);
            throw vm(f, a, "", -1);
        })
    };
    ...
    function bn(a, b) {
        return new rm("INCOMPATIBLE_DB_VERSION", {
            dbName: a.name,
    ...
    function cn(a, b) {
        if (!b) throw wm("openWithToken", km(a.name));
        return dn(a)
    }
    ...
    function dn(a) {
        function b() {
            ...
            return w(function(D) {
                switch (D.i) {
                    case 1:
                        return g = null != (f = Error().stack) ? f : "", va(D, 2), v(D, a.l(a.name, a.options.version, d), 4);
                    case 4:
                        h = D.j;
                        for (var F = a.options, N = [], O = p(Object.keys(F.Ja)), Q = O.next(); !Q.done; Q = O.next()) {
                            Q = Q.value;
                            var ba = F.Ja[Q],
                                ca = void 0 === ba.Vc ? Number.MAX_VALUE : ba.Vc;
                            !(h.i.version >= ba.jb) || h.i.version >= ca || h.i.objectStoreNames.contains(Q) || N.push(Q)
                        }
                        k = N;
                        if (0 === k.length) {
                            D.u(5);
                        ...
                        if (a.s < qk("ytidb_reopen_db_retries", 0)) return a.s++, h.close(), fm(new rm("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: m,
                            foundObjectStores: q
                        })), D.return(b());
                        if (!(a.m < qk("ytidb_remake_db_retries", 1))) {
                            D.u(6);
                            break
                        }
                        a.m++;
                    ...
                    case 9:
                        return fm(new rm("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: m,
                            foundObjectStores: q
                        })), D.return(b());
        ...
        return w(function(d) {
            ...
            return d.return(Jm(c, ["databases"], {
                ...
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1) return Gm(f.i.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    ...
    function gn(a, b) {
        var c;
        return w(function(d) {
            if (1 == d.i) return a ? v(d, cn(en, b), 2) : d.return();
            c = d.j;
    ...
    function hn(a, b) {
        var c, d;
        return w(function(e) {
            return 1 == e.i ? (c = [], v(e, cn(en, b), 2)) : 3 != e.i ? (d = e.j, v(e, Jm(d, ["databases"], {
                U: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
    ...
    function ln(a) {
        var b, c;
        return w(function(d) {
            if (1 == d.i) return b = im("YtIdbMeta hasAnyMeta other"), v(d, hn(function(e) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = Vl) f = /WebKit\/([0-9]+)/.exec(Rb()), f = !!(f && 600 <= parseInt(f[1], 10));
    ...
    function pn() {
        ...
        return mn = on().then(function(a) {
            ...
            if (null != (b = Xl()) && b.i) {
                var c;
                b = {
                    hasSucceededOnce: (null == (c = Yl()) ? void 0 : c.hasSucceededOnce) || a
                };
                var d;
                null == (d = Xl()) || d.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0)
            }
            return a
        })
    }
    ...
    function rn() {
        ...
        return a ? Promise.resolve(a) : pn().then(function(b) {
            (b = b ? nn : void 0) && z("ytglobal.idbToken_", b);
            return b
        })
    };
    var sn = 0;
    ...
    function un() {
        var a;
        return w(function(b) {
            return 1 == b.i ? v(b, rn(), 2) : (a = b.j) ? b.return(ln(a)) : b.return(!1)
        })
    }
    new th;

    function vn(a) {
        if (!hm()) throw a = new rm("AUTH_INVALID", {
            dbName: a
        }), fm(a), a;
        var b = im();
        return {
    ...
    function wn(a, b, c, d) {
        ...
        return w(function(q) {
            switch (q.i) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", v(q, rn(), 2);
                case 2:
                    g = q.j;
                    if (!g) throw h = wm("openDbImpl", a, b), M("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), fm(h), h;
                    jm(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                ...
                case 6:
                    return q.return(q.j);
                case 3:
                    return m = xa(q), va(q, 7), v(q, gn(k.actualName, g), 9);
                case 9:
                    wa(q,
                        8);
                    break;
    ...
    function An(a, b, c) {
        a = a.map(function(d) {
            return w(function(e) {
                return 1 == e.i ? v(e, Zm(d.actualName, b), 2) : v(e, gn(d.actualName, c), 0)
            })
        });
    ...
    function Dn(a) {
        ...
        this.xb =
            a.xb;
        this.wb = a.wb;
        En(this) && (!this.I || this.I("networkless_logging")) && Fn(this)
    }

    function Fn(a) {
        En(a) && !a.Ha && (a.i = !0, a.Xa && Math.random() <= a.Va && a.O.Ac(a.H), Gn(a), a.M.L() && a.Ma(), a.M.W(a.xb, a.Ma.bind(a)), a.M.W(a.wb, a.Ib.bind(a)))
    }
    l = Dn.prototype;
    ...
    l.sendAndWrite = function(a, b) {
        ...
        if (En(this) && this.i) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.O.za(d.id, c.H) : e = !0;
    ...
    l.Ma = function() {
        var a = this;
        if (!En(this)) throw wm("throttleSend");
        this.j || (this.j = this.ba.S(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return v(c, a.O.Tb("NEW", a.H), 2);
                if (3 != c.i) return b = c.j, b ? v(c, Hn(a, b), 3) : (a.Ib(), c.return());
                a.j && (a.j = 0, a.Ma());
                c.i = 0
            })
        }, this.mc))
    ...
    function Hn(a, b) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    if (!En(a)) throw c = wm("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.u(2);
                        break
                    }
                    return v(e, a.O.Nc(b.id, a.H), 3);
                case 3:
    ...
    function Kn(a, b) {
        if (!En(a)) throw wm("updateRequestHandlers");
            ...
            return w(function(m) {
                switch (m.i) {
                    ...
                    case 2:
                        ...
                        return b.sendCount < a.ic ? v(m, a.O.zb(b.id, a.H), 12) : v(m, a.O.za(b.id, a.H), 8);
                    case 12:
                        a.ba.S(function() {
                            a.M.L() && a.Ma()
                        }, a.hc);
        ...
        b.options.onSuccess = function(e, f) {
            var g;
            return w(function(h) {
                if (1 == h.i) return void 0 === (null == (g = b) ? void 0 : g.id) ? h.u(2) : v(h, a.O.za(b.id, a.H), 2);
    ...
    function Gn(a) {
        if (!En(a)) throw wm("retryQueuedRequests");
        a.O.Tb("QUEUED", a.H).then(function(b) {
            b && !Jn(a, b, a.dc) ? a.ba.S(function() {
                return w(function(c) {
    ...
    function In(a, b) {
        a.pc && !a.M.L() ? a.pc(b) : a.handleError(b)
    }
    ...
    var On = B("ytPubsub2Pubsub2Instance") || new K;
    ...
    z("ytPubsub2Pubsub2Instance", On);
    var Pn = B("ytPubsub2Pubsub2SubscribedKeys") || {};
    z("ytPubsub2Pubsub2SubscribedKeys", Pn);
    var Qn = B("ytPubsub2Pubsub2TopicToKeys") || {};
    z("ytPubsub2Pubsub2TopicToKeys", Qn);
    var Rn = B("ytPubsub2Pubsub2IsAsync") || {};
    z("ytPubsub2Pubsub2IsAsync", Rn);
    ...
    function Un(a) {
        ...
        var d = c.subscribe(b.toString(), function(e, f) {
            ...
            }, Rn[b.toString()] ? B("yt.scheduler.instance") ? Nh.S(g) : Qk(g, 0) : g())
        });
        Pn[d] = !0;
        Qn[b.toString()] || (Qn[b.toString()] = []);
        Qn[b.toString()].push(d);
        return d
    }
    ...
    Zn.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ab ? yn : xn)(a, b, Object.assign({}, c))
    };
    Zn.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ab ? Cn : zn)(this.name, a)
    };
    ...
    function ho(a, b) {
        ...
        return w(function(m) {
            ...
            if (3 != m.i) return d = m.j, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, P()], h = IDBKeyRange.bound(f, g), k = void 0, v(m, Jm(d, ["LogsRequestsStore"], {
                mode: "readwrite",
                U: !0
            }, function(q) {
        ...
        return w(function(d) {
            ...
            return d.return(Jm(c, ["LogsRequestsStore"], {
                ...
                return f.get(a).then(function(g) {
                    if (g) return g.status = "QUEUED", Gm(f.i.put(g, void 0)).then(function() {
                        return g
                    })
                })
            }))
        ...
        return w(function(e) {
            ...
            return e.return(Jm(d, ["LogsRequestsStore"], {
                ...
                return g.get(a).then(function(h) {
                    return h ? (h.status = "NEW", c && (h.sendCount += 1), Gm(g.i.put(h, void 0)).then(function() {
                        return h
                    })) : Am.resolve(void 0)
                })
            }))
    ...
    function go(a) {
        M("nwl_csi_killswitch") || .01 >= Math.random() && Sn("nwl_transaction_latency_payload", a)
    };
    var no = {},
        oo = ao("ServiceWorkerLogsDatabase", {
            Ja: (no.SWHealthLog = {
                jb: 1
            }, no),
            Ab: !0,
    ...
    function uo(a) {
        ...
        var c = void 0 === c ? !1 : c;
        if (a)
            if (b) $k(a, void 0, "POST", b);
            else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) $k(a, void 0, "GET", "", void 0, void 0, c);
        else {
            b: {
                try {
                    var d = new bb({
    ...
    function xo() {
        if (!wo.i) {
            var a = B("yt.networkRequestMonitor.instance") || new wo;
            z("yt.networkRequestMonitor.instance", a);
            wo.i = a
        }
        return wo.i
    }
    wo.prototype.requestComplete = function(a, b) {
        b && (this.j = !0);
        a = this.removeParams(a);
        this.i.get(a) || this.i.set(a, b)
    };
    wo.prototype.isEndpointCFR = function(a) {
        a = this.removeParams(a);
        return (a = this.i.get(a)) ? !1 : !1 === a && this.j ? !0 : null
    };
    wo.prototype.removeParams = function(a) {
        return a.split("?")[0]
    };
    wo.prototype.removeParams = wo.prototype.removeParams;
    wo.prototype.isEndpointCFR = wo.prototype.isEndpointCFR;
    wo.prototype.requestComplete = wo.prototype.requestComplete;
    wo.getInstance = xo;
    var yo;

    function zo() {
        yo || (yo = new Gl("yt.offline"));
        return yo
    }

    function Ao(a) {
        if (M("offline_error_handling")) {
            var b = zo().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            zo().set("errors", b, 2592E3, !0)
        }
    }

    function Bo() {
        if (M("offline_error_handling")) {
            var a = zo().get("errors", !0);
            if (a) {
                for (var b in a)
                    if (a[b]) {
                ...
                zo().set("errors", {}, 2592E3, !0)
            }
        }
    };
    var Co = qk("network_polling_interval", 3E4);
    ...
    function Do() {
        ...
        this.v = this.m = !1;
        this.l = this.rb();
        M("use_shared_nsm") ? (this.j = Mh(), M("use_shared_nsm_and_keep_yt_online_updated") && (this.j.W("networkstatus-online", function() {
            a.l = !0;
            a.v && Bo()
    ...
    function Go() {
        if (!Do.i) {
            var a = B("yt.networkStatusManager.instance") || new Do;
    ...
    l.Oc = function(a) {
        !M("use_shared_nsm") && (this.m = !0, void 0 === a ? 0 : a) && (this.G || Ho(this))
    };
    l.rb = function() {
    ...
    l.W = function(a, b) {
        return M("use_shared_nsm") && this.j ? this.j.W(a, b) : Ue.prototype.W.call(this, a, b)
    };
    ...
    function Ho(a) {
        a.G = Pl(function() {
            return w(function(b) {
                if (1 == b.i) return a.l ? a.rb() || !a.m ? b.u(3) : v(b, a.ja(), 3) : v(b, a.ja(), 3);
                Ho(a);
                b.i = 0
            })
        }, Co)
    ...
    l.ja = function(a) {
        ...
        if (M("use_shared_nsm") && this.j) {
            var c = Kh(this.j, a);
            c.then(function(d) {
                M("use_cfr_monitor") && xo().requestComplete("generate_204", d)
            });
            return c
        }
        return this.s ? this.s : this.s = new Promise(function(d) {
            ...
            return w(function(k) {
                switch (k.i) {
                    case 1:
                        return e = window.AbortController ? new window.AbortController : void 0, g = null == (f = e) ? void 0 : f.signal, h = !1, va(k, 2, 3), e && (b.B = Nh.S(function() {
                            e.abort()
                    ...
                    case 3:
                        Aa(k);
                        M("use_cfr_monitor") && xo().requestComplete("generate_204", h);
                        b.s = void 0;
                        b.B && Nh.aa(b.B);
                        h !== b.l && (b.l = h, b.l && b.m ? Ve(b, "ytnetworkstatus-online") : b.m && Ve(b, "ytnetworkstatus-offline"));
                        d(h);
                        Ba(k);
                        break;
                    case 2:
    ...
    Do.prototype.sendNetworkCheckRequest = Do.prototype.ja;
    Do.prototype.listen = Do.prototype.W;
    Do.prototype.enableErrorFlushing = Do.prototype.Ec;
    Do.prototype.getWindowStatus = Do.prototype.rb;
    Do.prototype.monitorNetworkStatusChange = Do.prototype.Oc;
    Do.prototype.networkStatusHint = Do.prototype.ha;
    Do.prototype.isNetworkAvailable = Do.prototype.L;
    Do.getInstance = Go;
    ...
    function Io(a) {
        ...
        c && c(a.Pb);
        a.Yb && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j)) && c();
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.j)) a.fb ? (this.fb = a.fb, c(this.s,
            function() {
                Jo(b, "publicytnetworkstatus-online")
            }), c(this.m, function() {
            Jo(b, "publicytnetworkstatus-offline")
        })) : (c(this.s, function() {
            Ve(b, "publicytnetworkstatus-online")
        }), c(this.m, function() {
            Ve(b, "publicytnetworkstatus-offline")
        }))
    }
    r(Io, Ue);
    ...
    Io.prototype.ja = function(a) {
        var b = this,
            c;
        return w(function(d) {
            c = B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.j);
            return M("skip_network_check_if_cfr") && xo().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
    ...
    function Jo(a, b) {
        a.fb ? a.l ? (Nh.aa(a.B), a.B = Nh.S(function() {
            a.v !== b && (Ve(a, b), a.v = b, a.l = P())
        }, a.fb - (P() - a.l))) : (Ve(a, b), a.v = b, a.l = P()) : Ve(a, b)
    };
    var Ko;
    ...
    function Lo() {
        Dn.call(this, {
            ...
            Xa: !0,
            Va: .1,
            cb: qk("potential_esf_error_limit", 10),
            I: M,
            Ha: !(hm() && Oo())
        });
        this.l = new th;
        M("networkless_immediately_drop_all_requests") && mo();
        Cn("LogsDatabaseV2")
    }
    r(Lo, Dn);
    ...
    function Po() {
        ...
        a || (a = new Lo, z("yt.networklessRequestController.instance", a), M("networkless_logging") && rn().then(function(b) {
            a.H = b;
            Fn(a);
            a.l.resolve();
            a.Xa && Math.random() <= a.Va && a.H && qo(a.H);
            M("networkless_immediately_drop_sw_health_store") && Qo(a)
        }));
        return a
    }
    Lo.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        hm() || (this.i = !1);
        Dn.prototype.writeThenSend.call(this, a, b)
    };
    Lo.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        hm() || (this.i = !1);
        Dn.prototype.sendThenWrite.call(this, a, b, c)
    };
    Lo.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        hm() || (this.i = !1);
        Dn.prototype.sendAndWrite.call(this, a, b)
    };
    Lo.prototype.awaitInitialization = function() {
    ...
    function Qo(a) {
        var b;
        w(function(c) {
            if (!a.H) throw b = wm("clearSWHealthLogsDb"), b;
            return c.return(ro(a.H).catch(function(d) {
                a.handleError(d)
            }))
        })
    }
    ...
    function Ro(a, b) {
        ...
        b.onError = function(e, f) {
            xo().requestComplete(a, !1);
            c(e, f)
        };
        var d = b.onSuccess ? b.onSuccess : function() {};
        b.onSuccess = function(e, f) {
            xo().requestComplete(a, !0);
            d(e, f)
        }
    }

    function Oo() {
        return "www.youtube-nocookie.com" !== mc(document.location.toString())
    };
    var So = !1,
        To = 0,
        Uo = 0,
        Vo, Wo = y.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: So,
            potentialEsfErrorCounter: Uo
        };
    z("ytNetworklessLoggingInitializationOptions", Wo);
    ...
    function Xo() {
        ...
        w(function(b) {
            switch (b.i) {
                ...
                case 2:
                    a = b.j;
                    if (!a || !hm() && !M("nwl_init_require_datasync_id_killswitch") || !Oo()) {
                        b.u(0);
                        break
                    }
                    So = !0;
                    Wo.isNwlInitialized = So;
                    if (!M("use_new_nwl_initialization")) {
                        b.u(4);
                        break
                    }
                    return v(b, Po().awaitInitialization(), 5);
                case 5:
                    return b.return();
                case 4:
                    return v(b, Cn("LogsDatabaseV2"), 6);
                case 6:
                    if (!(.1 >= Math.random())) {
                        b.u(7);
                        break
                ...
                case 7:
                    Yo();
                    Zo().L() && $o();
                    Zo().W("publicytnetworkstatus-online",
                        $o);
                    Zo().W("publicytnetworkstatus-offline", ap);
                    ...
                    return v(b, bp(), 10);
                case 10:
                    if (M("networkless_immediately_drop_all_requests")) return v(b, mo(), 0);
                    b.u(0)
            }
        })
    }
    ...
    function cp(a, b) {
        function c(d) {
            var e = Zo().L();
            if (!dp() || !d || e && M("vss_networkless_bypass_write")) ep(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        M("skip_is_supported_killswitch") ? rn().then(function(d) {
            c(d)
        }) : c(qn())
    }
        ...
        function c(d) {
            if (dp() && d) {
                ...
                e.options.onSuccess = function(k, m) {
                    M("use_cfr_monitor") && xo().requestComplete(e.url, !0);
                    void 0 !== e.id ? ko(e.id, d) : f = !0;
                    M("vss_network_hint") && Zo().ha(!0);
                    g(k, m)
                };
                if (M("use_cfr_monitor")) {
                    var h = b.onError ? b.onError : function() {};
                    e.options.onError = function(k, m) {
                        xo().requestComplete(e.url, !1);
                        h(k, m)
                    }
                }
                ep(e.url, e.options);
                fo(e, d).then(function(k) {
                    e.id = k;
                    f && ko(e.id, d)
                }).catch(function(k) {
                    Zo().L() ? wk(k) : Ao(k)
    ...
    function $o() {
        var a = qn();
        if (!a) throw wm("throttleSend");
        To || (To = Nh.S(function() {
            var b;
            return w(function(c) {
                if (1 == c.i) return v(c, ho("NEW", a), 2);
                if (3 != c.i) return b = c.j, b ? v(c, fp(b), 3) : (ap(), c.return());
                To && (To = 0, $o());
                c.i = 0
            })
        }, 100))
    ...
    function fp(a) {
        ...
        return w(function(e) {
            switch (e.i) {
                case 1:
                    b = qn();
                    if (!b) throw c = wm("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.u(2);
                        break
                    }
                    return v(e, io(a.id, b), 3);
                case 3:
                    (d = e.j) ? a = d: xk(Error("The request cannot be found in the database."));
                case 2:
                    if (hp(a, 2592E6)) {
                        e.u(4);
                        break
                    }
                    xk(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.u(5);
                        break
                    }
                    return v(e, ko(a.id, b), 5);
                case 5:
                    return e.return();
                case 4:
                    a.skipRetry || (a = ip(a));
                    ...
                    return v(e, ko(a.id, b), 8);
                case 8:
                    ep(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    ...
    function ip(a) {
        var b = qn();
        if (!b) throw wm("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return w(function(m) {
                switch (m.i) {
                    case 1:
                        M("use_cfr_monitor") && xo().requestComplete(a.url, !1);
                        g = Ln(f);
                        if (!(M("nwl_consider_error_code") && g || !M("nwl_consider_error_code") && jp() <= qk("potential_esf_error_limit", 10))) {
                            m.u(2);
                            break
                        }
                        if (M("skip_checking_network_on_cfr_failure") && (!M("skip_checking_network_on_cfr_failure") || xo().isEndpointCFR(a.url))) {
                            m.u(3);
                            break
                        }
                        return v(m, Zo().ja(), 3);
                    case 3:
                        ...
                        return v(m, jo(a.id, b, !1), 6);
                    case 6:
                        return m.return();
                    case 2:
                        if (M("nwl_consider_error_code") && !g && jp() > qk("potential_esf_error_limit", 10)) return m.return();
                        B("ytNetworklessLoggingInitializationOptions") && Wo.potentialEsfErrorCounter++;
                        Uo++;
                        if (void 0 === (null == (k = a) ? void 0 : k.id)) {
                            m.u(8);
                            break
                        }
                        return 1 > a.sendCount ? v(m, jo(a.id, b), 12) : v(m, ko(a.id, b), 8);
                    case 12:
                        Nh.S(function() {
                            Zo().L() && $o()
                        }, 5E3);
        ...
        a.options.onSuccess = function(e, f) {
            var g;
            return w(function(h) {
                if (1 == h.i) return M("use_cfr_monitor") && xo().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.u(2) : v(h, ko(a.id, b), 2);
                M("vss_network_hint") && Zo().ha(!0);
                d(e, f);
                h.i = 0
            })
    ...
    function Yo() {
        var a = qn();
        if (!a) throw wm("retryQueuedRequests");
        ho("QUEUED", a).then(function(b) {
            b && !hp(b, 12E4) ? Nh.S(function() {
                return w(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.u(2) : v(c, jo(b.id, a), 2);
                    Yo();
                    c.i = 0
                })
            }) : Zo().L() && $o()
    ...
    function bp() {
        ...
        return w(function(c) {
            a = qn();
            if (!a) throw b = wm("clearSWHealthLogsDb"), b;
            return c.return(ro(a).catch(function(d) {
                wk(d)
            }))
        })
    }
    ...
    function dp() {
        return B("ytNetworklessLoggingInitializationOptions") ? Wo.isNwlInitialized : So
    }

    function jp() {
        return B("ytNetworklessLoggingInitializationOptions") ? Wo.potentialEsfErrorCounter : Uo
    };

    function kp(a) {
        var b = this;
        this.config_ = null;
        a ? this.config_ = a : wl() && (this.config_ = xl());
        Pl(function() {
            Ml(b)
        }, 5E3)
    }
    kp.prototype.isReady = function() {
        !this.config_ && wl() && (this.config_ = xl());
        return !!this.config_
    };
    ...
    function Nl(a, b, c, d) {
        function e(A) {
            A = void 0 === A ? !1 : A;
            var D;
            if (d.retry && "www.youtube-nocookie.com" != h && (A || M("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (D = Kl(b, c, m, k)), D)) {
                var F = g.onSuccess,
                    N = g.onFetchSuccess;
            ...
            try {
                A && d.retry && !d.Zb.bypassNetworkless ? (g.method = "POST", d.Zb.writeThenSend ? M("use_new_nwl_wts") ? Po().writeThenSend(u, g) : cp(u, g) : M("use_new_nwl_saw") ? Po().sendAndWrite(u, g) : gp(u, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), Xk(u, g))
            } catch (O) {
                if ("InvalidAccessError" == O.name) D && (Ll(D), D = 0), xk(Error("An extension is blocking network request."));
                else throw O;
            }
            D && Pl(function() {
                Ml(a)
            }, 5E3)
        }!L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && xk(new R("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        var u = Jk("" + h + q, t || {}, !0);
        M("use_new_nwl") && Po().i || !M("use_new_nwl") &&
            dp() ? pn().then(function(A) {
                e(A)
            }) : e(!1)
    };
    var lp = {
    ...
    var np = 0,
        Ep = Nc ? "webkit" : Mc ? "moz" : Kc ? "ms" : Jc ? "o" : "";
    ...
    function dq(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in cq || (this[b] = a[b]);
                this.scale = a.scale;
    ...
    dq.prototype.stopImmediatePropagation = function() {
        this.event && (this.event.cancelBubble = !0, this.event.stopImmediatePropagation && this.event.stopImmediatePropagation())
    };
    var ob = y.ytEventsEventsListeners || {};
    z("ytEventsEventsListeners", ob);
    var fq = y.ytEventsEventsCounter || {
        count: 0
    };
    z("ytEventsEventsCounter", fq);
    ...
    function iq(a, b, c, d) {
        ...
        var g = f ? function(h) {
            h = new dq(h);
            if (!df(h.relatedTarget, function(k) {
                    return k == a
        ...
        g = vk(g);
        a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), hq() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
        ob[e] = [a, b, c, g, d];
        return e
    }
        ...
        a && ("string" == typeof a && (a = [a]), fb(a, function(b) {
            if (b in ob) {
                var c = ob[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? hq() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete ob[b]
            }
        }))
    };
    var kq = window.ytcsi && window.ytcsi.now ? window.ytcsi.now : window.performance && window.performance.timing && window.performance.now && window.performance.timing.navigationStart ? function() {
    ...
    function lq(a) {
        ...
        this.o = 0;
        this.K = iq(window, "mousemove", Xa(this.P, this));
        a = Xa(this.G, this);
        "function" === typeof a && (a = vk(a));
        this.R = window.setInterval(a, 25)
    }
    Za(lq, J);
    lq.prototype.P = function(a) {
        void 0 === a.i && eq(a);
        var b = a.i;
        void 0 === a.j && eq(a);
        this.j = new $e(b, a.j)
    ...
    function nq(a) {
        ...
        if (null == B("_lact", window)) {
            ...
            z("_lact", c, window);
            z("_fact", c, window); - 1 == c && oq();
            iq(document, "keydown", oq);
            iq(document, "keyup", oq);
            iq(document, "mousedown", oq);
            iq(document, "mouseup", oq);
            a ? iq(window, "touchmove", function() {
                pq("touchmove", 200)
            }, {
                passive: !0
            }) : (iq(window, "resize", function() {
                pq("resize", 200)
            }), b && iq(window, "scroll", function() {
                pq("scroll", 200)
            }));
            new lq(function() {
                pq("mouse", 100)
            });
            iq(document, "touchstart", oq, {
                passive: !0
            });
            iq(document, "touchend", oq, {
                passive: !0
            })
        }
    }
    ...
    var rq = y.ytPubsubPubsubInstance || new K,
        sq = y.ytPubsubPubsubSubscribedKeys || {},
        tq = y.ytPubsubPubsubTopicToKeys || {},
        uq = y.ytPubsubPubsubIsSynchronous || {};
    ...
    function vq(a, b) {
        ...
        if (c && b) {
            var d = c.subscribe(a, function() {
                var e = arguments;
                var f = function() {
                    sq[d] && b.apply && "function" == typeof b.apply && b.apply(window, e)
                };
                try {
                    uq[a] ? f() : Qk(f, 0)
                } catch (g) {
    ...
    K.prototype.publish = K.prototype.qa;
    K.prototype.clear = K.prototype.clear;
    z("ytPubsubPubsubInstance", rq);
    z("ytPubsubPubsubTopicToKeys", tq);
    z("ytPubsubPubsubIsSynchronous", uq);
    z("ytPubsubPubsubSubscribedKeys", sq);
    var Bq = y.window;
    Bq.ytExports || (Bq.ytExports = {
        logging: {
            transport: {
                leaderQueueLength: 0,
                leaderChosen: !1
    ...
    var Cq = qk("initial_gel_batch_timeout", 2E3),
        Dq = Math.pow(2, 16) - 1,
        Eq = !1,
        Fq = void 0;
    ...
    var Hq = new Gq,
        Iq = new Gq,
        Jq = !0,
        Kq = y.ytLoggingTransportGELQueue_ || new Map;
    z("ytLoggingTransportGELQueue_", Kq);
    var Lq = new Map,
        Mq = y.ytLoggingTransportGELProtoQueue_ || new Map;
    z("ytLoggingTransportGELProtoQueue_", Mq);
    var Nq = y.ytLoggingTransportTokensToCttTargetIds_ || {};
    z("ytLoggingTransportTokensToCttTargetIds_", Nq);
    var Oq = y.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    z("ytLoggingTransportTokensToJspbCttTargetIds_", Oq);

    function Pq() {
        M("jspb_with_transport_leader") && !Bq.ytExports.logging.transport.leaderChosen && (Eq = Bq.ytExports.logging.transport.leaderChosen = !0, document.addEventListener("FLUSH_REQUEST", function() {
            Qq(void 0, void 0, !0)
        }))
    }
    ...
    function Vq(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            Sq(void 0, a);
            var c = Tq(a, !0);
            if (M("jspb_with_transport_leader") && Eq) {
                var d = Lq.get(c) || [];
                Lq.set(c, d);
                Bq.ytExports.logging.transport.leaderQueueLength++;
                d.push(a.payload);
                Uq(b, d, c, !0)
            } else d = Mq.get(c) || [], Mq.set(c, d), a = a.payload.toJSON(), d.push(a), Uq(b, d, c, !0)
        }
    }
    ...
    function Uq(a, b, c, d) {
        d = void 0 === d ? !1 : d;
        a && (Fq = new a);
        a = qk("tvhtml5_logging_max_batch") || qk("web_logging_max_batch") || 100;
        var e = P(),
            f = d ? Iq.l : Hq.l,
            g = Mq.get(c) || [];
        M("jspb_with_transport_leader") && (Eq && b.length + g.length >= a || !Eq && Bq.ytExports.logging.transport.leaderQueueLength + b.length >= a) || b.length >= a ? Qq({
            writeThenSend: !0
        }, M("flush_only_full_queue") ? c : void 0, d) : 10 <= e - f && (Wq(d), d ? Iq.l = e : Hq.l = e)
    }
    ...
    function Zq(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            var c = Tq(a, !0),
                d = new Map,
                e = new Map;
            M("jspb_with_transport_leader") && Eq ? e.set(c, [a.payload]) : d.set(c, [a.payload.toJSON()]);
            b && (Fq = new b);
            return new qf(function(f) {
                Fq && Fq.isReady() ? $q(d, e, f, {
                    bypassNetworkless: !0
                }, !0) : f()
            })
        }
    ...
    function Tq(a, b) {
        ...
        if (a.Ga) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.cttAuthInfo;
                var d = new Jj;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && Pd(d, 2, Kj, c.playlistId);
                Oq[b] = d
            } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Nq[a.cttAuthInfo.token] = c;
    ...
    function Qq(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new qf(function(d, e) {
            c ? (Rk(Iq.j), Rk(Iq.i), Iq.i = 0) : (Rk(Hq.j), Rk(Hq.i), Hq.i = 0);
            if (M("jspb_with_transport_leader") && !Eq) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
            else if (Fq && Fq.isReady())
                if (void 0 !== b)
                    if (c) {
                        e = new Map;
                        var f = new Map,
                            g = Mq.get(b) || [];
                        e.set(b, g);
                        M("jspb_with_transport_leader") && (g = Lq.get(b) || [], f.set(b, g));
                        $q(e, f, d, a);
                        M("jspb_with_transport_leader") && Lq.delete(b);
                        Mq.delete(b)
                    } else f = new Map, g = Kq.get(b) || [], f.set(b,
                        g), Yq(f, d, e, a), Kq.delete(b);
            else c ? ($q(Mq, Lq, d, a), Mq.clear(), M("jspb_with_transport_leader") && Lq.clear()) : (Yq(Kq, d, e, a), Kq.clear());
            else Wq(c), d()
        })
    }
    ...
    function Wq(a) {
        a = void 0 === a ? !1 : a;
        if (M("web_gel_timeout_cap") && (!a && !Hq.i || a && !Iq.i)) {
            var b = Qk(function() {
                Qq({
                    writeThenSend: !0
                }, void 0, a)
        ...
        Rk(a ? Iq.j : Hq.j);
        b = L("LOGGING_BATCH_TIMEOUT", qk("web_gel_debounce_ms", 1E4));
        M("shorten_initial_gel_batch_timeout") && Jq && (b = Cq);
        b = Qk(function() {
            Qq({
                writeThenSend: !0
            }, void 0, a)
    ...
    function Yq(a, b, c, d, e) {
        ...
        for (var k = a.next(); !k.done; k = a.next()) {
            ...
            try {
                Nl(f, "log_event", k, dr(d, m, q, t, e)), Jq = !1
            } catch (x) {
                wk(x), c()
            }
        }
    ...
    function $q(a, b, c, d, e) {
        ...
        for (var m = k.next(); !m.done; m = k.next()) {
            var q = p(m.value).next().value,
                ...
                x = b.get(q) || [];
            m = new Lj;
            var u = Dl(f.config_ || xl());
            G(m, Qi, 1, u);
            t = t ? er(t) : [];
            t = p(t);
            for (u = t.next(); !u.done; u = t.next()) Wd(m, 3, Fj, u.value);
            x = p(x);
            for (t = x.next(); !t.done; t = x.next()) Wd(m, 3, Fj, t.value);
            (x = Oq[q]) && fr(m, q, x);
            delete Oq[q];
            ...
            q = dr(d, q,
                function() {
                    Bq.ytExports.logging.transport.leaderQueueLength = 0;
                    h--;
                    h || c()
                },
                function() {
    ...
    function br(a, b, c) {
        ...
        !c && (b = L("EVENT_ID")) && (c = hr(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function hr() {
        ...
        a || (a = Math.floor(Math.random() * Dq / 2));
        a++;
        a > Dq && (a = 1);
        nk("BATCH_CLIENT_COUNTER", a);
        return a
    }
    ...
    function er(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            wk(new R("Transport failed to deserialize " + String(a[c])))
        }
        return b
    }
    ...
    var ir = y.ytLoggingGelSequenceIdObj_ || {};
    z("ytLoggingGelSequenceIdObj_", ir);

    function jr(a, b, c, d) {
        d = void 0 === d ? {} : d;
        if (M("lr_drop_other_and_business_payloads")) {
            if (mp[a] || lp[a]) return
        } else if (M("lr_drop_other_payloads") && mp[a]) return;
        var e = {},
        ...
        M("log_sequence_info_on_gel_web") && d.ca && (a = e.context, b = d.ca, b = {
            index: kr(b),
            groupKey: b
        }, a.sequence = b, d.Qb && delete ir[d.ca]);
        (d.jc ? Xq : Rq)({
            endpoint: "log_event",
            payload: e,
    ...
    function lr(a) {
        Qq(void 0, void 0, void 0 === a ? !1 : a)
    }

    function kr(a) {
        ir[a] = a in ir ? ir[a] + 1 : 0;
        return ir[a]
    };
    ...
    function em(a, b, c) {
        c = void 0 === c ? {} : c;
        var d = kp;
        L("ytLoggingEventsDefaultDisabled", !1) && kp == kp && (d = null);
        jr(a, b, d, c)
    };
    var mr = [{
        vb: function(a) {
    ...
    function rr() {
        if (!qr) {
            ...
            a.na.length = 0;
            a.ma.length = 0;
            or.na && a.na.push.apply(a.na, or.na);
            or.ma && a.ma.push.apply(a.ma, or.ma)
        }
        return qr
    };
    var sr = new K;
    ...
    function vr(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += wr(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = tr(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? wr(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += wr(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = xr(a), d += c[b].length;
        else c[b] = xr(a), d += c[b].length;
        return d
    }
    ...
    var yr = y.ytLoggingGelSequenceIdObj_ || {};
    z("ytLoggingGelSequenceIdObj_", yr);
    ...
    function Ar(a, b) {
        b = void 0 === b ? {} : b;
        var c = !1;
        L("ytLoggingEventsDefaultDisabled", !1) && kp === kp && (c = !0);
        zr(a, c ? null : kp, b)
    };
    ...
    var Ir = new Set,
        ...
        Lr = 0,
        Mr = [],
        Nr = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
        ...
        if (a) {
            ...
            if (!(5 <= Jr)) {
                ...
                if (a.hasOwnProperty("args") && a.args && a.args.length)
                    for (var Q = 0; Q < a.args.length && !(O = vr(a.args[Q], "params." + Q, g, O), 500 <= O); Q++);
                        ...
                        for (var ca in ba) {
                            if (ba[ca]) {
                                var V = "params." + ca,
                                    Ua = xr(ba[ca]);
                                g[V] = Ua;
                                O += V.length + Ua.length;
                                if (500 < O) break
                            }
                        } else g.params = xr(ba)
                }
                if (m.length)
                    for (var za = 0; za < m.length && !(O = vr(m[za], "params.context." + za, g, O), 500 <= O); za++);
                ...
                if ("IGNORED" === a.level) var ya = 0;
                    ...
                    for (var op = rr(), pp = p(op.na), Pj = pp.next(); !Pj.done; Pj = pp.next()) {
                        var qp = Pj.value;
                        if (H.message && H.message.match(qp.oq)) {
                            ya = qp.weight;
                            break a
                        }
                    }
                    for (var rp = p(op.ma), Qj = rp.next(); !Qj.done; Qj = rp.next()) {
                        var sp = Qj.value;
                        if (sp.callback(H)) {
                            ya = sp.weight;
                            break a
                ...
                H.sampleWeight = ya;
                for (var tp = p(mr), Rj = tp.next(); !Rj.done; Rj = tp.next()) {
                    var Sj = Rj.value;
                    if (Sj.bb[H.name])
                        for (var up = p(Sj.bb[H.name]), Tj = up.next(); !Tj.done; Tj = up.next()) {
                            var vp = Tj.value,
                                Gg = H.message.match(vp.regexp);
                            if (Gg) {
                                H.params["params.error.original"] = Gg[0];
                                for (var Uj = vp.groups, wp = {}, od = 0; od < Uj.length; od++) wp[Uj[od]] = Gg[od + 1], H.params["params.error." + Uj[od]] = Gg[od + 1];
                                H.message = Sj.vb(wp);
                                break
                            }
                        }
                ...
                H.params || (H.params = {});
                var xp = rr();
                H.params["params.errorServiceSignature"] = "msg=" + xp.na.length + "&cb=" + xp.ma.length;
                ...
                Db("sample").constructor !==
                    zb && (H.params["params.fconst"] = "true");
                window.yterr && "function" === typeof window.yterr && window.yterr(H);
                if (0 !== H.sampleWeight && !Ir.has(H.message)) {
                    if ("ERROR" === h) {
                        sr.qa("handleError", H);
                        if (M("record_app_crashed_web") && 0 === Lr && 1 === H.sampleWeight)
                            if (Lr++, M("errors_via_jspb")) {
                                ...
                                M("report_client_error_with_app_crash_ks") || (Dp.systemHealth = {
                                    crashData: {
                                        clientError: {
                                            logMessage: {
                                                message: H.message
                        ...
                        Kr++
                    } else "WARNING" === h && sr.qa("handleWarning", H);
                    if (M("kevlar_gel_error_routing")) a: {
                        ...
                        if (M("errors_via_jspb")) {
                            if (Qr()) var Fp = void 0;
                                ...
                                var pd = new Vi;
                                E(pd, 1, H.stack);
                                H.fileName && E(pd, 4, H.fileName);
                                var Ab = H.lineNumber && H.lineNumber.split ? H.lineNumber.split(":") : [];
                                0 !== Ab.length && (1 !==
                                    Ab.length || isNaN(Number(Ab[0])) ? 2 !== Ab.length || isNaN(Number(Ab[0])) || isNaN(Number(Ab[1])) || (E(pd, 2, Number(Ab[0])), E(pd, 3, Number(Ab[1]))) : E(pd, 2, Number(Ab[0])));
                                var tc = new Yi;
                                E(tc, 1, H.message);
                                E(tc, 3, H.name);
                                ...
                                for (var Gp = L("FEXP_EXPERIMENTS", []), Xj = 0; Xj < Gp.length; Xj++) {
                                    var Bv = Gp[Xj];
                                    xd(Xb);
                                    Md(Xb, 5).push(Bv)
                                }
                                var Yj = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                                if (!ok() && Yj)
                                    for (var Hp = p(Object.keys(Yj)), uc = Hp.next(); !uc.done; uc = Hp.next()) {
                                        var Ip = uc.value,
                                            Zj = new Ui;
                                        E(Zj, 1, Ip);
                                        Zj.setValue(String(Yj[Ip]));
                                        Wd(Xb, 4, Ui, Zj)
                                    }
                                var ak = H.params;
                                if (ak) {
                                    var Jp = p(Object.keys(ak));
                                    for (uc = Jp.next(); !uc.done; uc = Jp.next()) {
                                        var Kp = uc.value,
                                            bk = new Ui;
                                        E(bk, 1, "client." + Kp);
                                        bk.setValue(String(ak[Kp]));
                                        Wd(Xb, 4, Ui, bk)
                                    }
                                }
                                var Lp = L("SERVER_NAME"),
                                    Mp = L("SERVER_VERSION");
                                if (Lp && Mp) {
                                    var ck = new Ui;
                                    E(ck, 1, "server.name");
                            ...
                            if (Qr()) var Pp = void 0;
                                ...
                                "ERROR" === ue ? ek.level = "ERROR_LEVEL_ERROR" : "WARNING" === ue && (ek.level = "ERROR_LEVEL_WARNNING");
                                var Cv = {
                                        isObfuscated: !0,
                                        browserStackInfo: ve
                                    },
                                ...
                                L("FEXP_EXPERIMENTS") && (qd.experimentIds = L("FEXP_EXPERIMENTS"));
                                var fk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                                if (!ok() && fk)
                                    for (var Qp = p(Object.keys(fk)), vc = Qp.next(); !vc.done; vc = Qp.next()) {
                                        var Rp =
                                            vc.value;
                                        qd.kvPairs.push({
                                            key: Rp,
                                ...
                                var gk = H.params;
                                if (gk) {
                                    var Sp = p(Object.keys(gk));
                                    for (vc = Sp.next(); !vc.done; vc = Sp.next()) {
                                        var Tp = vc.value;
                                        qd.kvPairs.push({
                                            key: "client." + Tp,
                                            value: String(gk[Tp])
                                ...
                                var Up = L("SERVER_NAME"),
                                    Vp = L("SERVER_VERSION");
                                Up && Vp && (qd.kvPairs.push({
                                    key: "server.name",
                                    value: Up
                                }), qd.kvPairs.push({
                                    key: "server.version",
                    ...
                    if (!M("suppress_error_204_logging")) {
                        ...
                        if (Yb.postParams) {
                            ...
                            for (var Xp = p(Object.keys(we)), hk = Xp.next(); !hk.done; hk = Xp.next()) {
                                var Yp = hk.value;
                                Yb.postParams["client." + Yp] = we[Yp]
                            }
                            var ik =
                                L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                            if (ik)
                                for (var Zp = p(Object.keys(ik)), jk = Zp.next(); !jk.done; jk = Zp.next()) {
                                    var $p = jk.value;
                                    Yb.postParams[$p] = ik[$p]
                                }
                            var aq = L("SERVER_NAME"),
                                bq = L("SERVER_VERSION");
                            aq && bq && (Yb.postParams["server.name"] = aq, Yb.postParams["server.version"] = bq)
                        }
                        Xk(L("ECATCHER_REPORT_HOST", "") + "/error_204", Yb)
                    }
                    try {
                        Ir.add(H.message)
                    } catch (ax) {}
    ...
    function Qr() {
        for (var a = p(Nr), b = a.next(); !b.done; b = a.next())
    ...
    function Tr(a) {
        ...
        for (var b = a.next(); !b.done; b = a.next()) b.value.rq("ABORTED")
    }
    ...
    function Wr() {
        a: {
            ...
            if (Vr)
                for (a = 1, b = 0; b < Vr.length; b++) d[a % 16] = d[a % 16] ^ d[(a - 1) % 16] / 4 ^ Vr.charCodeAt(b), a++
        }
        a = [];
        for (b = 0; b < d.length; b++) a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b] & 63));
        return a.join("")
    };
    var Xr = y.ytLoggingDocDocumentNonce_;
    Xr || (Xr = Wr(), z("ytLoggingDocDocumentNonce_", Xr));
    var Yr = Xr;
    var Zr = {
        wh: 0,
        ie: 1,
    ...
    $r.prototype.getAsJson = function() {
        var a = {};
    ...
    $r.prototype.getAsJspb = function() {
        var a = new ej;
        ...
        void 0 !== this.i.youtubeData && G(a, Ci, 8, this.i.jspbYoutubeData);
        return a
    };
    $r.prototype.toString = function() {
        return JSON.stringify(this.getAsJson())
    };
    $r.prototype.isClientVe = function() {
    ...
    function ds(a) {
        return L(cs(void 0 === a ? 0 : a))
    }
    z("yt_logging_screen.getRootVeType", ds);

    function es(a) {
        return (a = ds(void 0 === a ? 0 : a)) ? new $r({
            veType: a,
            youtubeData: void 0,
    ...
    z("yt_logging_screen.getCurrentCsn", gs);
    ...
    function js(a, b, c, d) {
        c = void 0 === c ? 0 : c;
        if (a !== L(bs(c)) || b !== L(cs(c)))
            if (hs(a, d, c), nk(bs(c), a), nk(cs(c), b), b = function() {
                    setTimeout(function() {
                        if (a)
                            if (M("web_time_via_jspb")) {
                                ...
                                E(e, 1, Yr);
                                E(e, 2, a);
                                M("use_default_heartbeat_client") ? Hr(e) : Hr(e, void 0, kp)
                            } else e = {
                                clientDocumentNonce: Yr,
                                clientScreenNonce: a
                            }, M("use_default_heartbeat_client") ? em("foregroundHeartbeatScreenAssociated", e) : jr("foregroundHeartbeatScreenAssociated", e, kp)
                    }, 0)
    ...
    z("yt_logging_screen.setCurrentScreen", js);
    var ks = window.yt && window.yt.msgs_ || window.ytcfg && window.ytcfg.msgs || {};
    z("yt.msgs_", ks);
    ...
    function ns() {
        var a = tb(os),
            b;
        return (new qf(function(c, d) {
            a.onSuccess = function(e) {
                Pk(e) ? c(new ps(e)) : d(new qs("Request failed, status=" + (e && "status" in e ? e.status : -1), "net.badstatus", e))
            };
            a.onError = function(e) {
                d(new qs("Unknown request error", "net.unknown", e))
            };
            a.onTimeout = function(e) {
                d(new qs("Request timed out", "net.timeout", e))
            };
            b = Xk("//googleads.g.doubleclick.net/pagead/id", a)
        })).gb(function(c) {
            c instanceof xf && b.abort();
            return vf(c)
        })
    }
    ...
    rs.prototype.then = function(a, b, c) {
        return 1 === this.i && a ? (a = a.call(c, this.ka)) && "function" === typeof a.then ? a : ss(a) : 2 === this.i && b ? (a = b.call(c, this.ka)) && "function" === typeof a.then ? a : ts(a) : this
    };
    ...
    function us(a, b) {
        return {
            ...
            mode: Kk(a) ? "same-origin" : "cors",
            credentials: Kk(a) ? "same-origin" : "include"
        }
    };

    function vs() {
        if (kg() || Vl && Wl("applewebkit") && !Wl("version") && (!Wl("safari") || Wl("gsa/")) || Oc && Wl("version/")) return !0;
        if (M("enable_web_eom_visitor_data")) return L("EOM_VISITOR_DATA") ? !1 : !0;
        var a = L("INNERTUBE_CLIENT_NAME");
        return !a || "WEB" !== a && "MWEB" !== a ? !0 : (a = hl("CONSENT")) ? a.startsWith("YES+") : !0
    };
    ...
    function xs(a) {
        ...
        this.isMissing = a instanceof ys;
        this.isTimeout = a instanceof qs && "net.timeout" == a.errorCode;
        this.isCanceled = a instanceof xf
    }
    r(xs, ab);
    xs.prototype.name = "BiscottiError";

    function ys() {
        ab.call(this, "Biscotti ID is missing from server")
    }
    r(ys, ab);
    ys.prototype.name = "BiscottiMissingError";
    var os = {
            format: "RAW",
            method: "GET",
            timeout: 5E3,
    ...
    function zk() {
        if (M("disable_biscotti_fetch_entirely_for_all_web_clients")) return vf(Error("Biscotti id fetching has been disabled entirely."));
        if (!vs()) return vf(Error("User has not consented - not fetching biscotti id."));
        var a = L("PLAYER_VARS", {});
        if ("1" == rb(a)) return vf(Error("Biscotti ID is not available in private embed mode"));
        if (M("embeds_web_disable_ads_for_pfl") && ws(a)) return vf(Error("Biscotti id fetching has been disabled for pfl."));
        zs || (zs = ns().then(As).gb(function(b) {
            return Bs(2, b)
        }));
        return zs
    }
    ...
    function As(a) {
        ...
        if (0 != a.lastIndexOf(")]}'", 0)) throw new ys;
        a = JSON.parse(a.substr(4));
        if (1 < (a.type || 1)) throw new ys;
        a = a.id;
        Ak(a);
        zs = ss(a);
        Cs(18E5, 2);
    ...
    function Es(a) {
        if ("1" != rb(L("PLAYER_VARS", {}))) {
            a && yk();
            try {
                Ds().then(function() {}, function() {}), Qk(Es, 18E5)
            } catch (b) {
                wk(b)
            }
        }
    ...
    function Gs(a) {
        var b = {},
            c = mg([]);
        c && (b.Authorization = c, c = a = null == a ? void 0 : a.sessionIndex, void 0 === c && (c = Number(L("SESSION_INDEX", 0)), c = isNaN(c) ? 0 : c), M("voice_search_auth_header_removal") || (b["X-Goog-AuthUser"] = c), "INNERTUBE_HOST_OVERRIDE" in mk || (b["X-Origin"] = window.location.origin), void 0 === a && "DELEGATED_SESSION_ID" in mk && (b["X-Goog-PageId"] = L("DELEGATED_SESSION_ID")));
        return b
    };
    var Hs = Symbol("injectionDeps");
    ...
    Ls.prototype.resolve = function(a) {
        return a instanceof Js ? Ms(this, a.key, [], !0) : Ms(this, a, [])
    };
    ...
    function Ms(a, b, c, d) {
        ...
        c.push(b);
        if (d.td) var e = d.td;
        else if (d.sd) e = d[Hs] ? Ns(a, d[Hs], c) : [], e = d.sd.apply(d, ia(e));
        else if (d.oc) {
            e = d.oc;
            var f = e[Hs] ? Ns(a, e[Hs], c) : [];
    ...
    function Ns(a, b, c) {
        return b ? b.map(function(d) {
            return d instanceof Js ? Ms(a, d.key, c, !0) : Ms(a, d, c)
        }) : []
    };
    var Os;
    var Ps = {
    ...
    function Ss() {
        this.i = {};
        if (this.j = il()) {
            var a = hl("CONSISTENCY");
            a && Ts(this, {
                encryptedTokenJarContents: a
            })
        }
    }
    Ss.prototype.handleResponse = function(a, b) {
    ...
    var Us = window.location.hostname.split(".").slice(-2).join(".");

    function Vs() {
        var a = L("LOCATION_PLAYABILITY_TOKEN");
        "TVHTML5" === L("INNERTUBE_CLIENT_NAME") && (this.i = Ws(this)) && (a = this.i.get("yt-location-playability-token"));
        a && (this.locationPlayabilityToken = a, this.j = void 0)
    }
    var Xs;
    Vs.getInstance = function() {
        Xs = B("yt.clientLocationService.instance");
        Xs || (Xs = new Vs, z("yt.clientLocationService.instance", Xs));
        return Xs
    };
    Vs.prototype.setLocationOnInnerTubeContext = function(a) {
        a.client || (a.client = {});
    ...
    Vs.prototype.handleResponse = function(a) {
        var b;
        a = null == (b = a.responseContext) ? void 0 : b.locationPlayabilityToken;
        void 0 !== a && (this.locationPlayabilityToken = a, this.j = void 0, "TVHTML5" === L("INNERTUBE_CLIENT_NAME") ? (this.i = Ws(this)) && this.i.set("yt-location-playability-token", a, 15552E3) : gl("YT_CL", JSON.stringify({
            loctok: a
        }), 15552E3, Us, !0))
    };

    function Ws(a) {
        return void 0 === a.i ? new Gl("yt-client-location") : a.i
    }
    ...
    Vs.prototype.createUnpluggedLocationInfo = function(a) {
        var b = {};
        a = a.coords;
    ...
    function bt(a) {
        ...
        var f = [];
        Object.entries(at).forEach(function(g) {
            var h = p(g);
            g = h.next().value;
            h = h.next().value;
            b !== g && f.push(h)
    ...
    ct.prototype.m = function(a, b, c) {
        ...
        if (g) {
            ...
            nl(165) ? m = "USER_INTERFACE_THEME_DARK" : nl(174) ? m = "USER_INTERFACE_THEME_LIGHT" : !M("kevlar_legacy_browsers") && window.matchMedia && window.matchMedia("(prefers-color-scheme)").matches && window.matchMedia("(prefers-color-scheme: dark)").matches && (m = "USER_INTERFACE_THEME_DARK");
            k = k ? m : Rs() || m;
            h.userInterfaceTheme = k;
            if (!f) {
                if (k =
                    ul()) h.connectionType = k;
                M("web_log_effective_connection_type") && (k = vl()) && (g.client.effectiveConnectionType = k)
            }
            var q;
            ...
            if (!M("web_populate_time_zone_itc_killswitch")) {
                ...
                x && (h.timeZone = x)
            }(x = rk()) ? h.experimentsToken = x: delete h.experimentsToken;
            x = sk();
            Ss.i || (Ss.i = new Ss);
            h = Ss.i.i;
            t = [];
            ...
            M("warm_op_csn_cleanup") ? e && (f = gs()) && (g.clientScreenNonce = f) : !f && (f = gs()) && (g.clientScreenNonce = f);
            d && (g.clickTracking = {
                clickTrackingParams: d
            });
            if (d = B("yt.mdx.remote.remoteClient_")) g.remoteClient = d;
            M("web_enable_client_location_service") && Vs.getInstance().setLocationOnInnerTubeContext(g);
            try {
                var A = Lk(),
                    D = A.bid;
                delete A.bid;
            ...
            F = g
        } else Or(Error("Error: No InnerTubeContext shell provided in ytconfig.")), F = {};
        F = {
            context: F
        };
        if (N = this.i(a)) {
            this.j(F, N, b);
            var ca;
            b = "/youtubei/v1/" + bt(this.l());
            var V;
            (N = null == (ca = a.commandMetadata) ? void 0 : null == (V = ca.webCommandMetadata) ? void 0 : V.apiUrl) &&
            (b = N);
            ca = b;
            (V = L("INNERTUBE_HOST_OVERRIDE")) && (ca = String(V) + String(nc(ca)));
            V = {};
            V.key = L("INNERTUBE_API_KEY");
            M("json_condensed_response") && (V.prettyPrint = "false");
            ca = Jk(ca, V || {}, !1);
        ...
        Or(new R("Error: Failed to create Request from Command.", a))
    };
    fa.Object.defineProperties(ct.prototype, {
        o: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    dt.prototype.m = function() {
        return {
            ...
            Ca: us("/getDatasyncIdsEndpoint", "GET"),
            ga: {}
        }
    };
    ...
    var et = {},
        ft = (et.GET_DATASYNC_IDS = Zs(dt), et);

    function gt(a) {
        var b = Ja.apply(1, arguments);
        if (!ht(a) || b.some(function(d) {
                return !ht(d)
            })) throw Error("Only objects may be merged.");
        b = p(b);
        for (var c = b.next(); !c.done; c = b.next()) jt(a, c.value);
        return a
    }
    ...
    function jt(a, b) {
        for (var c in b)
            if (ht(b[c])) {
                if (c in a && !ht(a[c])) throw Error("Cannot merge an object into a non-object.");
                c in a || (a[c] = {});
                jt(a[c], b[c])
            } else if (kt(b[c])) {
            if (c in a && !kt(a[c])) throw Error("Cannot merge an array into a non-array.");
            c in a || (a[c] = []);
            lt(a[c], b[c])
        } else a[c] = b[c];
        return a
    ...
    function lt(a, b) {
        b = p(b);
        for (var c = b.next(); !c.done; c = b.next()) c = c.value, ht(c) ? a.push(jt({}, c)) : kt(c) ? a.push(lt([], c)) : a.push(c);
        return a
    }
    ...
    function mt(a, b) {
        Mn.call(this, 1, arguments);
        this.timer = b
    }
    r(mt, Mn);
    var nt = new Nn("aft-recorded", mt);
    var ot = window;
    ...
    var S = ot.performance || ot.mozPerformance || ot.msPerformance || ot.webkitPerformance || new pt;
    var qt = !1,
        rt = {
    ...
    function ut() {
        ...
        if (M("csi_use_performance_navigation_timing") || M("csi_use_performance_navigation_timing_tvhtml5")) {
            ...
            e ? (e.requestStart = vt(e.requestStart), e.responseEnd = vt(e.responseEnd), e.redirectStart = vt(e.redirectStart), e.redirectEnd = vt(e.redirectEnd), e.domainLookupEnd = vt(e.domainLookupEnd), e.connectStart = vt(e.connectStart), e.connectEnd =
                vt(e.connectEnd), e.responseStart = vt(e.responseStart), e.secureConnectionStart = vt(e.secureConnectionStart), e.domainLookupStart = vt(e.domainLookupStart), e.isPerformanceNavigationTiming = !0, a = e) : a = S.timing
        } else a = S.timing;
        return a
    }
    ...
    function Dt(a) {
        var b = tt(a || ""),
            c = st(a);
        c && !qt && (Sn(nt, new mt(Math.round(c - b._start), a)), qt = !0)
    }

    function Et(a, b) {
        for (var c = p(Object.keys(b)), d = c.next(); !d.done; d = c.next())
            if (d = d.value, !Object.keys(a).includes(d) || "object" === typeof b[d] && !Et(a[d], b[d])) return !1;
        return !0
    };
    ...
    var T = {},
        ...
        Kt = "isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
        Lt = {},
        Mt = (Lt.ccs = "CANARY_STATE_", Lt.mver = "MEASUREMENT_VERSION_", Lt.pis = "PLAYER_INITIALIZED_STATE_", Lt.yt_pt = "LATENCY_PLAYER_", Lt.pa = "LATENCY_ACTION_", Lt.ctop = "TOP_ENTITY_TYPE_", Lt.yt_vst = "VIDEO_STREAM_TYPE_", Lt),
        Nt = "all_vc ap aq c cbr cbrand cbrver cmodel cos cosver cplatform ctheme cver ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");

    function Ot(a) {
        return It[a] || "LATENCY_ACTION_UNKNOWN"
    }
    ...
    function Pt(a, b, c) {
        ...
        if (a in Jt) {
            c = Jt[a];
            0 <= eb(Kt, c) && (b = !!b);
            a in Mt && "string" === typeof b && (b = Mt[a] + b.toUpperCase());
            a = b;
            b = c.split(".");
        ...
        0 <= eb(Nt, a) || Pr(new R("Unknown label logged with GEL CSI", a))
    };
    var W = {
    ...
    Qt[Qt.LATENCY_NETWORK_MOBILE] = "LATENCY_NETWORK_MOBILE";
    Qt[Qt.LATENCY_NETWORK_WIFI] = "LATENCY_NETWORK_WIFI";
    Qt[Qt.LATENCY_NETWORK_UNKNOWN] = "LATENCY_NETWORK_UNKNOWN";
    var X = {
        CONN_INVALID: 31,
        CONN_CELLULAR_5G_NSA: 12,
        CONN_CELLULAR_5G_SA: 11,
    ...
    Rt[Rt.LATENCY_PLAYER_RTSP] = "LATENCY_PLAYER_RTSP";
    Rt[Rt.LATENCY_PLAYER_HTML5_INLINE] = "LATENCY_PLAYER_HTML5_INLINE";
    Rt[Rt.LATENCY_PLAYER_HTML5_FULLSCREEN] = "LATENCY_PLAYER_HTML5_FULLSCREEN";
    Rt[Rt.LATENCY_PLAYER_HTML5] = "LATENCY_PLAYER_HTML5";
    Rt[Rt.LATENCY_PLAYER_FRAMEWORK] = "LATENCY_PLAYER_FRAMEWORK";
    Rt[Rt.LATENCY_PLAYER_FLASH] = "LATENCY_PLAYER_FLASH";
    Rt[Rt.LATENCY_PLAYER_EXO] = "LATENCY_PLAYER_EXO";
    Rt[Rt.LATENCY_PLAYER_UNKNOWN] = "LATENCY_PLAYER_UNKNOWN";
    var St = {
    ...
    St[St.LATENCY_AD_BREAK_TYPE_POSTROLL] = "LATENCY_AD_BREAK_TYPE_POSTROLL";
    St[St.LATENCY_AD_BREAK_TYPE_MIDROLL] = "LATENCY_AD_BREAK_TYPE_MIDROLL";
    St[St.LATENCY_AD_BREAK_TYPE_PREROLL] = "LATENCY_AD_BREAK_TYPE_PREROLL";
    St[St.LATENCY_AD_BREAK_TYPE_UNKNOWN] = "LATENCY_AD_BREAK_TYPE_UNKNOWN";
    var Tt = {
        LATENCY_ACTION_ERROR_STARTUP_TIMEOUT: 1,
        LATENCY_ACTION_ERROR_UNSPECIFIED: 0
    };
    Tt[Tt.LATENCY_ACTION_ERROR_STARTUP_TIMEOUT] = "LATENCY_ACTION_ERROR_STARTUP_TIMEOUT";
    Tt[Tt.LATENCY_ACTION_ERROR_UNSPECIFIED] = "LATENCY_ACTION_ERROR_UNSPECIFIED";
    var Ut = {
    ...
    Ut[Ut.LIVE_STREAM_MODE_WINDOW] = "LIVE_STREAM_MODE_WINDOW";
    Ut[Ut.LIVE_STREAM_MODE_POST] = "LIVE_STREAM_MODE_POST";
    Ut[Ut.LIVE_STREAM_MODE_LP] = "LIVE_STREAM_MODE_LP";
    Ut[Ut.LIVE_STREAM_MODE_LIVE] = "LIVE_STREAM_MODE_LIVE";
    Ut[Ut.LIVE_STREAM_MODE_DVR] = "LIVE_STREAM_MODE_DVR";
    Ut[Ut.LIVE_STREAM_MODE_UNKNOWN] = "LIVE_STREAM_MODE_UNKNOWN";
    var Vt = {
    ...
    Vt[Vt.VIDEO_STREAM_TYPE_VOD] = "VIDEO_STREAM_TYPE_VOD";
    Vt[Vt.VIDEO_STREAM_TYPE_DVR] = "VIDEO_STREAM_TYPE_DVR";
    Vt[Vt.VIDEO_STREAM_TYPE_LIVE] = "VIDEO_STREAM_TYPE_LIVE";
    Vt[Vt.VIDEO_STREAM_TYPE_UNSPECIFIED] = "VIDEO_STREAM_TYPE_UNSPECIFIED";
    var Wt = {
        YT_IDB_TRANSACTION_TYPE_READ: 2,
        YT_IDB_TRANSACTION_TYPE_WRITE: 1,
        YT_IDB_TRANSACTION_TYPE_UNKNOWN: 0
    };
    Wt[Wt.YT_IDB_TRANSACTION_TYPE_READ] = "YT_IDB_TRANSACTION_TYPE_READ";
    Wt[Wt.YT_IDB_TRANSACTION_TYPE_WRITE] = "YT_IDB_TRANSACTION_TYPE_WRITE";
    Wt[Wt.YT_IDB_TRANSACTION_TYPE_UNKNOWN] = "YT_IDB_TRANSACTION_TYPE_UNKNOWN";
    var Xt = {
        PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN: 2,
        PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT: 1,
        PLAYER_ROTATION_TYPE_UNKNOWN: 0
    };
    Xt[Xt.PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN] = "PLAYER_ROTATION_TYPE_PORTRAIT_TO_FULLSCREEN";
    Xt[Xt.PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT] = "PLAYER_ROTATION_TYPE_FULLSCREEN_TO_PORTRAIT";
    Xt[Xt.PLAYER_ROTATION_TYPE_UNKNOWN] = "PLAYER_ROTATION_TYPE_UNKNOWN";
    var Yt = "actionVisualElement spinnerInfo resourceInfo playerInfo commentInfo mdxInfo watchInfo thumbnailLoadInfo creatorInfo unpluggedInfo reelInfo subscriptionsFeedInfo requestIds mediaBrowserActionInfo musicLoadActionInfo shoppingInfo prefetchInfo accelerationSession webInfo tvInfo kabukiInfo mwebInfo musicInfo".split(" ");
    var Zt = y.ytLoggingLatencyUsageStats_ || {};
    z("ytLoggingLatencyUsageStats_", Zt);
    ...
    $t.prototype.tick = function(a, b, c, d) {
        bu(this, "tick_" + a + "_" + b) || (c = {
            timestamp: c,
            cttAuthInfo: d
        }, M("web_csi_via_jspb") ? (d = new Cj, E(d, 1, a), E(d, 2, b), a = new Fj, Ud(a, Cj, 5, Gj, d), Ar(a, c)) : em("latencyActionTicked", {
            tickName: a,
            clientActionNonce: b
        }, c))
    };
    $t.prototype.info = function(a, b, c) {
        var d = Object.keys(a).join("");
        bu(this, "info_" + d + "_" + b) || (a = Object.assign({}, a), a.clientActionNonce = b, em("latencyActionInfo", a, {
            cttAuthInfo: c
        }))
    };
    $t.prototype.jspbInfo = function(a, b, c) {
        for (var d = "", e = 0; e < a.toJSON().length; e++) void 0 !== a.toJSON()[e] && (d = 0 === e ? d.concat("" + e) : d.concat("_" + e));
        bu(this, "info_" + d + "_" + b) || (E(a, 2, b), b = {
            cttAuthInfo: c
        }, c = new Fj, Ud(c, wj, 7, Gj, a), Ar(c, b))
    };
    $t.prototype.span = function(a, b, c) {
        var d = Object.keys(a).join("");
        bu(this, "span_" + d + "_" + b) || (a.clientActionNonce = b, em("latencyActionSpan", a, {
            cttAuthInfo: c
        }))
    };
    ...
    function bu(a, b) {
        ...
        a.i || (a.i = Pl(function() {
            var d = P(),
                e;
            for (e in Zt) Zt[e] && 6E4 < d - Zt[e].time && delete Zt[e];
            a && (a.i = 0)
        }, 5E3));
    ...
    function cu() {
        var a = ["ol"];
        Ht("").info.actionType = "embed";
        a && nk("TIMING_AFT_KEYS", a);
        nk("TIMING_ACTION", "embed");
        du();
        a = zt();
        var b = Bt();
        if ("cold" === a.yt_lt || "cold" === b.loadType) {
            ...
            c = !1;
            d = p(Object.keys(a));
            for (var f = d.next(); !f.done; f = d.next()) f = f.value, (f = Pt(f, a[f])) && !Et(Bt(), f) && (gt(b, f), gt(e, f), c = !0);
            c && eu(e)
        }
        z("ytglobal.timingready_", !0);
        a = L("TIMING_ACTION");
        B("ytglobal.timingready_") && a && "_start" in tt() &&
            st() && Dt()
    }
    ...
    function eu(a, b, c) {
        if (!M("web_csi_via_jspb") || (void 0 === c ? 0 : c)) c = Ht(b || ""), gt(c.info, a), gt(Bt(b), a), c = Ct(b), b = xt(b).cttAuthInfo, au().info(a, c, b);
        else {
            c = new wj;
            var d = Object.keys(a);
            a = Object.values(a);
                ...
                try {
                    switch (f) {
                        ...
                        case "getLibraryRequestId":
                            ...
                            break;
                        default:
                            Yt.includes(f) && wk(new R("Codegen laipb translator asked to translate message field", "" + f))
                    }
                } catch (g) {
                    wk(Error("Codegen laipb translator failed to set " + f))
                }
            }
            gu(c, b)
        }
    ...
    function Z(a, b, c) {
        ...
        d[a] = e;
        e = Ct(c);
        var f = xt(c).cttAuthInfo;
        if ("_start" === a) {
            var g = au();
            bu(g, "baseline_" + e) || (b = {
                timestamp: b,
                cttAuthInfo: f
            }, M("web_csi_via_jspb") ? (f = new uj, E(f, 1, e), e = new Fj, Ud(e, uj, 6, Gj, f), Ar(e,
                b)) : em("latencyActionBaselined", {
                clientActionNonce: e
            }, b))
        } else au().tick(a, e, b, f);
        Dt(c);
        return d[a]
    }
    ...
    function du() {
        function a(f) {
            ...
            f.secureConnectionStart >= wt() && 0 < f.connectEnd - f.secureConnectionStart && (Z("nstcps", f.secureConnectionStart, void 0), Z("ntcpe", f.connectEnd, void 0));
            S && "getEntriesByType" in S && ju()
        }
        var b = L("TIMING_INFO", {});
        if (M("web_csi_via_jspb")) {
            b = ku(b);
            gu(b);
            b = yj(zj(new wj, !0), W[Ot(L("TIMING_ACTION"))]);
            var c = L("PREVIOUS_ACTION");
            c && E(b, 13, W[Ot(c)]);
            (c = L("CLIENT_PROTOCOL")) && E(b, 33, c);
            (c = L("CLIENT_TRANSPORT")) && E(b, 34, c);
            (c = gs()) && "UNDEFINED_CSN" !== c && E(b, 4, c);
            c = iu();
            1 !== c && -1 !== c || E(b, 6, !0);
            c = zt();
            E(b, 3, "cold");
            ...
            for (c in b) b.hasOwnProperty(c) && fu(c, b[c]);
            b = {
                isNavigation: !0,
                actionType: Ot(L("TIMING_ACTION"))
            };
            if (c = L("PREVIOUS_ACTION")) b.previousAction = Ot(c);
            if (c = L("CLIENT_PROTOCOL")) b.httpProtocol = c;
            if (c = L("CLIENT_TRANSPORT")) b.transportProtocol = c;
            (c = gs()) && "UNDEFINED_CSN" !== c && (b.clientScreenNonce = c);
            c = iu();
    ...
    function mu(a, b) {
        ...
        gc() && a.setAttribute("nonce", gc());
        return c ? (a = S.getEntriesByName(c)) && a[0] && (a = a[0], c = wt(), Z("rsf_" + b, c + Math.round(a.fetchStart)), Z("rse_" + b, c + Math.round(a.responseEnd)), void 0 !== a.transferSize && 0 === a.transferSize) ? !0 : !1 : !1
    }
    ...
    function ju() {
        ...
        (b = ib(b, function(c, d) {
            ...
            duration: 0
        })) && 0 < b.startTime && 0 < b.responseEnd && (Z("wffs", vt(b.startTime)), Z("wffe", vt(b.responseEnd)))
    }
    var nu = window;
    nu.ytcsi && (nu.ytcsi.info = fu, nu.ytcsi.tick = Z);
    ...
    function pu(a, b, c, d) {
        ...
        this.i = new Map;
        a.La || (a.La = {});
        a.La = Object.assign({}, ft, a.La)
    }

    function qu(a, b, c, d) {
        if (void 0 !== pu.i) {
            if (d = pu.i, a = [a !== d.m, b !== d.M, c !== d.o, !1, !1, void 0 !== d.j], a.some(function(e) {
                    return e
    ...
    function ru(a) {
        ...
        var c = void 0 === c ? Ps : c;
        var d = Ys(b, a.m);
        if (!d) return vf(new R("Error: No request builder found for command.", b));
        var e = d.m(b, void 0, c);
        return e ? new qf(function(f) {
            var g, h, k;
            return w(function(m) {
                if (1 == m.i) {
                    ...
                    if (a.o.ld) {
                        ...
                        k = Object.assign({}, su(h), t);
                        return m.u(2)
                    }
                    return v(m, tu(e.config,
                        h), 3)
                }
                2 != m.i && (k = m.j);
                f(uu(a, e, k));
        ...
        }) : vf(new R("Error: Failed to build request for command.", b))
    }

    function uu(a, b, c) {
        var d, e, f, g, h, k, m, q, t, x, u, A, D, F, N, O, Q, ba, ca;
        return w(function(V) {
            switch (V.i) {
                case 1:
                    V.u(2);
                    break;
                case 3:
                    if ((d = V.j) && !d.isExpired()) return V.return(Promise.resolve(d.i()));
                case 2:
                    if (null == (e = b) ? 0 : null == (f = e.ga) ? 0 : f.context)
                        for (g = p([]), h = g.next(); !h.done; h = g.next()) k = h.value, k.qq(b.ga.context);
                    if (null == (m = a.j) ? 0 : m.wq(b.input, b.ga)) return V.return(a.j.nq(b.input, b.ga));
                    (x = null == (t = b.config) ? void 0 : t.Ba) && a.i.has(x) && M("web_memoize_inflight_requests") ? q = a.i.get(x) : (u = JSON.stringify(b.ga),
                        b.Ca = Object.assign({}, b.Ca, {
                            ...
                            body: u
                        })), (null == (D = b.config) ? 0 : D.Wc) && Z(b.config.Wc), F = function() {
                ...
                case 4:
                    ...
                    (null == (O = b.config) ? 0 : O.Xc) && Z(b.config.Xc);
                    if (N || null == (Q = a.j) || !Q.hq(b.input, b.ga)) {
                        V.u(5);
                        break
                    }
                    return v(V, a.j.mq(b.input, b.ga), 6);
                case 6:
                    N = V.j;
                case 5:
                    if (N && a.l)
                        for (ba = p(ou), h = ba.next(); !h.done; h = ba.next()) ca = h.value, a.l[ca] && a.l[ca].handleResponse(N, b);
                    return V.return(N)
            }
        })
    }
    ...
    fa.Object.defineProperties(Bu.prototype, {
        o: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    fa.Object.defineProperties(Cu.prototype, {
        o: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    fa.Object.defineProperties(Du.prototype, {
        o: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    Gu.prototype.i = function(a) {
        return a.webPlayerShareEntityServiceEndpoint
    };
    Gu.prototype.j = function(a, b, c) {
        c = void 0 === c ? {} : c;
        b.serializedShareEntity && (a.serializedSharedEntity = b.serializedShareEntity);
        c.includeListId && (a.includeListId = !0)
    };
    var Ks = new Is("NETWORK_SLI_TOKEN");

    function Hu(a) {
        this.i = a
    }
    Hu.prototype.fetch = function(a, b) {
        var c = this,
            d, e;
        return w(function(f) {
            c.i && (d = kc(lc(5, Bc(a, "key"))) || "/UNKNOWN_PATH", c.i.start(d));
    ...
    Hu.prototype.handleResponse = function(a) {
        ...
        a.redirected || a.ok ? this.i && this.i.success() : (this.i && this.i.failure(), b = b.then(function(c) {
            Pr(new R("Error: API fetch failed", a.status, a.url, c));
    ...
    Hu[Hs] = [new Js];
    var Iu = new Is("NETWORK_MANAGER_TOKEN");
    var Ju;
    ...
    r(Ku, Mn);
    var Vn = new Nn("screen-created", Ku),
        Lu = [],
        Nu = Mu,
        Ou = 0;
    ...
    function Pu(a, b, c, d, e, f, g) {
        function h() {
            Pr(new R("newScreen() parent element does not have a VE - rootVe", b))
        }
        var k = Nu();
        f = new $r({
            veType: b,
        ...
        if (M("il_via_jspb")) {
            ...
            m.V(k);
            kj(m, f.getAsJspb());
            c && c.visualElement ? (f = new lj, c.clientScreenNonce && E(f, 2, c.clientScreenNonce), mj(f, c.visualElement.getAsJspb()), g && E(f, 4, Hj[g]), G(m, lj, 5, f)) : c && h();
            d && E(m, 3, d);
            Fr(m, e, a)
        } else f = {
            csn: k,
            ...
            g)) : c && h(), d && (f.cloneCsn = d), a ? jr("screenCreated", f, a, e) : em("screenCreated", f, e);
        Sn(Vn, new Ku(k));
        return k
    }
    ...
    function Qu(a, b, c, d) {
        ...
        d = p(d);
        for (var g = d.next(); !g.done; g = d.next()) g = g.value.getAsJson(), (pb(g) || !g.trackingParams && !g.veType) && Pr(Error("Child VE logged with no data"));
        if (M("il_via_jspb")) {
            var h = new nj;
            h.V(b);
            pj(h, c.getAsJspb());
            ...
            "UNDEFINED_CSN" == b ? Ru("visualElementAttached", h, f) : Gr(h, f, a)
        } else c = {
            csn: b,
        ...
        }, "UNDEFINED_CSN" == b ? Ru("visualElementAttached", c, f) : a ? jr("visualElementAttached", c, a, f) : em("visualElementAttached", c, f)
    }
                ...
                if (c = c.value, c.payload)
                    if (M("il_via_jspb")) switch (c.payload.V(a.csn), c.payloadName) {
                        ...
                        case "visualElementStateChanged":
                            ...
                            break;
                        default:
                            Pr(new R("flushQueue unable to map payloadName to JSPB setter"))
                    } else c.payload.csn =
                        a.csn, jr(c.payloadName, c.payload, null, c.options);
            Lu.length = 0
        }
        Ou = 0
    };
    ...
    function Uu(a, b, c) {
        ...
        b.then(function(d) {
            ...
            if (e && f) {
                var g;
                (null == d ? 0 : null == (g = d.response) ? 0 : g.trackingParams) && Qu(a.client, e, f, [as(d.response.trackingParams)]);
                var h;
                (null == d ? 0 : null == (h = d.playerResponse) ? 0 : h.trackingParams) && Qu(a.client, e, f, [as(d.playerResponse.trackingParams)])
            }
        })
    }
    ...
    function Vu(a, b, c, d) {
        ...
        if (a.j.has(d)) a.m.push([b, c]);
            ...
            var e = gs(d);
            c = c || es(d);
            e && c && Qu(a.client, e, c, [b])
        }
    }
    Tu.prototype.clickCommand = function(a, b, c) {
        var d = a.clickTrackingParams;
        c = void 0 === c ? 0 : c;
        if (d)
            if (c = gs(void 0 === c ? 0 : c)) {
                ...
                if (M("il_via_jspb")) {
                    ...
                    e = e.getAsJspb();
                    G(f, ej, 2, e);
                    E(f, 4, Hj.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK);
                    b && G(f, hj, 3);
                    "UNDEFINED_CSN" == c ? Ru("visualElementGestured", f, d) : Dr(f, d, a)
                } else f = {
                        csn: c,
                        ve: e.getAsJson(),
                        gestureType: "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"
                    }, b && (f.clientData = b), "UNDEFINED_CSN" == c ?
                    Ru("visualElementGestured", f, d) : a ? jr("visualElementGestured", f, a, d) : em("visualElementGestured", f, d);
                b = !0
            } else b = !1;
        else b = !1;
        return b
    ...
    function Wu(a, b, c) {
        ...
        a.l = function() {
            ...
            var f = es(c.layer);
            if (f) {
                for (var g = p(a.m), h = g.next(); !h.done; h = g.next()) h = h.value, Vu(a, h[0], h[1] || f, c.layer);
                f = p(a.N);
                for (g = f.next(); !g.done; g = f.next()) {
                    ...
                    if (h && m) {
                        ...
                        M("il_via_jspb") ? (q = new tj, q.V(h), m = m.getAsJspb(), G(q, ej, 2, m), "UNDEFINED_CSN" == h ? Ru("visualElementStateChanged", q, k) : Er(q, k, g)) : (m = {
                            csn: h,
                            ve: m.getAsJson(),
                            clientData: q
                        }, "UNDEFINED_CSN" == h ? Ru("visualElementStateChanged", m, k) : g ? jr("visualElementStateChanged", m, g, k) : em("visualElementStateChanged", m, k))
                    }
                }
            }
        };
        gs(c.layer) || a.l();
        if (c.Ob)
            for (var d = p(c.Ob), e = d.next(); !e.done; e = d.next()) Uu(a, e.value, c.layer);
        else Or(Error("Delayed screen needs a data promise."))
    }
    ...
    function Xu(a, b, c) {
        ...
        try {
            var k = Pu(a.client, b, f, c.Nb, c.cttAuthInfo, g, c.kq)
        } catch (m) {
            Rr(m, {
                tq: b,
                rootVe: d,
        ...
        b && (b = a.client, g = !0, h = (g = void 0 === g ? !1 : g) ? 16 : 8, f = {
            ...
            ca: e,
            Qb: g
        }, M("il_via_jspb") ? (h = new rj, h.V(e), d = d.getAsJspb(), G(h, ej, 2, d), E(h, 4, g ? 16 : 8), "UNDEFINED_CSN" == e ? Ru("visualElementHidden", h, f) : Cr(h, f, b)) : (d = {
            csn: e,
            ve: d.getAsJson(),
            eventType: h
        }, "UNDEFINED_CSN" == e ? Ru("visualElementHidden", d, f) : b ? jr("visualElementHidden", d, b, f) : em("visualElementHidden",
            d, f)));
        a.i[a.i.length - 1] && !a.i[a.i.length - 1].csn && (a.i[a.i.length - 1].csn = k || "");
        eu({
            clientScreenNonce: k
        });
        Su.getInstance().clear();
        d = es(c.layer);
        e && "UNDEFINED_CSN" !== e && d && (M("web_mark_root_visible") || M("music_web_mark_root_visible")) && (e = k, k = {
            cttAuthInfo: is(e),
            ca: e
        }, M("il_via_jspb") ? (b = new sj, b.V(e), f = d.getAsJspb(), G(b, ej, 2, f), E(b, 4, 1), "UNDEFINED_CSN" == e ? Ru("visualElementShown", b, k) : Br(b, k)) : (b = {
            csn: e,
            ve: d.getAsJson(),
            eventType: 1
        }, "UNDEFINED_CSN" == e ? Ru("visualElementShown", b, k) : em("visualElementShown",
            b, k)));
        a.j.delete(c.layer || 0);
        a.l = void 0;
        e = p(a.v);
        for (k = e.next(); !k.done; k = e.next()) b = p(k.value), k = b.next().value, b = b.next().value, b.has(c.layer) && d && Vu(a, k, d, c.layer);
        ...
        for (c = a.o.length = 0; c < a.C.length; c++) {
            e = a.C[c];
            try {
                e()
            } catch (m) {
    ...
    function Yu() {
        var a, b;
        return w(function(c) {
            if (1 == c.i) return a = pu.i, a ? v(c, ru(a), 2) : (Pr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")), c.return(void 0));
            if (b = c.j) return b.errorMetadata ? (Pr(Error("Datasync IDs fetch responded with " + b.errorMetadata.status + ": " + b.error)), c.return(void 0)) : c.return(b.jq);
            Pr(Error("Network request to get Datasync IDs failed."));
    ...
    function bv() {
        return w(function(a) {
            if (void 0 !== $u) return a.return($u);
            $u = new Promise(function(b) {
                var c;
                return w(function(d) {
                    switch (d.i) {
                        case 1:
                            return va(d, 2), v(d, Zu.open("test-only"), 4);
                        case 4:
                            return v(d, Zu.delete("test-only"), 5);
                        case 5:
                            wa(d, 3);
                            break;
                        case 2:
                            if (c = xa(d), c instanceof Error && "SecurityError" === c.name) return b(!1), d.return();
                        case 3:
    ...
    function cv(a) {
        var b, c, d, e, f, g, h;
        w(function(k) {
            if (1 == k.i) return v(k, bv(), 2);
            if (3 != k.i) {
                if (!k.j) return k.return(!1);
                b = [];
                return v(k, Zu.keys(), 3)
            }
            c = k.j;
            d = p(c);
            for (e = d.next(); !e.done; e = d.next()) f = e.value, g = av(f), h = g.datasyncId, !h || a.includes(h) || b.push(Zu.delete(f));
    ...
    function dv() {
        var a, b, c, d, e, f, g;
        return w(function(h) {
            if (1 == h.i) return v(h, bv(), 2);
            if (3 != h.i) {
                if (!h.j) return h.return(!1);
                a = im("cache contains other");
                return v(h, Zu.keys(), 3)
            }
            b = h.j;
            c = p(b);
            for (d = c.next(); !d.done; d = c.next())
                if (e = d.value, f = av(e), (g = f.datasyncId) && g !== a) return h.return(!0);
            return h.return(!1)
        })
    };
    ...
    function hv() {
        ...
        b = p(b);
        for (var c = b.next(); !c.done; c = b.next())
            if (c = fv(c.value), void 0 !== c && c !== a) return !0;
        return !1
    };
            ...
            return w(function(f) {
                switch (f.i) {
                    case 1:
                        ...
                        return v(f, dv(), 3);
                    case 3:
                        return d = f.j, v(f, un(), 4);
                    case 4:
                        if (e = f.j, !c && !d && !e) return f.return();
                    case 2:
                        a.L() ? iv() : a.o.add("publicytnetworkstatus-online", iv, !0, void 0, void 0), f.i = 0
                }
            })
        })
    };
    ...
    function kv(a) {
        a && (a.dataset ? a.dataset[lv("loaded")] = "true" : a.setAttribute("data-loaded", "true"))
    }

    function mv(a, b) {
        return a ? a.dataset ? a.dataset[lv(b)] : a.getAttribute("data-" + b) : null
    }
    var nv = {};

    function lv(a) {
        return nv[a] || (nv[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
            return c.toUpperCase()
        }))
    };
    var ov = /\.vflset|-vfl[a-zA-Z0-9_+=-]+/,
        pv = /-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;
        ...
        if (window.spf && spf.script) {
            ...
            if (a) {
                var d = a.indexOf("jsbin/"),
                    e = a.lastIndexOf(".js"),
                    f = d + 6; - 1 < d && -1 < e && e > f && (c = a.substring(f, e), c = c.replace(ov, ""), c = c.replace(pv, ""), c = c.replace("debug-", ""), c = c.replace("tracing-", ""))
            }
    ...
    function rv(a, b, c) {
        ...
        var d = sv(a),
            ...
            f = e && mv(e, "loaded"),
            g = e && !f;
        f ? b && b() : (b && (f = vq(d, b), b = "" + Ra(b), tv[b] = f), g || (e = uv(a, d, function() {
            mv(e, "loaded") || (kv(e), yq(d), Qk(Ya(zq, d), 0))
        }, c)))
    }
    ...
    function vv(a) {
        ...
        b && (zq(a), b.parentNode.removeChild(b))
    }

    function wv(a, b) {
        a && b && (a = "" + Ra(b), (a = tv[a]) && xq(a))
    }
    ...
    function zv() {
        if (!M("disable_biscotti_fetch_for_ad_blocker_detection") && !M("disable_biscotti_fetch_entirely_for_all_web_clients") && vs()) {
            var a = L("PLAYER_VARS", {});
            if (!("1" == rb(a) || M("embeds_web_disable_ads_for_pfl") && ws(a))) {
                var b = function() {
                    yv = !0;
                ...
                xv.push(Nh.S(function() {
                    if (!(yv || "google_ad_status" in window)) {
                        try {
                            wv("//static.doubleclick.net/instream/ad_status.js", b)
                        } catch (c) {}
                        yv = !0;
                        nk("DCLKSTAT", 3)
                    }
    ...
    Dv.prototype.initialize = function(a, b, c) {
        if (a.program) {
            var d, e = null != (d = a.interpreterScript) ? d : null,
                f;
            d = null != (f = a.interpreterUrl) ? f : null;
            a.interpreterSafeScript && (e = a.interpreterSafeScript, Db("From proto message. b/166824318"), e = e.privateDoNotAccessOrElseSafeScriptWrappedValue || "", e = (f = yb()) ? f.createScript(e) : e, e = (new Fb(e)).toString());
            ...
            Ev(this, e, d, a.program, b, c)
        } else Pr(Error("Cannot initialize botguard without program"))
    };

    function Ev(a, b, c, d, e, f) {
        var g = void 0 === g ? "trayride" : g;
        c ? (a.state = 2, qv(c, function() {
            window[g] ? Fv(a, d, g, e) : (a.state = 3, vv(c), Pr(new R("Unable to load Botguard", "from " + c)))
        }, f)) : b ? (f = cf("SCRIPT"), f.textContent = b, f.nonce = gc(), document.head.appendChild(f), document.head.removeChild(f), window[g] ? Fv(a, d, g, e) : (a.state = 4, Pr(new R("Unable to load Botguard from JS")))) : Pr(new R("Unable to load VM; no url or JS provided"))
    }
    Dv.prototype.isInitialized = function() {
        return !!this.i
    };
    ...
    function Fv(a, b, c, d) {
        ...
        try {
            ...
            a.state = 7, f instanceof Error && Pr(f)
        }
    }
    Dv.prototype.invoke = function(a) {
        a = void 0 === a ? {} : a;
        var b = this.i;
        if (b) {
            var c = {
            ...
            a = sh();
            var d;
            null != (d = b.ta) && d.j.i.Cb("/client_streamz/bg/fsc", d.Ba);
            d = b.md([c.Mb, c.kd]);
            null != (b = b.ta) && (a = sh() - a, b.l.i.hb("/client_streamz/bg/fsl", a, b.Ba));
            b = d
        } else b = null;
        return b
    };
    Dv.prototype.dispose = function() {
        Gv(this, null);
        this.state = 8
    };
    ...
    function Mv(a) {
        var b = Array.from(a.i.keys()).sort(function(d, e) {
            return Lv(a, a.i[e]) - Lv(a, a.i[d])
        });
        b = p(b);
        for (var c = b.next(); !c.done; c = b.next()) c = a.i[c.value], void 0 === c.Za || c.eb || (a.l.aa(c.Za), Ql(c.ub, 10))
    }
    Kv.prototype.cancel = function() {
        for (var a = p(this.i), b = a.next(); !b.done; b = a.next()) b = b.value, void 0 === b.Za || b.eb || this.l.aa(b.Za), b.eb = !0;
        this.j.resolve()
    };
    ...
    function Ov(a, b, c) {
        return function() {
            ...
            for (var h = e.next(); !h.done; g = {
                    Oa: g.Oa
                }, h = e.next()) g.Oa = h.value, Sl(function(k) {
                return function() {
    ...
    fa.Object.defineProperties(Nv.prototype, {
        currentState: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    function Pv(a) {
        Nv.call(this, void 0 === a ? "document_active" : a);
        var b = this;
        this.s = 10;
        this.i = new Map;
        this.C = [{
    ...
    function Qv(a) {
        Nv.call(this, void 0 === a ? "document_visibility_unknown" : a);
        var b = this;
        this.C = [{
    ...
    Qv.prototype.o = function(a, b) {
        a(null == b ? void 0 : b.event)
    };
    Qv.prototype.m = function(a, b) {
        a(null == b ? void 0 : b.event)
    };
    ...
    Sv.prototype.o = function() {
        if (M("web_fp_via_jspb")) {
            ...
            Ud(b, dj, 380, Gj, a);
            Ar(b);
            M("web_fp_via_jspb_and_json") && em("finalPayload", {
                csn: gs()
            })
        } else em("finalPayload", {
            csn: gs()
        })
    };
    ...
    function Uv() {}
    Uv.getInstance = function() {
        var a = B("ytglobal.storage_");
        a || (a = new Uv, z("ytglobal.storage_", a));
        return a
    };
    Uv.prototype.estimate = function() {
        var a, b, c;
        return w(function(d) {
            a = navigator;
            return (null == (b = a.storage) ? 0 : b.estimate) ? d.return(a.storage.estimate()) : (null == (c = a.webkitTemporaryStorage) ? 0 : c.queryUsageAndQuota) ? d.return(Vv()) : d.return()
        })
    };
    ...
    cm.prototype.logEvent = function(a, b) {
        switch (a) {
    ...
    function Wv(a, b) {
        Uv.getInstance().estimate().then(function(c) {
            c = Object.assign({}, b, {
                isSw: void 0 === self.document,
                isIframe: self !== self.top,
                deviceStorageUsageMbytes: Xv(null == c ? void 0 : c.usage),
                deviceStorageQuotaMbytes: Xv(null == c ? void 0 : c.quota)
            });
            ...
            a: if (!("*" != d.o && e.origin != d.o || d.l && e.source != d.l || "string" !== typeof e.data)) {
                ...
                if (!(null == f || d.B && (d.sessionId && d.sessionId != f.id || d.channel && d.channel != f.channel)) && f) switch (f.event) {
                    case "listening":
                        ...
                        break;
                    case "command":
                        d.m && (!d.s || 0 <= eb(d.s, f.func)) && d.m(f.func, f.args, e.origin)
                }
            }
        };
    ...
    r(Yv, J);
    Yv.prototype.sendMessage = function(a, b) {
        if (b = b || this.l) {
    ...
    function Zv() {
        ...
        this.isReady = !1;
        this.l = {};
        var a = this.i = new Yv(!!L("WIDGET_ID_ENFORCE")),
            b = this.Uc.bind(this);
        a.m = b;
        a.s = null;
    ...
    l = Zv.prototype;
    l.Uc = function(a, b, c) {
        "addEventListener" === a && b ? (a = b[0], this.l[a] || "onReady" === a || (this.addEventListener(a, $v(this, a)), this.l[a] = !0)) : this.Db(a, b, c)
    };
    l.Db = function() {};
        ...
        if (this.api.isExternalMethodAvailable(a, c)) {
            ...
            if (0 < b.length && bw(a)) {
                ...
                if (Qa(d[0]) && !Array.isArray(d[0])) var e = d[0];
                    ...
                    case "loadVideoById":
                    case "cueVideoById":
                        e = cw(d[0], void 0 !== d[1] ? Number(d[1]) : void 0, d[2]);
                        break;
                    case "loadVideoByUrl":
                    case "cueVideoByUrl":
                        e = d[0];
                    ...
                    case "loadPlaylist":
                    case "cuePlaylist":
                        e = dw(d[0], d[1], d[2], d[3])
                }
                b.length = 1;
                b[0] = e
            }
            this.api.handleExternalCall(a, b, c);
            bw(a) && aw(this, this.pb())
        }
    };
    l.onReady = function() {
    ...
    l.dispose = function() {
        Zv.prototype.dispose.call(this);
        ...
        if (this.started && !this.i()) {
            ...
            switch (a) {
                ...
                case "removeEventListener":
                    ...
                    break;
                default:
                    this.api.isReady() && this.api.isExternalMethodAvailable(a, c || null) && (b = gw(a, b || {}), c = this.api.handleExternalCall(a, b, c || null), (c = hw(a, c)) && this.wa(a, c))
            }
        }
    };
    ...
    l.Zc = function(a, b) {
        this.started && !this.i() && this.connection.wa(a, this.ob(a, b))
    };
    l.ob = function(a, b) {
        if (null != b) return {
            value: b
    ...
    l.D = function() {
        ...
        a.i() || li(a.j, "command", this.ec, this);
    ...
    r(iw, fw);
    iw.prototype.addEventListener = function(a, b) {
        this.api.addEventListener(a, b)
    };
    iw.prototype.removeEventListener = function(a, b) {
    ...
    iw.prototype.ob = function(a, b) {
        ...
        return fw.prototype.ob.call(this, a, b)
    };
    iw.prototype.D = function() {
        fw.prototype.D.call(this);
        delete this.api
    };
    ...
    Za(jw, J);
    jw.prototype.subscribe = function(a, b, c) {
    ...
    function lw(a, b, c) {
        ...
        this.destination = a;
        this.origin = c;
        this.j = iq(window, "message", this.l.bind(this));
        this.connection = new kw(this, a, b);
        me(this, this.connection)
    }
    r(lw, J);
    lw.prototype.wa = function(a, b, c, d) {
        this.i() || a !== this.destination || (a = {
            id: b,
            command: c
        }, d && (a.data = d), this.destination.postMessage(qg(a), this.origin))
    };
    lw.prototype.l = function(a) {
        var b;
        if (b = !this.i())
    ...
    mw.prototype.clone = function() {
        ...
        for (b in this)
            if (this.hasOwnProperty(b)) {
                var c = this[b];
                "object" == Oa(c) ? a[b] = tb(c) : a[b] = c
            }
        return a
    };
    var nw = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;
    ...
    function pw(a) {
        var b = qw(a),
            ...
            d = c && mv(c, "loaded");
        d || c && !d || (c = rw(a, b, function() {
            mv(c, "loaded") || (kv(c), yq(b), Qk(Ya(zq, b), 0))
        }))
    }
    ...
    l.loadNewVideoConfig = function(a) {
        if (!this.i()) {
            this.T && (Rk(this.T), this.T = 0);
            var b = a || {};
            b instanceof mw || (b = new mw(b));
            this.config = b;
            this.setConfig(a);
            yw(this);
            this.isReady() && zw(this)
        }
    };
    ...
    l.setConfig = function(a) {
        ...
        if (!this.Y) {
            var b;
            this.Y = Bw(this, (null == (b = this.config.args) ? void 0 : b.jsapicallback) || "onYouTubePlayerReady")
        }
        this.config.args ? this.config.args.jsapicallback = null : this.config.args = {
            jsapicallback: null
        };
        var c;
        if (null == (c = this.config) ? 0 : c.attrs) a = this.config.attrs, (b = a.width) && this.l && (this.l.style.width = Gh(Number(b) || b)), (a = a.height) && this.l && (this.l.style.height = Gh(Number(a) || a))
    };
    ...
    function Cw(a) {
        var b = !0,
            c = Dw(a);
        c && a.config && (a = Ew(a), b = mv(c, "version") === a);
    ...
    function yw(a) {
        if (!a.i() && !a.P) {
            var b = Cw(a);
            if (b && "html5" === (Dw(a) ? "html5" : null)) a.R = "html5", a.isReady() || Fw(a);
            else if (Gw(a), a.R = "html5", b && a.o && a.m) a.m.appendChild(a.o), Fw(a);
            else {
                a.config && (a.config.loaded = !0);
                var c = !1;
                a.B = function() {
                    c = !0;
                    var d = Hw(a, "player_bootstrap_method") ? B("yt.player.Application.createAlternate") || B("yt.player.Application.create") : B("yt.player.Application.create");
                    var e = a.config ? Aw(a.config) : void 0;
                    d && d(a.m, e, a.webPlayerContextConfig);
                    Fw(a)
                };
                a.P = !0;
                b ? a.B() : (qv(Ew(a), a.B), (b = Iw(a)) && ow(b), Jw(a) && !c && z("yt.player.Application.create", null))
            }
        }
    }

    function Dw(a) {
        var b = bf(a.elementId);
    ...
    function Kw(a) {
        ...
        var b = Dw(a);
        if (b) {
            a.s = Lw(a, b, "addEventListener");
            a.X = Lw(a, b, "removeEventListener");
    ...
    function Lw(a, b, c) {
        ...
        return function() {
            ...
            try {
                ...
                "sendAbandonmentPing" !== c && (f.params = c, a.lastError = f, Pr(f))
            }
        }
    }
    ...
    function vw(a) {
        ...
        for (var c in a.G) a.G.hasOwnProperty(c) && Rk(Number(c));
        a.G = {};
        a.s = null;
        a.X = null;
        b = a.api;
    ...
    function ww(a) {
        a.addEventListener("WATCH_LATER_VIDEO_ADDED", function(b) {
            yq("WATCH_LATER_VIDEO_ADDED", b)
        });
        a.addEventListener("WATCH_LATER_VIDEO_REMOVED", function(b) {
            yq("WATCH_LATER_VIDEO_REMOVED", b)
        })
    }
    l.addEventListener = function(a, b) {
        var c = this,
            d = Bw(this, b);
        d && (0 <= eb(this.Pa, a) || this.j[a] || (b = Mw(this, a), this.s && this.s(a, b)), this.K.subscribe(a, d), "onReady" === a && this.isReady() && Qk(function() {
            d(c.api)
        }, 0))
    };
    l.removeEventListener = function(a, b) {
        this.i() || (b = Bw(this, b)) && li(this.K, a, b)
    };
            ...
            var e = Qk(function() {
                if (!a.i()) {
                    try {
                        ...
                        Pr(new R("PlayerProxy error when creating global callback", {
                            error: h,
                            event: b,
                            playerId: a.v,
                            data: d
    ...
    l.getPlayerType = function() {
        return this.R || (Dw(this) ? "html5" : null)
    };
    l.getLastError = function() {
    ...
    function Gw(a) {
        ...
        var b = Dw(a);
        b && (Cw(a) || !Jw(a) ? a.o = b : (b && b.destroy && b.destroy(), a.o = null));
        if (a.m)
            for (a = a.m; b = a.firstChild;) a.removeChild(b)
    }
    l.cancel = function() {
        this.B && wv(Ew(this), this.B);
        Rk(this.Fa);
        this.P = !1
    };
    l.D = function() {
    ...
    var Nw = {},
        Ow = "player_uid_" + (1E9 * Math.random() >>> 0);

    function Pw(a, b, c) {
        var d = "player";
        c = void 0 === c ? !0 : c;
        d = "string" === typeof d ? bf(d) : d;
        var e = Ow + "_" + Ra(d),
            f = Nw[e];
        if (f && c) return Qw(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api;
        f = new uw(d, e, a, b);
        Nw[e] = f;
        yq("player-added", f.api);
        ne(f, function() {
            delete Nw[f.getId()]
        });
        return f.api
    ...
    function Yw(a, b, c) {
        ...
        if (b) {
            ...
            var f = L("VALID_SESSION_TEMPDATA_DOMAINS", []),
                g = mc(window.location.href);
            g && f.push(g);
            g = mc(d);
            if (0 <= eb(f, g) || !g && 0 == d.lastIndexOf("/", 0))
                if (M("autoescape_tempdata_url") && (f = document.createElement("a"), dc(f, d), d = f.href), d && (d = nc(d), f = d.indexOf("#"), d = 0 > f ? d : d.slice(0, f)))
        ...
        if ((window.ytspf || {}).enabled) spf.navigate(a);
            ...
            a: {
                ...
                for (k = 0; k < t.length; ++k)
                    if (m = t[k], m instanceof wh && m.isValid(a)) {
                        t = new Mb(a, Nb);
                        break a
                    }
                t = void 0
    ...
    z("writeEmbed", function() {
        ...
        M("embeds_js_api_set_1p_cookie") && (c = Ik(window.location.href), c.embedsTokenValue && (a.args.embedsTokenValue = c.embedsTokenValue));
        cu();
        if ((c = L("WEB_PLAYER_CONTEXT_CONFIGS")) &&
            ...
            if (!c.serializedForcedExperimentIds) {
                var d = Ik(window.location.href);
                d.forced_experiments && (c.serializedForcedExperimentIds = d.forced_experiments)
            }
            Rw = Pw(a, c, !1)
        } else Rw = Pw(a);
        Rw.addEventListener("onVideoDataChange", Uw);
        Rw.addEventListener("onReady", Ww);
        a = L("POST_MESSAGE_ID", "player");
        L("ENABLE_JS_API") ? Tw = new ew(Rw) : L("ENABLE_POST_API") && "string" === typeof a && "string" === typeof b && (Sw = new lw(window.parent,
            a, b), Tw = new iw(Rw, Sw.connection));
        zv();
        M("ytidb_create_logger_embed_killswitch") || bm();
        a = {};
        Tv || (Tv = new Sv);
        Tv.install((a.flush_logs = {
            callback: function() {
                Qq()
            }
        }, a));
        M("embeds_web_enable_new_nwl") ? Po() : Xo();
        M("ytidb_clear_embedded_player") && Nh.S(function() {
            var e;
            if (!Ju) {
                Os || (Os = new Ls);
                var f = Os;
                ...
                g = {
                    Lb: {
                        feedbackEndpoint: Zs(Du),
                        modifyChannelNotificationPreferenceEndpoint: Zs(Eu),
                        playlistEditEndpoint: Zs(Fu),
                        subscribeEndpoint: Zs(Bu),
                        unsubscribeEndpoint: Zs(Cu),
                        webPlayerShareEntityServiceEndpoint: Zs(Gu)
                    }
                };
                var h = M("web_enable_client_location_service") ? Vs.getInstance() : void 0,
                    k = {};
    ...
    var Zw = vk(function() {
            ...
            if (document.body && Zh(document.body, "exp-invert-logo"))
                if (c && !Zh(document.body, "inverted-hdpi")) {
                    var d = document.body;
                    if (d.classList) d.classList.add("inverted-hdpi");
                    else if (!Zh(d, "inverted-hdpi")) {
                        var e = Xh(d);
                        Yh(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi"))
                    }
                } else !c && Zh(document.body, "inverted-hdpi") && $h();
            if (b != c) {
                b = "f" + (Math.floor(119 / 31) + 1);
                d = ol(b) || 0;
                d = c ? d | 67108864 : d & -67108865;
                0 == d ? delete jl[b] : (c = d.toString(16),
                    jl[b] = c.toString());
                c = !0;
                M("web_secure_pref_cookie_killswitch") && (c = !1);
                b = a.i;
                d = [];
                for (var f in jl) d.push(f + "=" + encodeURIComponent(String(jl[f])));
                gl(b, d.join("&"), 63072E3, a.j, c)
            }
            Tu.i || (Tu.i = new Tu);
            a = Tu.i;
            f = 16623;
            var g = void 0 === g ? {} : g;
            Object.values(ms).includes(f) || (Pr(new R("createClientScreen() called with a non-page VE", f)), f = 83769);
            ...
            a.m = [];
            a.N = [];
            g.Ob ? Wu(a, f, g) : Xu(a, f, g)
        }),
        $w = vk(function() {
            Rw && Rw.sendAbandonmentPing && Rw.sendAbandonmentPing();
            L("PL_ATT") && Hv.dispose();
            for (var a = Nh, b = 0, c = xv.length; b < c; b++) a.aa(xv[b]);
            xv.length = 0;
            vv("//static.doubleclick.net/instream/ad_status.js");
            yv = !1;
            nk("DCLKSTAT", 0);
            le(Tw, Sw);
            Rw && (Rw.removeEventListener("onVideoDataChange", Uw), Rw.destroy())
        });
    window.addEventListener ? (window.addEventListener("load", Zw), window.addEventListener("pagehide", $w)) : window.attachEvent && (window.attachEvent("onload", Zw), window.attachEvent("onunload", $w));
    z("yt.abuse.player.botguardInitialized", B("yt.abuse.player.botguardInitialized") || Iv);
    z("yt.abuse.player.invokeBotguard", B("yt.abuse.player.invokeBotguard") || Jv);
    z("yt.abuse.dclkstatus.checkDclkStatus", B("yt.abuse.dclkstatus.checkDclkStatus") || Av);
    z("yt.player.exports.navigate", B("yt.player.exports.navigate") || Yw);
    z("yt.util.activity.init", B("yt.util.activity.init") || nq);
    z("yt.util.activity.getTimeSinceActive", B("yt.util.activity.getTimeSinceActive") || qq);
    z("yt.util.activity.setTimestamp", B("yt.util.activity.setTimestamp") || oq);
}).call(this);